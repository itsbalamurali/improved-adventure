...
$latitude = 37.090_240;
$longitude = -95.712_891;

echo $UserTimeZoneDate = getPassengerTimeZoneDate($PickUpAddress, $latitude, $longitude, $scheduleDate = '');

exit;
function getPassengerTimeZoneDate($PickUpAddress, $latitude, $longitude, $scheduleDate = '')
{
    global $obj, $tconfig,$GOOGLE_SEVER_API_KEY_WEB,$vTimeZone;
