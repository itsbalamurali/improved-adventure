...
if (!empty($img_arr)) {
    ...
    foreach ($img_arr as $key => $value) {
        ...
        if (!empty($value['name'])) {
            ...
            if ('secure_section_img_first' === $key) {
                $second_down_img = 1;
            }
            if ('safe_section_img_first' === $key) {
                $second_down_img = 1;
            }
            $img_str = 'img_';
            ...
            } elseif ('secure_section_img' === $key || 'secure_section_img_first' === $key) {
            ...
            } elseif ('safe_section_img' === $key || 'safe_section_img_first' === $key) {
                $key = 'lSafeSection';
            }
            for ($i = 1; $i <= 4; ++$i) {
...
if (isset($_POST['submit'])) {
    $check_file_query = "SELECT lHowitworkSection,lSecuresafeSection,lDownloadappSection,lCalltobookSection,lGeneralBannerSection,lCalculateSection,lBookServiceSection,lSafeSection FROM {$tbl_name} where vCode='".$vCode."'";
    $check_file = $obj->MySQLSelect($check_file_query);
    ...
    $secure_section_arr['img_first'] = $sectionData['img_first'] ?? '';
    ...
    $lServiceSection = $_POST['lServiceSection'] ?? '';
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h3 class="show-help-section">
                                            Book section
                                            <i class="fa fa-question-circle show-help-img" data-fancybox data-src="<?php echo $tconfig['tsite_url_main_admin']; ?>img/web_home_page_help_image/home_2.png"></i>
                                        </h3>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="book_section_title"
                                               id="book_section_title" value="<?php echo $book_section['title']; ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control" name="book_section_subtitle"
                                               id="book_section_subtitle" value="<?php echo $book_section['subtitle']; ?>"
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="secure_section_title" id="secure_section_title" value="<?php echo $secure_section['title']; ?>" placeholder="Secure Section Title" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10" name="secure_section_desc" id="secure_section_desc" placeholder=">Secure Section Description" required><?php echo $secure_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $secure_section['img_first']) { ?>
                                            <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$secure_section['img_first']; ?>" class="innerbg_image"/>
                                        <?php } ?>
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="safe_section_title" id="safe_section_title" value="<?php echo $lSafeSection['title']; ?>" placeholder="Safe Section Title" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10" name="safe_section_desc" id="safe_section_desc" placeholder="Safe Section Description" required><?php echo $lSafeSection['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $lSafeSection['img_first']) { ?>
                                            <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$lSafeSection['img_first']; ?>" class="innerbg_image"/>
                                        <?php } ?>
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="register_section_desc_first" id="register_section_desc_first" value="<?php echo $register_section['desc_first']; ?>" placeholder="Description">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="register_section_desc_sec" id="register_section_desc_sec" value="<?php echo $register_section['desc_sec']; ?>" placeholder="Description">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
