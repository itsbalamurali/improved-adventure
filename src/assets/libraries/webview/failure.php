<?php
 ...
 //    error_reporting(E_ALL);
    ...
    {
        $failure_msg = $languageLabelsArr['LBL_USER']." ".$languageLabelsArr['LBL_NOT_FOUND'];    
    }
    else{
...
<html lang="en" dir="<?= (isset($_SESSION['eDirectionCode']) && $_SESSION['eDirectionCode'] != "") ? $_SESSION['eDirectionCode'] : 'ltr'; ?>">
    <head>
        ...
        <title><?php echo $languageLabelsArr['LBL_FAILED_TXT']; ?></title>
            ...
            <div class="page-contant-inner clearfix">
                ...
                <div class="static-page-a">
                    <div class="static-page-aa">
                        <img src="<?= $tconfig['tsite_url'] ?>assets/img/sad.svg" alt="" />
                    </div>
                    <div class="payment-failed-title"><?= $languageLabelsArr['LBL_PAYMENT_FAILED_TITLE'] ?></div>
                    <p><?php echo $failure_msg; ?></p>
                    <div class="try-again">
                        <button type="button" class="try-again-btn" onclick="window.location.href='<?= $previous_url ?>'; showLoader()"><?= $languageLabelsArr['LBL_LOC_TRY_AGAIN_TXT'] ?></button>
                    </div>
                    <a href="<?= $failure_url ?>&page_action=close" class="close-link"><?= $languageLabelsArr['LBL_CLOSE_TXT'] ?></a>
                    <div class="help-block">
                        <?php 
                            $replace_txt = '<a href="'.$failure_url.'&page_action=contactus">' . $languageLabelsArr['LBL_CONTACT_US_TXT'] . '</a>';
                            $help_text = str_replace("####", $replace_txt, $languageLabelsArr['LBL_PAYMENT_SUPPORT_TXT']);
                            echo $help_text;
                        ?>
                    </div>
                </div>
