...
if (isset($_POST['import'])) {
    ...
    foreach ($sheetData as $key => $value) {
        ...
        try {
            $make = Make::where(['vMake' => $make_name])->first();
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?php echo $SITE_NAME; ?> | Make Import</title>
