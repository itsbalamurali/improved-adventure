...
final class ImageFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $builder = $this->createPartialMock('Imagecraft\\Engine\\PhpGd\\Extension\\Gif\\GifBuilder', null);
        $builderPlus = $this->createPartialMock('Imagecraft\\Engine\\PhpGd\\Extension\\Gif\\GifBuilderPlus', null);
