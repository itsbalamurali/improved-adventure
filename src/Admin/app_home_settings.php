...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?php echo $SITE_NAME; ?> | App Main Screen Settings</title>
                                  ...
                                  <table class="table table-striped table-bordered table-hover">
                                      ...
                                      <tbody>
                                          <?php if (!empty($totalData)) {
                                            ...
                                            <tr class="gradeA">
                                              <td><?php echo $name; ?></td>
                                              <td style="text-align:center;"><?php echo $imgType; ?></td>
                                              <td style="text-align:center;">
                                                <a href="app_home_settings_action.php?PageType=<?php echo $PageType; ?>" data-toggle="tooltip" title="Edit">
