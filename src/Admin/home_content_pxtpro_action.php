...
if (1 === $cubexthemeonh) {
        ...
        foreach ($img_arr as $key => $value) {
            ...
            if (!empty($value['name'])) {
                ...
                if ('how_it_work_section_img' === $key) {
                    ...
                    $key = 'lGeneralBannerSection';
                } elseif ('safety_section_img' === $key) {
                    $key = 'lSecuresafeSection';
                } elseif ('lMainServiceSection_img' === $key) {
                    $key = 'lMainServiceSection';
                } elseif ('lUseSeviceSection_img' === $key) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $safety_section_arr['img'] = $sectionData['img'] ?? '';
        $safety_section_arr = !(empty($sectionData)) ? array_merge($sectionData, $safety_section_arr) : $safety_section_arr;
        // For How it works Added By PJ 25 Sep 2019
        for ($i = 1; $i <= 2; ++$i) {
            $safety_section_arr['ms_title'.$i] = $_POST['safety_section_ms_title'.$i] ?? '';
            $safety_section_arr['ms_desc'.$i] = $_POST['safety_section_ms_desc'.$i] ?? '';
        }
        ...
        $lMainServiceSection_arr['title'] = $_POST['lMainServiceSection_title'] ?? '';
        $lMainServiceSection_arr['desc'] = $_POST['lMainServiceSection_desc'] ?? '';
        $lMainServiceSection_arr['img'] = $sectionData['img'] ?? '';
        $lMainServiceSection_arr = !(empty($sectionData)) ? array_merge($sectionData, $lMainServiceSection_arr) : $lMainServiceSection_arr;
        // For How it works Added By PJ 25 Sep 2019
        for ($i = 1; $i <= 4; ++$i) {
            $lMainServiceSection_arr['ms_title'.$i] = $_POST['lMainServiceSection_ms_title'.$i] ?? '';
            $lMainServiceSection_arr['ms_desc'.$i] = $_POST['lMainServiceSection_ms_desc'.$i] ?? '';
        }
        ...
        $lUseSeviceSection_arr['title'] = $_POST['lUseSeviceSection_title'] ?? '';
        $lUseSeviceSection_arr['img'] = $sectionData['img'] ?? '';
        $lUseSeviceSection_arr = !(empty($sectionData)) ? array_merge($sectionData, $lUseSeviceSection_arr) : $lUseSeviceSection_arr;
        // For How it works Added By PJ 25 Sep 2019
        for ($i = 1; $i <= 2; ++$i) {
            $lUseSeviceSection_arr['ms_title'.$i] = $_POST['lUseSeviceSection_ms_title'.$i] ?? '';
            $lUseSeviceSection_arr['ms_desc'.$i] = $_POST['lUseSeviceSection_ms_desc'.$i] ?? '';
        }
                        ...
                        <div class="body-div innersection">
                            <div class="form-group general_section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="3" name="general_section_desc" id="general_section_desc" placeholder="Description"><?php echo $general_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $general_section['img']) { ?>
                                            <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$general_section['img']; ?>"
                                                 class="innerbg_image"/>
                                        <?php } ?>
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="3" name="how_it_work_section_desc" id="how_it_work_section_desc" placeholder="Description"><?php echo $how_it_work_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <!-- How It Works Blocks -->
                                <div class="row">
                                    ...
                                    <?php for ($i = 1; $i <= 4; ++$i) { ?>
                                        <div class="col-lg-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <input type="text" class="form-control"
                                                           ...
                                                           value="<?php echo $how_it_work_section['hiw_title'.$i]; ?>"
                                                           placeholder="Title">
                                                </div>
                                            </div>
                                            <!-- Description  -->
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <textarea class="form-control" name="how_it_work_section_hiw_desc<?php echo $i; ?>" id="how_it_work_section_hiw_desc<?php echo $i; ?>" value="<?php echo $how_it_work_section['hiw_desc'.$i]; ?>" placeholder="Description" rows="5"><?php echo $how_it_work_section['hiw_desc'.$i]; ?></textarea>
                                                </div>
                                            </div>
                                            <!-- Image  -->
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <?php if ('' !== $how_it_work_section['hiw_img'.$i]) { ?>
                                                        <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=200&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$how_it_work_section['hiw_img'.$i]; ?>"
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="travel_section_title"
                                               id="travel_section_title" value="<?php echo $travel_section['title']; ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="3" name="travel_section_desc" id="travel_section_desc" placeholder="Description"><?php echo $travel_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $travel_section['img']) { ?>
                                            <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$travel_section['img']; ?>"
                                                 class="innerbg_image"/>
                                        <?php } ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="pool_section_title"
                                               id="pool_section_title" value="<?php echo $pool_section['title']; ?>"
                                               placeholder="Title" required>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="3" name="pool_section_desc" id="pool_section_desc" placeholder="Description"><?php echo $pool_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $pool_section['img']) { ?>
                                            <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$pool_section['img']; ?>"
                                                 class="innerbg_image"/>
                                        <?php } ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="lMainServiceSection_title"
                                               ...
                                               value="<?php echo $lMainServiceSection['title']; ?>" placeholder="Title"
                                               required>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="3" name="lMainServiceSection_desc" id="lMainServiceSection_desc" placeholder="Description"><?php echo $lMainServiceSection['desc']; ?></textarea>
                                    </div>
                                </div>
                                    ...
                                    <?php for ($i = 1; $i <= 4; ++$i) { ?>
                                        <div class="col-lg-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <input type="text" class="form-control" name="lMainServiceSection_ms_title<?php echo $i; ?>"
                                                           ...
                                                           value="<?php echo $lMainServiceSection['ms_title'.$i]; ?>"
                                                           placeholder="Title">
                                                </div>
                                            </div>
                                            <!-- Description  -->
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <textarea class="form-control" name="lMainServiceSection_ms_desc<?php echo $i; ?>" id="lMainServiceSection_ms_desc<?php echo $i; ?>" value="<?php echo $lMainServiceSection['ms_desc'.$i]; ?>" placeholder="Description" rows="5"><?php echo $lMainServiceSection['ms_desc'.$i]; ?></textarea>
                                                </div>
                                            </div>
                                            <!-- Image  -->
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <?php if ('' !== $lMainServiceSection['ms_img'.$i]) { ?>
                                                        <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=200&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$lMainServiceSection['ms_img'.$i]; ?>"
                                                             class="innerbg_image"/ style="max-height:100px;">
                                                    <?php } ?>
                                                    <input type="file" class="form-control FilUploader"
                                                           ...
                                                           accept=".png,.jpg,.jpeg,.gif,.svg">
                                                    <br/>
                                                    <span class="notes">[Note: For Better Resolution Upload only image size of 150px * 80px.]</span>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="lUseSeviceSection_title"
                                               ...
                                               value="<?php echo $lUseSeviceSection['title']; ?>" placeholder="Title"
                                               required>
                                    </div>
                                </div>
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $lUseSeviceSection['img']) { ?>
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$lUseSeviceSection['img']; ?>"
                                                 class="innerbg_image"/>
                                        <?php } ?>
                                        <input type="file" class="form-control FilUploader"
                                    ...
                                    <?php for ($i = 1; $i <= 2; ++$i) { ?>
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <input type="text" class="form-control" name="lUseSeviceSection_ms_title<?php echo $i; ?>"
                                                           ...
                                                           value="<?php echo $lUseSeviceSection['ms_title'.$i]; ?>"
                                                           placeholder="Title">
                                                </div>
                                            </div>
                                            <!-- Description  -->
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <textarea class="form-control" name="lUseSeviceSection_ms_desc<?php echo $i; ?>" id="lUseSeviceSection_ms_desc<?php echo $i; ?>" value="<?php echo $lUseSeviceSection['ms_desc'.$i]; ?>" placeholder="Description" rows="5"><?php echo $lUseSeviceSection['ms_desc'.$i]; ?></textarea>
                                                </div>
                                            </div>
                                            <!-- Image  -->
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <?php if ('' !== $lUseSeviceSection['ms_img'.$i]) { ?>
                                                        <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$lUseSeviceSection['ms_img'.$i]; ?>" / >
                                                    <?php } ?>
                                                    <input type="file" class="form-control FilUploader"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="safety_section_main_title"
                                               ...
                                               value="<?php echo $safety_section['main_title']; ?>" placeholder="Title"
                                               required>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="3" name="safety_section_main_desc" id="safety_section_main_desc" placeholder="Description"><?php echo $safety_section['main_desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $safety_section['img']) { ?>
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$safety_section['img']; ?>"
                                                 class="innerbg_image"/>
                                        <?php } ?>
                                        <input type="file" class="form-control FilUploader"
                                    ...
                                    <?php for ($i = 1; $i <= 2; ++$i) { ?>
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <input type="text" class="form-control" name="safety_section_ms_title<?php echo $i; ?>"
                                                           ...
                                                           value="<?php echo $safety_section['ms_title'.$i]; ?>"
                                                           placeholder="Title">
                                                </div>
                                            </div>
                                            <!-- Description  -->
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <textarea class="form-control" name="safety_section_ms_desc<?php echo $i; ?>" id="safety_section_ms_desc<?php echo $i; ?>" value="<?php echo $safety_section['ms_desc'.$i]; ?>" placeholder="Description" rows="5"><?php echo $safety_section['ms_desc'.$i]; ?></textarea>
                                                </div>
                                            </div>
                                            <!-- Image  -->
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <?php if ('' !== $safety_section['ms_img'.$i]) { ?>
                                                        <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$safety_section['ms_img'.$i]; ?>" / >
                                                    <?php } ?>
                                                    <input type="file" class="form-control FilUploader"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="call_section_title"
                                               id="call_section_title" value="<?php echo $call_section['title']; ?>"
                                               placeholder="Title" required>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="3" name="call_section_desc" id="call_section_desc" placeholder="Description"><?php echo $call_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $call_section['img']) { ?>
                                            <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$call_section['img']; ?>"
                                                 class="innerbg_image"/>
                                        <?php } ?>
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="3" name="register_section_main_desc" id="register_section_main_desc" placeholder="Description"><?php echo $register_section['main_desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="3" name="register_section_desc_first" id="register_section_desc_first" placeholder="Description"><?php echo $register_section['desc_first']; ?></textarea>
                                    </div>
                                </div>
                                <!-- <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="3" name="register_section_desc_sec" id="register_section_desc_sec" placeholder="Description"><?php echo $register_section['desc_sec']; ?></textarea>
                                    </div>
                                </div>
                                <!-- <div class="row">
                                    <div class="col-lg-12">
