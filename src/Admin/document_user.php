...
if (isset($_POST['submit'])) {
    ...
    if($id != "") {
		$msg= checkDuplicateAdmin('iAdminId', 'administrators' , Array('vEmail'),$tconfig["tsite_url"]."/".ADMIN_URL_CLIENT."/admin_action.php?success=3&var_msg=Email already Exists", "Email already Exists",$id ,"");
	}else {
		$msg= checkDuplicateAdmin('vEmail', 'administrators' , Array('vEmail'),$tconfig["tsite_url"]."/".ADMIN_URL_CLIENT."/admin_action.php?success=3&var_msg=Email already Exists", "Email already Exists","" ,"");
	}
     if($msg == 1){
        if($id == ""){
                                   ...
                                   <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" pattern="[a-zA-Z]+" class="form-control" name="vLastName"  id="vLastName" value="<?= clearName(" ".$vLastName); ?>" placeholder="Last Name" required>
                                             </div>
                                        </div>
