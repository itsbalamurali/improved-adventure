<?php
	...
	$sql = "select * from ratings_user_driver where iTripId = '".$iTripId."' AND eUserType='Driver' AND vRating1 != '' ";
          				...
          				<div class="fare-breakdown">
                			<div class="fare-breakdown-inner">
                  				...
                  				<ul>
									...
									{
										?>
										<li><strong><?=$langage_lbl['LBL_RIDER_Basic_Fare']; ?></strong><b><?=trip_currency($db_trip[0]['iBaseFare'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li>
										<?php if($APP_TYPE == "UberX") {?>
									...
									else
									{
										...
										<? } else {?>	
											...
											$vVehicleFare = trip_currency($vVehicleFare_price,$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);
				                    ...
				                    <!-- <li><strong><?=$langage_lbl['LBL_RIDER_Commision']; ?></strong><b><?=trip_currency($db_trip[0]['fCommision'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li> -->							
									<?php 
										if($db_trip[0]['fVisitFee'] > 0){ ?> 
										<li><strong><?=$langage_lbl['LBL_VISIT_FEE']; ?></strong><b><?=trip_currency($db_trip[0]['fVisitFee'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li>
										<?php } ?>	
										<?php 
										if($db_trip[0]['fMaterialFee'] > 0){ ?> 
										<li><strong><?=$langage_lbl['LBL_MATERIAL_FEE']; ?></strong><b><?=trip_currency($db_trip[0]['fMaterialFee'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li>
										<?php } ?>	
										<?php 
										if($db_trip[0]['fMiscFee'] > 0){ ?> 
										<li><strong><?=$langage_lbl['LBL_MISC_FEE']; ?></strong><b><?=trip_currency($db_trip[0]['fMiscFee'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li>
										<?php } ?>	
										<?php 
										if($db_trip[0]['fDriverDiscount'] > 0){ ?> 
										<li><strong><?=$langage_lbl['LBL_PROVIDER_DISCOUNT']; ?></strong><b> - <?=trip_currency($db_trip[0]['fDriverDiscount'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li>
										<?php } ?>
				                     <?php if($db_trip[0]['fMinFareDiff']!="" && $db_trip[0]['fMinFareDiff'] > 0){
			                           ...
			                           <li><strong><?=trip_currency($minimum_fare,$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b> <?=$langage_lbl['LBL_RIDER_MINIMUM']; ?>
			                              </strong><b>
			                              <?=trip_currency($db_trip[0]['fMinFareDiff'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li>
									 ...
									 if($db_trip[0]['fTollPrice'] > 0 && $eTollSkipped == "No"){
			                          ?>
									<li><strong><?=$langage_lbl['LBL_TOLL_PRICE_TOTAL']; ?></strong><b><?=trip_currency($db_trip[0]['fTollPrice'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li>
						<?php } ?>
                  				</ul>
                  				<span>
								<?php $paymentMode = ($db_trip[0]['vTripPaymentMode'] == 'Cash')? $langage_lbl['LBL_VIA_CASH_TXT']: $langage_lbl['LBL_VIA_CARD_TXT']?>
                  					...
                  					<em><?=trip_currency($db_trip[0]['fCancellationFare'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></em>
                  					<?php } else {?>
                  					<em><?=trip_currency($db_trip[0]['iFare'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></em>
                  					<?php } ?>
              					</span>
