        ...
        <div class="model-body">
            ...
            <div>
                <div class="form-group newrow">
                    ...
                    <input type="text" autocomplete="off" name="vNamenewsletter"  id="vNamenewsletter" value="<?= !empty($vNamenewsletter) ? $vNamenewsletter : ''; ?>">
                </div>
                <div class="form-group newrow">
                    <label><?= $langage_lbl['LBL_EMAIL_LBL_TXT']; ?></label>
                    <input type="email" autocomplete="off" name="vEmailnewsletter"  id="vEmailnewsletter" value="<?= !empty($vEmailnewsletter) ? $vEmailnewsletter : ''; ?>">
                </div>
            </div>
            <div class="data-row">
            ...
            <div class="form-group  captcha-column newrow">
                    <?php //to solve register page and contact us page captcha issue
                    if(basename($_SERVER['PHP_SELF']) == 'contact_us.php' || basename($_SERVER['PHP_SELF']) == 'sign-up.php'){
