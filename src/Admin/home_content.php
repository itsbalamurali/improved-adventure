...
// print_r(getAppTypeWiseHomeTable());exit;
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="hc.vCode" <?php if ('vCode' === $option) {
                                              echo 'selected';
                                                ...
                                                <?php
                                                        ...
                                                        <tr class="gradeA">
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <a href="home_content_action.php?id=<?php echo $data_drv[$i]['id']; ?>" data-toggle="tooltip" title="Edit">
