...
$manual_order_first_label = $_POST['manual_order_first_label'] ?? '';
$manual_order_second_label = $_POST['manual_order_second_label'] ?? '';
$manual_order_button_label = $_POST['manual_order_button_label'] ?? '';
$manual_order_desc = $_POST['manual_order_desc'] ?? '';
                            ...
                            <form method="post" name="_home_content_form" id="_home_content_form" action="" enctype='multipart/form-data'>
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="header_first_label"  id="header_first_label" value="<?php echo $header_first_label; ?>" placeholder="Home First Section Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="third_sec_desc"  id="third_sec_desc"  placeholder="Home First Section Description" required><?php echo $third_sec_desc; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="third_mid_desc_two1"  id="third_mid_desc_two1"  placeholder="Home First Section First Button Description" required><?php echo $third_mid_desc_two1; ?></textarea>
                                            </div>
                                        </div>
                                        <!--<div class="row">
                                                <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                        <textarea class="form-control ckeditor" rows="10" name="third_mid_desc_one"  id="third_mid_desc_one"  placeholder=">Home First Section Second Button Description" required><?php echo $third_mid_desc_one; ?></textarea>
                                                </div>
                                        </div>
                                        <div class="row">
                                                <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ('' !== $home_banner_left_image) { ?>
                                                    <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$home_banner_left_image; ?>" class="innerbg_image"/>
                                                <?php } ?>
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="header_second_label"  id="header_second_label" value="<?php echo $header_second_label; ?>" placeholder="Home Second Section Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="third_mid_desc_two"  id="third_mid_desc_two"  placeholder="Home Second Section Description" required><?php echo $third_mid_desc_two; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ('' !== $home_banner_right_image) { ?>
                                                    <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$home_banner_right_image; ?>" class="innerbg_image"/>
                                                <?php } ?>
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="third_sec_title"  id="third_sec_title" value="<?php echo $third_sec_title; ?>" placeholder="Home Third Section Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="third_mid_title_one"  id="third_mid_title_one" value="<?php echo $third_mid_title_one; ?>" placeholder="Home Third Section Second Text" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="third_mid_desc_three"  id="third_mid_desc_three"  placeholder="Home Third Section Description" required><?php echo $third_mid_desc_three; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ('' !== $third_mid_image_two) { ?>
                                                    <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$third_mid_image_two; ?>" class="innerbg_image"/>
                                                <?php } ?>
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="third_mid_title_two"  id="third_mid_title_two" value="<?php echo $third_mid_title_two; ?>" placeholder="Home Forth Section First Text" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                        ...
                                        <!--<div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="third_mid_title_three"  id="third_mid_title_three" value="<?php echo $third_mid_title_three; ?>" placeholder="Home Forth Section Second Text" required>
                                                </div>
                                        </div>-->
                                        <div class="row">
                                            <div class="col-lg-12">
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="third_mid_title_one1"  id="third_mid_title_one1" value="<?php echo $third_mid_title_one1; ?>" placeholder="Home Fifth Section Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="taxi_app_right_desc"  id="taxi_app_right_desc"  placeholder="Home Fifth Section Description" required><?php echo $taxi_app_right_desc; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="mobile_app_right_title"  id="mobile_app_right_title" value="<?php echo $mobile_app_right_title; ?>" placeholder="Home Sixth Section Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="mobile_app_right_desc"  id="mobile_app_right_desc"  placeholder="Home Sixth Section Description" required><?php echo $mobile_app_right_desc; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ('' !== $taxi_app_left_img) { ?>
                                                    <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$taxi_app_left_img; ?>" class="innerbg_image"/>
                                                <?php } ?>
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="manual_order_first_label"  id="manual_order_first_label" value="<?php echo $manual_order_first_label; ?>" placeholder="Manual Order Section Main Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="manual_order_second_label"  id="manual_order_second_label" value="<?php echo $manual_order_second_label; ?>" placeholder="Home Seventh Section Second Text" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="manual_order_button_label"  id="manual_order_button_label" value="<?php echo $manual_order_button_label; ?>" placeholder="Home Seventh Order Button Text" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="manual_order_desc"  id="manual_order_desc"  placeholder="Home Seventh Section Description" required><?php echo $manual_order_desc; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ('' !== $manual_order_bg_img) { ?>
                                                    <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$manual_order_bg_img; ?>" class="innerbg_image"/>
                                                <?php } ?>
                                ...
                                <div class="body-div innersection">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="third_mid_title_two1"  id="third_mid_title_two1" value="<?php echo $third_mid_title_two1; ?>" placeholder="Home Middle Section Title" required>
                                        </div>
                                    </div>
                                    <!-- <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                    <textarea class="form-control ckeditor" rows="10" name="third_mid_desc_one1"  id="third_mid_desc_one1"  placeholder="Home Seventh Section Description" required><?php echo $third_mid_desc_one1; ?></textarea>
                                            </div>
                                    </div> -->
                                    <div class="form-group">
                                    ...
                                    ?>
                                                        ...
                                                        <td align="center">
                                                            <?php if ('' !== $vcatdata[$i]['vHomepageLogo']) { ?>
                                                                <img src="<?php echo $tconfig['tsite_upload_home_page_service_images'].'/'.$vcatdata[$i]['vHomepageLogo']; ?>"  style="width:35px;height:35px;">
                                                            <?php } ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $vcatdata[$i]['vCategory_EN']; ?>
                                                        </td>
                                                        <td align="center">
                                                        <center><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#<?php echo $vcatdata[$i]['iVehicleCategoryId']; ?>">Upload</button></center>
                                                        </td>
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <center>
                                                                <form method="post" name="test1"   action="" enctype='multipart/form-data'>
                                                                    <input type="hidden" name="removeid" value="<?php echo $vcatdata[$i]['iVehicleCategoryId']; ?>"/>
                                                                    <input type="hidden" name="backlink" id="backlink" value="home_content_new.php"/>
                                                                    <button type="submit" style="display: none;" id="removeIconFrom_<?php echo $vcatdata[$i]['iVehicleCategoryId']; ?>" style="background-color: transparent; border: none; outline: none;" name="removeicon" id="removeicon" value="remove"><img src="img/delete-icon.png" alt="Delete Icon"></button>
                                                                    <button type="submit" id="removeIconFrom_<?php echo $vcatdata[$i]['iVehicleCategoryId']; ?>" style="background-color: transparent; border: none; outline: none;" data-id="<?php echo $vcatdata[$i]['iVehicleCategoryId']; ?>" name="removeicon" id="removeicon" value="remove" onclick="return deleteIcon(this);"><img src="img/delete-icon.png" alt="Delete Icon"></button>
                                                                </form>
                                                            </center>
                                                        <?php } ?>
...
?>
        ...
        if (!empty($vcatdata)) {
            for ($i = 0; $i < count($vcatdata); ++$i) {
                ?>
                <div class="modal fade" id="<?php echo $vcatdata[$i]['iVehicleCategoryId']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            if (!empty($vcatdata[$i]['vHomepageLogo'])) {
                                                ?>
                                                <img src="<?php echo $tconfig['tsite_upload_home_page_service_images'].'/'.$vcatdata[$i]['vHomepageLogo']; ?>" class="innerbg_image" />
                                            <?php } ?>
                                        </div>
                                        <div class="col-lg-12">
                                            <span><b><?php echo $vcatdata[$i]['vCategory_EN']; ?></b></span>
                                        </div>
