...
if (!empty($img_arr)) {
    ...
    foreach ($img_arr as $key => $value) {
        if (!empty($value['name'])) {
            ...
            if ('benefit_section_img_first' === $key || 'service_section_img_first' === $key || 'secure_section_img_first' === $key) {
                $img_str = 'img_first_';
            } elseif ('benefit_section_img_sec' === $key || 'service_section_img_sec' === $key || 'secure_section_img_sec' === $key) {
                $img_str = 'img_sec_';
            } elseif ('benefit_section_img_third' === $key || 'service_section_img_third' === $key || 'secure_section_img_third' === $key) {
                $img_str = 'img_third_';
            } elseif ('benefit_section_img_fourth' === $key || 'service_section_img_fourth' === $key || 'secure_section_img_fourth' === $key) {
                $img_str = 'img_fourth_';
            } elseif ('benefit_section_img_fifth' === $key || 'service_section_img_fifth' === $key || 'secure_section_img_fifth' === $key) {
                $img_str = 'img_fifth_';
            } elseif ('benefit_section_img_six' === $key || 'service_section_img_six' === $key || 'secure_section_img_six' === $key) {
                $img_str = 'img_six_';
            } else {
                $img_str = 'img_';
            }
            ...
            if ('download_section_img' === $key) {
                ...
                $key = 'lBenefitSection';
            } elseif ('service_section_img' === $key || 'service_section_img_first' === $key || 'service_section_img_sec' === $key || 'service_section_img_third' === $key || 'service_section_img_fourth' === $key || 'service_section_img_fifth' === $key || 'service_section_img_six' === $key) {
                $key = 'lServiceSection';
            }
...
if (isset($_POST['submit'])) {
    ...
    header('location:home_content_delivery_action.php?iVehicleCategoryId='.$iVehicleCategoryId.'&id='.$id);
                                        ...
                                        <div style="display: none;">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-6">
                                                   ...
                                                   <input type="text" class="form-control" name="service_section_main_title"  id="service_section_main_title" value="<?php echo $service_section['main_title_'.$vCode]; ?>" placeholder="Main Title">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               ...
                                               <input type="text" class="form-control" name="secure_section_main_title"  id="secure_section_main_title" value="<?php echo $secure_section['main_title_'.$vCode]; ?>" placeholder="Main Title">
                                        ...
                                        <div class="row"><div class="col-lg-12"><h4>Fleet Data</h4></div>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-11">
                                                   ...
                                                   <input type="text" class="form-control" name="secure_section_title_first" value="<?php echo $secure_section['title_first_'.$vCode]; ?>" placeholder="Main Title">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-11">
                                                    ...
                                                    <?php if ('' !== $secure_section['img_first_'.$vCode]) { ?>
                                                       ...
                                                       <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$secure_section['img_first_'.$vCode]; ?>" class="innerbg_image"/>

                                                    <?php } ?>

                                                   <input type="file" class="form-control" name="secure_section_img_first" value="<?php echo $secure_section['img_first_'.$vCode]; ?>" placeholder="Main Title">

                                                   <span class="notes">[Note: For Better Resolution Upload only image size of 288px * 211px.]</span>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-11">
                                                   ...
                                                   <input type="text" class="form-control" name="secure_section_title_sec" value="<?php echo $secure_section['title_sec_'.$vCode]; ?>" placeholder="Main Title">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-11">
                                                    ...
                                                    <?php if ('' !== $secure_section['img_sec_'.$vCode]) { ?>
                                                       ...
                                                       <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$secure_section['img_sec_'.$vCode]; ?>" class="innerbg_image"/>

                                                    <?php } ?>

                                                   <input type="file" class="form-control" name="secure_section_img_sec" value="<?php echo $secure_section['img_sec_'.$vCode]; ?>" placeholder="Main Title">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-11">
                                                   ...
                                                   <input type="text" class="form-control" name="secure_section_title_third" value="<?php echo $secure_section['title_third_'.$vCode]; ?>" placeholder="Main Title">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-11">
                                                    ...
                                                    <?php if ('' !== $secure_section['img_third_'.$vCode]) { ?>
                                                       ...
                                                       <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$secure_section['img_third_'.$vCode]; ?>" class="innerbg_image"/>



                                                    <?php } ?>

                                                   <input type="file" class="form-control" name="secure_section_img_third" value="<?php echo $secure_section['img_third_'.$vCode]; ?>" placeholder="Main Title">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-11">
                                                   ...
                                                   <input type="text" class="form-control" name="secure_section_title_fourth" value="<?php echo $secure_section['title_fourth_'.$vCode]; ?>" placeholder="Main Title">
                                               ...
                                               <div class="col-lg-11">
                                                    ...
                                                    <?php if ('' !== $secure_section['img_fourth_'.$vCode]) { ?>
                                                     ...
                                                     <!--   <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$secure_section['img_fourth_'.$vCode]; ?>" class="innerbg_image"/> -->
                                                       ...
                                                       <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$secure_section['img_fourth_'.$vCode]; ?>" class="innerbg_image"/>

                                                    <?php } ?>

                                                   <input type="file" class="form-control" name="secure_section_img_fourth" value="<?php echo $secure_section['img_fourth_'.$vCode]; ?>" placeholder="Main Title">
                                        ...
                                        <!--<div class="col-lg-4">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-11">
                                                   ...
                                                   <input type="text" class="form-control" name="secure_section_title_fifth" value="<?php echo $secure_section['title_fifth_'.$vCode]; ?>" placeholder="Main Title">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                     ...
                                                     <?php if ('' !== $secure_section['img_fifth_'.$vCode]) { ?>
                                                        ...
                                                        <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$secure_section['img_fifth_'.$vCode]; ?>" class="innerbg_image"/>

                                                     <?php } ?>

                                                    <input type="file" class="form-control" name="secure_section_img_fifth" value="<?php echo $secure_section['img_fifth_'.$vCode]; ?>" placeholder="Main Title">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-11">
                                                   ...
                                                   <input type="text" class="form-control" name="secure_section_title_six" value="<?php echo $secure_section['title_six_'.$vCode]; ?>" placeholder="Main Title">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                     ...
                                                     <?php if ('' !== $secure_section['img_six_'.$vCode]) { ?>
                                                        ...
                                                        <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$secure_section['img_six_'.$vCode]; ?>" class="innerbg_image"/>

                                                     <?php } ?>

                                                    <input type="file" class="form-control" name="secure_section_img_six" value="<?php echo $secure_section['img_six_'.$vCode]; ?>" placeholder="Main Title">
