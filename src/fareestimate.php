...
<html lang="en" dir="<?php echo (isset($_SESSION['eDirectionCode']) && '' !== $_SESSION['eDirectionCode']) ? $_SESSION['eDirectionCode'] : 'ltr'; ?>">
    <head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=geometry,places&language=en&key=<?php echo $GOOGLE_SEVER_API_KEY_WEB; ?>"></script>
    ...
    <body>
        ...
        <div id="main-uber-page">
            ...
            <!-- End: Top Menu-->
            <!-- contact page-->
            <?php if ('Ride' === $APP_TYPE || 'Ride-Delivery' === $APP_TYPE || 'Ride-Delivery-UberX' === $APP_TYPE || 'Delivery' === $APP_TYPE) { ?>
                <!-- -->
                <div class="get-fare-estimation">
                    <div class="get-fare-estimation-inner">
                        <div class="get-free1">
                            <div class="get-fare-estimation-left ">
                                <h3><?php echo $langage_lbl['LBL_GET_FARE_ESTIMATION_TXT']; ?></h3>
                                <span>
                                    <form name="_fare_estimate_form" id="_fare_estimate_form" method="post" >
                                        ...
                                        <?php if ('Ride-Delivery-UberX' === $APP_TYPE || 'Ride-Delivery' === $APP_TYPE) { ?>
                                            ...
                                            <br/><br/>
                                        <?php } ?>
                                        <b><input name="vPickup" type="text" id="from" placeholder="<?php echo $langage_lbl['LBL_HOME_ADD_PICKUP_LOC']; ?>" class="trip-start" /></b>
                                        <b><input name="vDest" type="text" id="to" placeholder="<?php echo $langage_lbl['LBL_ADD_DESTINATION_LOCATION_TXT']; ?>" class="trip-end" /><button type="button"><i aria-hidden="true" class="fa fa-arrow-right"></i></button></b>
                                    </form>
                                </span>
                                ...
                                <div class="" id="imageIcons" style="width:100%;display:none">
                                    <div align="center">
                                        <img src="default.gif">
                                        <span style="text-transform: lowercase"><?php echo $langage_lbl['LBL_PROCEED'].','.$langage_lbl['LBL_PLEASE_WAIT']; ?>...</span>
                                    </div>
                                </div>
		...
		function getAddress(mDlatitude, mDlongitude, addId,setLatLongField,oldlat,oldlong,oldlatlong,oldAddress) {
                                    ...
                                    var mylatlang = new google.maps.LatLng(mDlatitude, mDlongitude);
                                var result = getReverseGeoCode(addId,setLatLongField,"<?php echo $_SESSION['sess_lang']; ?>",mDlatitude, mDlongitude, oldlat, oldlong, oldlatlong, oldAddress, function(latitude, longitude, address){
                                    go_for_action();
                    ...
                    // $("#map-canvas").gmap3({
                        // getroute: {
                            ...
                            // callback: function (results, status) {
                                ...
                                // chk_route = status;
                                // if (!results) {
                                    // alert('<?php echo $langage_lbl['LBL_PLEASE_ENTER_VALID_LOCATION']; ?>');
                                    // return false;
                                // }
                                // $(this).gmap3({
                                    // map: {
