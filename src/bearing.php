...
{
    $bearingradians = atan2(
        asin($long1 - $long2) * cos($lat2),
        cos($lat1) * sin($lat2) - sin($lat1) * cos($lat2) * cos($long1 - $long2)
    );

    return abs(rad2deg($bearingradians));
}
...
echo bearing1(23.013_826, 72.503_887, 23.026_741, 72.507_664);
