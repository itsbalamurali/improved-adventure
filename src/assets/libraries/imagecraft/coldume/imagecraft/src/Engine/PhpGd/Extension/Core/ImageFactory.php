...
class ImageFactory
{
     ...
     * @param mixed[]          $options
     */
    protected function initContents(array $layers, $options): void
    {
    ...
    protected function initImageAwareLayerResource(ImageAwareLayerInterface $layer): void
    {
        ...
        } elseif ($layer instanceof BackgroundLayerInterface && PhpGdContext::FORMAT_PNG === $layer->get('image.format')) {
