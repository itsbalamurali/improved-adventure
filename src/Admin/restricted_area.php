...
if ('' !== $keyword) {
    if ('' !== $option) {
        if ('' !== $eStatus) {
            $ssql .= ' AND '.stripslashes($option)." LIKE '%".clean($keyword)."%' AND ra.eStatus = '".clean($eStatus)."'";
        } else {
            $ssql .= ' AND '.stripslashes($option)." LIKE '%".clean($keyword)."%' AND ra.eStatus != 'Deleted'";
        }
    } else {
        if ('' !== $eStatus) {
            $ssql .= " AND (lm.vLocationName LIKE '%".clean($keyword)."%' OR ra.eType LIKE '%".clean($keyword)."%' OR ra.eRestrictType LIKE '%".clean($keyword)."%') AND ra.eStatus = '".clean($eStatus)."'";
        } else {
            $ssql .= " AND (lm.vLocationName LIKE '%".clean($keyword)."%' OR ra.eType LIKE '%".clean($keyword)."%' OR ra.eRestrictType LIKE '%".clean($keyword)."%') AND ra.eStatus != 'Deleted'";
        }
    }
} else {
    if ('' !== $eStatus) {
        $ssql .= " AND ra.eStatus = '".clean($eStatus)."'";
    } else {
...
<head>
    <meta charset="UTF-8"/>
    <title><?php echo $SITE_NAME; ?> | Restricted Area</title>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="Reset" class="btnalt button11"
                                   onClick="window.location.href='restricted_area.php'"/>
                        </td>
                        <?php if ($userObj->hasPermission('create-restricted-area')) { ?>
                            <td width="20%">
                                <a class="add-btn" href="restricted_area_action.php" style="text-align: center;">Add
                                    Restricted Area
                                </a>
                            </td>
                        <?php } ?>
                            ...
                            <form class="_list_form" id="_list_form" method="post"
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(4,<?php if ('4' === $sortby) {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Address <?php if (4 === $sortby) {
                                                   if (0 === $order) { ?>
                                            ...
                                            <th width="15%">
                                                <a href="javascript:void(0);"
                                                   onClick="Redirect(5,<?php if ('5' === $sortby) {
                                                       echo $order;
                                                   } else { ?>0<?php } ?>)">Area <?php if (5 === $sortby) {
                                                       if (0 === $order) { ?>
                                                            <i class="fa fa-sort-amount-asc"
                                                               aria-hidden="true"></i> <?php } else { ?>
                                        ...
                                        <th width="15%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(7,<?php if ('7' === $sortby) {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Type <?php if (7 === $sortby) {
                                                   if (0 === $order) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                        ...
                                        <th width="6%" class='align-center'>
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(6,<?php if ('6' === $sortby) {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Status <?php if (6 === $sortby) {
                                                   if (0 === $order) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                        ...
                                        <?php if ($userObj->hasPermission(['edit-restricted-area', 'update-status-restricted-area', 'delete-restricted-area'])) { ?>
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td align="center" style="text-align:center;">
                                                    <input type="checkbox" id="checkbox" name="checkbox[]"
                                                           value="<?php echo $db_data[$i]['iRestrictedNegativeId']; ?>"/>&nbsp;
                                                </td>
                                                <?php } ?>
                                                ...
                                                <td width="20%" align="center" class="center">
                                                    <?php if ('Active' === $db_data[$i]['eStatus']) {
                                                        $dis_img = 'img/active-icon.png';
                                                    } elseif ('Inactive' === $db_data[$i]['eStatus']) {
                                                        $dis_img = 'img/inactive-icon.png';
                                                    } elseif ('Deleted' === $db_data[$i]['eStatus']) {
                                                        $dis_img = 'img/delete-icon.png';
                                                    } ?>
                                                    <img src="<?php echo $dis_img; ?>" alt="<?php echo $db_data[$i]['eStatus']; ?>"
                                                         data-toggle="tooltip" title="<?php echo $db_data[$i]['eStatus']; ?>">
                                                </td>
                                                <?php if ($userObj->hasPermission(['edit-restricted-area', 'update-status-restricted-area', 'delete-restricted-area'])) { ?>
                                                    <td align="center" style="text-align:center;" class="action-btn001">
                                                        <div class="share-button  openHoverAction-class"
                                                            ...
                                                            <div class="social show-moreOptions leastcol openPops_<?php echo $db_data[$i]['iRestrictedNegativeId']; ?>">
                                                                <ul>
                                                                    <?php if ($userObj->hasPermission('edit-restricted-area')) { ?>
                                                                        <li class="entypo-twitter"
                                                                            data-network="twitter">
                                                                            <a href="restricted_area_action.php?restricted_id=<?php echo $db_data[$i]['iRestrictedNegativeId']; ?>"
                                                                    ...
                                                                    <?php if ($userObj->hasPermission('update-status-restricted-area')) { ?>
                                                                        <li class="entypo-facebook"
                                                                            ...
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?php echo $db_data[$i]['iRestrictedNegativeId']; ?>','Inactive')"
                                                                        ...
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?php echo $db_data[$i]['iRestrictedNegativeId']; ?>','Active')"
                                                                    ...
                                                                    <?php if ($userObj->hasPermission('delete-restricted-area')) { ?>
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatusDelete('<?php echo $db_data[$i]['iRestrictedNegativeId']; ?>')"
