...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?php echo $SITE_NAME; ?> | Food Home Page</title>
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($data_drv)) {
                                                    for ($i = 0; $i < count($data_drv); ++$i) {
                                                        ...
                                                        ?>
                                                        <tr class="gradeA">
                                                            <td>Food Page - <?php echo $data_drv[$i]['vTitle']; ?></td>
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <a href="home_content_food_action.php?id=<?php echo $data_drv[$i]['iLanguageMasId']; ?>" data-toggle="tooltip" title="Edit">
