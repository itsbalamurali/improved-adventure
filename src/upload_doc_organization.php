...
if ('photo' === $action) {
    ...
    if ('' !== $image_name || 'NONE' !== $image_name) {
        ...
        */
        ...
        if (1 === $flag_error) {
            getPostForm($_POST, $var_msg, 'organization-profile.php?success=0&var_msg='.$var_msg);
...
function check_email_send($iDriverId, $tablename, $field)
{
    ...
    // $valid=0;
    if ('register_driver' === $tablename) {
        if (null !== $db_data[0]['vNoc'] && null !== $db_data[0]['vLicence'] && null !== $db_data[0]['vCerti']) {
        ...
        if (null !== $db_data[0]['vNoc'] && null !== $db_data[0]['vCerti']) {
