...
class TextLayerPass extends AbstractLayerPass
{
     ...
     */
    public function processFont(TextLayerInterface $layer): void
    {
    ...
    public function processLabel(TextLayerInterface $layer): void
    {
    ...
    public function processAngle(TextLayerInterface $layer): void
    {
    ...
    public function processLineSpacing(TextLayerInterface $layer): void
    {
    ...
    public function processBox(TextLayerInterface $layer): void
    {
