											...
											<? for ($i = 0; $i < count($data_drv); $i++) { ?>
												<tr class="gradeA">
													...
													<td width="10%" align="center">
														<a href="menuitems.php?iMenuItemId=<?= $data_drv[$i]['iMenuItemId']; ?>&menu_itemid=<?= $menu_itemid; ?>&Status=<?= ($data_drv[$i]['eStatus'] == "Active") ? 'Inactive' : 'Active' ?>" class="gen-btn small-btn">
													...
													<td align="center">
														<a href="menu_item_action.php?id=<?= $data_drv[$i]['iMenuItemId']; ?>&menu_itemid=<?= $menu_itemid; ?>&action=edit" class="gen-btn small-btn"><?=$langage_lbl['LBL_DRIVER_EDIT']; ?>
														</a>
													</td>
													<td align="center">
														<form name="delete_form_<?= $data_drv[$i]['iMenuItemId']; ?>" id="delete_form_<?= $data_drv[$i]['iMenuItemId']; ?>" method="post" action="" class="margin0">
															...
															<input type="hidden" name="menu_itemid" id="menu_itemid" value="<?= $menu_itemid; ?>">
		...
		$(document).ready(function() {
			...
			var dt = $('#dataTables-example').dataTable({
				...
				"ajax":{
					...
					type:"POST",
					data:{menu_itemid:"<?php echo $menu_itemid;?>"},
					dataType:"json"
				},
				"aaSorting": [],
				"pageLength": 10,
