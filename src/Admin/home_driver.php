							...
							<tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
										...
										<option value="vName_<?php echo $default_lang; ?>" <?php if ($option === 'vName_'.$default_lang) {
										    echo 'selected';
										}?> >Name</option>
                                    ...
                                    <td width="30%"><a class="add-btn" href="home_driver_action.php" style="text-align: center;">Add <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?></a></td>
                                   	<?php } ?>
								</tr>
							</tbody>
						</table>
														...
														<tr class="gradeA">
															...
															<td align="center" style="text-align:center;">
																<?php if ('Yes' !== $data_drv[$i]['eStatus']) {?>
																	...
																	<?php } else { ?><img src="img/active-icon.png" alt="image" data-toggle="tooltip" title="<?php echo $data_drv[$i]['eStatus']; ?>">
																<?php } ?>
															</td>
                                                            <td align="center" style="text-align:center;" class="action-btn001">
																...
																<div class="social show-moreOptions openPops_<?php echo $data_drv[$i]['iDriverId']; ?>">
																	<ul>
																		<li class="entypo-twitter" data-network="twitter"><a href="home_driver_action.php?id=<?php echo $data_drv[$i]['iDriverId']; ?>" data-toggle="tooltip" title="Edit">
