...
if (isset($_SERVER['HTTP_HOST']) && ('192.168.1.131' === $_SERVER['HTTP_HOST'] || '192.168.1.141' === $_SERVER['HTTP_HOST'])) {
    $deleteAction = 1;
}
$script = 'service_category';
// get cusine
$hdn_del_id = $_POST['hdn_del_id'] ?? '';
$iServiceId = $_GET['iServiceId'] ?? '';
$status = $_GET['status'] ?? '';
...
if ('' !== $keyword) {
    if ('' !== $option) {
        ...
        if ('' !== $eStatus) {
            $ssql .= ' AND vServiceName_'.$default_lang." LIKE '%".$keyword."%' AND eStatus = '".clean($eStatus)."'";
        } else {
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?php echo $SITE_NAME; ?> | DeliveryAll Service Category</title>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                            ...
                                            <option value="vServiceName_<?php echo $default_lang; ?>" <?php if ($option === 'vServiceName_'.$default_lang) {
                                                echo 'selected';
                            ...
                            <div class="col-lg-12">
                                <div class="admin-nir-export">
                                    <div class="changeStatus col-lg-12 option-box-left">
                                        ...
                                        <?php if ('Deleted' !== $eStatus && 1 === $deleteAction) {  ?>
...
<?php } ?>
        ...
        <?php if (!empty($data_drv[$i]['vImage'])) { ?>
                                                                    <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=200&src='.$tconfig['tsite_upload_service_categories_images'].''.$data_drv[$i]['vImage']; ?>" class="thumbnail" style="max-width: 100px; max-height: 100px;margin:0;"/>
        <?php } ?>
                                                            </td>
            ...
            $dis_img = 'img/delete-icon.png';
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions leastcol openPops_<?php echo $data_drv[$i]['iServiceId']; ?>">
                                                                        <ul>
                                                                            <li class="entypo-twitter" data-network="twitter"><a href="service_category_action.php?id=<?php echo $data_drv[$i]['iServiceId']; ?>" data-toggle="tooltip" title="Edit">
