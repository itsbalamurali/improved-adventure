...
if($type=='getNearestFlyStations_booking') {
	...
	$data_arr = json_decode(str_replace("\\", "", $data),true);
                ...
                <label class='veh-left cursor-pointer'>
                    <div class='radio-main'>
                        <span class='radio-hold'>
                            <input type='radio' name='iLocationId' required onChange="savelocationid(this.value,'<?= $fromto; ?>');" value="<?= $value['iLocationId'] ?>" <?=$selected ?>> 
                            <!--<input type='radio' name='iLocationId' required onChange="savelocationid(this.value,'<?= $fromto; ?>'); triggerflystations('<?= $fromto; ?>');" value="<?= $value['iLocationId'] ?>" <?=$selected ?>> triggerflystations commented becoz when second time change to location then station not change becoz of this two time called savelocationid so..-->
