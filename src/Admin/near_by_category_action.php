...
$vTextColor = $_POST['vTextColor'] ?? '#000000';
...
if (isset($_POST['submit'])) {
    ...
    if ('Add' === $action && !$userObj->hasPermission('create-category-nearby')) {
        $_SESSION['success'] = 3;
    ...
    if ('Edit' === $action && !$userObj->hasPermission('edit-category-nearby')) {
        $_SESSION['success'] = 3;
...
if ('Edit' === $action) {
    ...
    $parentid = $nearbyCategory['iParentId'];
...
<head>
    <meta charset="UTF-8"/>
    <title>Admin | NearBy Category <?php echo $action; ?></title>
                ...
                <div class="form-group">
                    ...
                    <form method="post" action="" enctype="multipart/form-data" id="nearby_category_form">
                                    ...
                                    <div class="modal-content nimot-class">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            for ($i = 0; $i < $count_all; ++$i) {
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <label>Category Name (<?php echo $vTitle; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <input required type="text" class="form-control" id="vTitle_<?php echo $default_lang; ?>"
                            ...
                            <div class="col-lg-6">
                                <?php if ('' !== $vIconImage) { ?>
                                    <div class="marginbottom-10">
                                        <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?w=150&src='.$tconfig['tsite_upload_images_nearby_item'].$vIconImage; ?>">
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <select name="iDisplayOrder" class="form-control">
                                    <?php for ($i = 1; $i <= $maxDisplayOrder; ++$i) { ?>
                                        <option value="<?php echo $i; ?>" <?php echo $iDisplayOrder === $i ? 'selected' : ''; ?> <?php if (('Add' === $action) && ($i === $maxDisplayOrder)) {
                                            echo 'selected';
                                        }?>>
                                            <?php echo $i; ?></option>
                                    <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="submit" class="save btn-info" name="submit" id="submit"
                                       value="<?php echo $action.' '.'NearBy Category'; ?>"
