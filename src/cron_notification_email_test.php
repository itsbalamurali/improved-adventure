<?php  
	...
	$query = "SELECT * FROM cab_booking WHERE iDriverId != '0' AND ( eStatus = 'Pending' OR eStatus = 'Assign' ) AND eMessageSend = 'No' AND eAutoAssign = 'No' AND iCabBookingId = '14'";
    ...
    function get_DriverDetail($id,$booking_date,$iUserId,$BookingNo,$vTimeZone){
        ...
        $systemTimeZone = date_default_timezone_get();
    		...
    		$scheduleDate = converToTz($booking_date,$systemTimeZone,$vTimeZone); 
