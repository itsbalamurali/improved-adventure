                ...
                <div class="form-group">
                    ...
                    <form method="post" name="_home_content_form" id="_home_content_form" action=""
                        ...
                        <div class="body-div innersection">
                         ...
                         <?php /*<div class="body-div innersection">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="benefit_section_main_title"
                                               ...
                                               value="<?= $benefit_section['main_title_' . $vCode]; ?>"
                                ...
                                <!-- <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="benefit_section_menu_title"
                                               ...
                                               value="<?= $benefit_section['menu_title_' . $vCode]; ?>"
                                               placeholder="Menu Title">
                                    </div>
                                </div> -->
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  ...
                                                  placeholder="Main Description"><?= $benefit_section['main_desc_' . $vCode]; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <? if ($benefit_section['img_' . $vCode] != '') { ?>
                                            <img src="<?= $tconfig["tsite_url"] . 'resizeImg.php?h=300&src=' . $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $benefit_section['img_' . $vCode]; ?>"
                                                 class="innerbg_image"/>
                                        <? } ?>
                                        <input type="file" class="form-control" name="benefit_section_img"
                                               value="<?= $benefit_section['img_' . $vCode]; ?>"
