...
for ($r = 0; $r < count($getConfig); ++$r) {
    if (isset($getConfig[$r]['vName']) && 'PUBSUB_TECHNIQUE' === $getConfig[$r]['vName']) {
        $PUBSUB_TECHNIQUE = $getConfig[$r]['vValue'];
    }
    if (isset($getConfig[$r]['vName']) && 'YALGAAR_CLIENT_KEY' === $getConfig[$r]['vName']) {
        $YALGAAR_CLIENT_KEY = $getConfig[$r]['vValue'];
    }
}
$iTripId = $_REQUEST['iTripId'] ?? '';
// $iTripId = decrypt($iTripId);
$iTripId = base64_decode(base64_decode($iTripId, true), true);
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?php echo $SITE_NAME; ?> | Live tracking </title>
         <?php if ('Simple Refresh' === $trackingMethod && 0 === $enablePubnub && 0 === $enableSocketCluster) { ?>
    ...
    <body class="padTop53 " >
              ...
              <div class="page-contant page-contant trip-tracking-main">
                <div class="page-contant-inner trip-tracking">
                    <h2 class="header-page add-car-vehicle">
                        <?php echo clearName($riderName); ?>'s Trip
                        <font class="trip-start">On Trip</font>
                    </h2>
                    <?php if (isset($db_dtrip[0]['iActive']) && 'Active' === $db_dtrip[0]['iActive'] || isset($db_dtrip[0]['iActive']) && 'On Going Trip' === $db_dtrip[0]['iActive']) { ?>
                        <div class="map-page" style="display:none; width: 100%">
                            <div class="panel-heading location-heading">
                                <i class="icon-map-marker"></i>
                                <?php echo $langage_lbl['LBL_LOCATIONS_TXT']; ?>
                            </div>
                        ...
                        <div class="trip-track-cub" style="width: 100%;">
                            <div class="trip-track-cub-left" style=" margin-top: 45px !important;">
                                ...
                                <div class="trip-track-cub-left-l-sec">
                                    <div class="trip-track-cub-left-l-ab-11"><h2><?php echo $vehicle_modal; ?></h2></div>
                                    <div class="trip-track-cub-left-l-bb-11"><b><?php echo $vehicle_number; ?></b></div>
                                </div>
                            </div>
                            <div class="trip-track-cub-right-11">
                                <div class="trip-track-lrft-text">
                                    <b><?php echo clearName($driverName); ?></b>
                                    <a href="javascript:void(0);">
                                        <?php echo $starHtml; ?>
                                    </a>
                                    <span><?php echo clearPhone($phone); ?></span>
                                </div>
                                <div class="trip-track-right-img">
                                    <div class="driver-profile-img">
                                        <a href="javascript:void(0);">
                                            <img src="<?php echo $driver_avatar; ?>" title="<?php echo clearName($driverName); ?>" alt="<?php echo clearName($driverName); ?>">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php } elseif (isset($db_dtrip[0]['iActive']) && 'Finished' === $db_dtrip[0]['iActive']) { ?>
                        <br><br><br><br>
                        <div class="row Msgbox">
                            <div class="alert alert-danger paddiing-10">
                                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                <?php echo $langage_lbl['LBL_TRIP_IS_FINISHED']; ?>.
                            </div>
                        </div>
                    <?php } elseif (isset($db_dtrip[0]['iActive']) && 'Canceled' === $db_dtrip[0]['iActive']) { ?>
                        <br><br><br><br>
                        <div class="row Msgbox">
                            <div class="alert alert-danger paddiing-10">
                                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                <?php echo $langage_lbl['LBL_CANCELED_TRIP_TXT']; ?>.
                            </div>
                        </div>
                    <?php } else { ?>
                        <br><br><br><br>
                        <div class="row Msgbox">
                            <div class="alert alert-danger paddiing-10">
                                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                <?php echo $langage_lbl['LBL_TRIP_TXT'].' '.$langage_lbl['LBL_NOT_FOUND']; ?>.
                            </div>
                        </div>
                    <?php } ?>
        ...
        <script type="text/javascript" src="<?php echo $tconfig['tsite_url']; ?>assets/libraries/scClient-js/socketcluster-client.js"></script>
        <script type="text/javascript" src="<?php echo $tconfig['tsite_url']; ?>assets/js/socketclustercls.js"></script>
        <script>
            ...
            function initialize() {
                var ajaxData = {
                    'URL': '<?php echo $tconfig['tsite_url_main_admin']; ?>ajax_getdriver_detail.php',
