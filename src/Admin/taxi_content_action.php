            ...
            <div class="body-div">
                <div class="form-group">
                    ...
                    <form method="post" name="_home_content_form" id="_home_content_form" action=""
                        ...
                        <?php if (ONLY_MEDICAL_SERVICE === 'No' && '174' === $iVehicleCategoryId) {
                            // if (ONLY_MEDICAL_SERVICE == "No" && $iVehicleCategoryId != 326) {?>
                            <div class="body-div innersection">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h3>Calculate Section</h3>
                                        </div>
                                    </div>
                                    <!-- <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="calculate_section_menu_title"
                                                   id="calculate_section_menu_title"
                                                   value="<?php echo $calculate_section['menu_title_'.$vCode]; ?>"
                                                   placeholder="Menu Title">
                                        </div>
                                    </div> -->
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="calculate_section_title"
                                                   id="calculate_section_title"
                                                   value="<?php echo $calculate_section['title_'.$vCode]; ?>"
                                                   placeholder="Title" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea class="form-control ckeditor" rows="10"
                                                      name="calculate_section_desc" id="calculate_section_desc"
                                                      placeholder="Description"><?php echo $calculate_section['desc_'.$vCode]; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <?php if ('' !== $calculate_section['img_'.$vCode]) { ?>
                                                <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$calculate_section['img_'.$vCode]; ?>"
                                                     class="innerbg_image"/>
                                            <?php } ?>
                                            <input type="file" class="form-control FilUploader"
                                                   name="calculate_section_img" id="calculate_section_img"
