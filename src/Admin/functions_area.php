...
if ('' !== $country_main_id) {
    ...
    if (empty($db_data_country_main)) {
        ...
        for ($i = 0; $i < count($db_data_country_main); ++$i) {
            if ($country_main_id) {
                echo "<option value='".$db_data_country_main[$i]['iCountryId']."'>";
                echo $db_data_country_main[$i]['vCountry'];
                echo '</option>';
            }
        }
    }
...
if ('' !== $country_id) {
    ...
    if (empty($db_data_state)) {
        ...
        for ($i = 0; $i < count($db_data_state); ++$i) {
            if ($country_id) {
                echo "<option  value='".$db_data_state[$i]['iStateId']."'>";
                echo $db_data_state[$i]['vState'];
                echo '</option>';
            }
        }
    }
...
if ('' !== $state_id) {
    ...
    for ($i = 0; $i < count($db_data_city); ++$i) {
        if ($state_id) {
            echo "<option name='vCity' value='".$db_data_city[$i]['iCityId']."'>";
            echo $db_data_city[$i]['vCity'];
            echo '</option>';
        }
    }
}
