...
$kiosk_section = $LANG_OBJ->checkOtherLangDataExist(json_decode($ride_data[0]['lKioskSection'],true),$vCode,$inner_key);
...
<head>
    ...
    <title><?=$SITE_NAME?> | <?= !empty($catname) ? $catname : $langage_lbl['LBL_RIDE'] ?></title>
    <!--
