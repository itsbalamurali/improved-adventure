...
<head>
    <meta charset="UTF-8"/>
    <title><?php echo $SITE_NAME; ?> | SMS Template</title>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="Reset" class="btnalt button11"
                                   onClick="window.location.href='sms_template.php'"/>
                        </td>
                        <td width="30%">
                            ...
                            <form class="_list_form" id="_list_form" method="post"
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(3,<?php if ('3' === $sortby) {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">SMS Title <?php if (3 === $sortby) {
                                                   if (0 === $order) { ?>
                                        ...
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(1,<?php if ('1' === $sortby) {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">SMS Code <?php if (1 === $sortby) {
                                                   if (0 === $order) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                        ...
                                        <?php if ($userObj->hasPermission('edit-sms-templates')) { ?>
                                        <th width="8%" align="center" style="text-align:center;">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(5,<?php if ('4' === $sortby) {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Edit <?php if (2 === $sortby) {
                                                   if (0 === $order) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td align="center" style="text-align:center;" class="action-btn001">
                                                    <!--<div class="share-button openHoverAction-class" style="display: block;">
                                                                    <label class="entypo-export"><span><a href="page_action.php?id=<?php echo $data_drv[$i]['iSMSId']; ?>" data-toggle="tooltip" title="Edit">
                                                                                <img src="img/edit-icon.png" alt="Edit">
                                                                            </a></span></label>
                                                                    <div class="social show-moreOptions openPops_<?php echo $data_drv[$i]['iSMSId']; ?>">
                                                        ...
                                                        <div class="share-button openHoverAction-class"
                                                            ...
                                                            <label class="entypo-twitter" data-network="twitter"
                                                                ...
                                                                <a href="sms_template_action.php?id=<?php echo $data_drv[$i]['iSendMessageId']; ?>"
                                                            ...
                                                            <div class="social show-moreOptions openPops_<?php echo $data_drv[$i]['iSendMessageId']; ?>">
                                                                <!--<ul>-->  <!-- </ul>-->
                                                            </div>
                                                        </div>
