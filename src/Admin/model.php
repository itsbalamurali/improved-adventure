...
if ('' !== $hdn_del_id) {
    if (SITE_TYPE !== 'Demo') {
        ...
        header('Location:model.php?success=2');
...
$eStatussql .= " AND mk.eStatus != 'Deleted'";
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?php echo $SITE_NAME; ?> | Model</title>
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option  value="mo.vTitle" <?php if ('mo.vTitle' === $option) {
                                              echo 'selected';
                                          } ?> >Title</option>
                                           <option  value="mk.vMake" <?php if ('mk.vMake' === $option) {
                                               echo 'selected';
                                           } ?> >Make</option>
                                          <option value="mo.eStatus" <?php if ('mo.eStatus' === $option) {
                                              echo 'selected';
                                          } ?> >Status</option>
                                    </select>
                                    </td>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="35%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if ('1' === $sortby) {
                                                            echo $order;
														 ...
														 <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if ('2' === $sortby) {
														     echo $order;
														 } else { ?>0<?php } ?>)">Make<?php if (2 === $sortby) {
														     if (0 === $order) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
														     } else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>

                                                        <th width="9%" align="center" style="text-align:center;"><a href="javascript:void(0);" onClick="Redirect(4,<?php if ('4' === $sortby) {
                                                            echo $order;
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td><?php echo $data_drv[$i]['vMake']; ?></td>
                                                        <td align="center" style="text-align:center;">
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class " style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions leastcol openPops_<?php echo $data_drv[$i]['iModelId']; ?>">
                                                                        <ul>
                                                                            <li class="entypo-twitter" data-network="twitter"><a href="model_action.php?id=<?php echo $data_drv[$i]['iModelId']; ?>" data-toggle="tooltip" title="Edit">
