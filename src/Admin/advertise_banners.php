...
if ($sortby == 1) {
    if ($order == 0) $ord = " ORDER BY vBannerTitle ASC"; else
...
if ($sortby == 4) {
    if ($order == 0) $ord = " ORDER BY iDispOrder ASC"; else
        ...
        <div class="inner">
            <div id="add-hide-show-div" class="vehicleCategorylist">
                ...
                <hr/>
					...
					onClick="window.location.href = 'advertise_banners.php'"/>
                                    </td>

                                    <?php //if ($parent_ufx_catid == "0") { ?>
                                        <?php if ($userObj->hasPermission('create-advertise-banner')) { ?>
					  <td width="30%">
					  <a class="add-btn" href="advertise_banner_action.php" style="text-align: center;">Add 
					  Banner
					  </a>
					  </td>
                                        <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="panel-heading">
                                <div class="addtype_options" id="addtype_options" style="display: inline-flex;">
                                    <label for="textfield">Advertisement Display Type:
                                        <span class="red" style="float: none;"> *</span>
                                        <i class="icon-question-sign" data-placement="top" data-toggle="tooltip"
                                           data-original-title="Select the display type as Sequential, if you want Advertisement to be display one after the other. or select the type as Randon if you want any add to display randomly."></i>
                                    </label>
                                    <select name="addtype" onchange="updateAddType(this.value);" id="addtype_value"
                                            class="form-control">
						    ...
						    <input type="checkbox" id="setAllCheck" >
						     ...
						     <a href="javascript:void(0);" onClick="Redirect(1,<?php
                                        ...
                                        <th width="10%" style="text-align:center;">Total Impression
                                            <i class="icon-question-sign" data-placement="bottom" data-toggle="tooltip"
                                               data-original-title="It is total impression by all users"></i>
                                        </th>
                                        <th width="10%" style="text-align:center;">Used Impression
                                            <i class="icon-question-sign" data-placement="bottom" data-toggle="tooltip"
                                               data-original-title="Count shows used impression by all users"></i>
                                        </th>
                                        ...
                                        <?php if ($userObj->hasPermission(['edit-advertise-banner', 'update-status-advertise-banner', 'delete-advertise-banner'])) { ?>
                                    ...
                                    if (!empty($data_drv)) {
                                        for ($i = 0; $i < count($data_drv); $i++) {
                                            ...
                                            <tr class="gradeA">
                                                <?php if ($userObj->hasPermission(['update-status-advertise-banner', 'delete-advertise-banner'])) { ?>
                                                    <td align="center" style="text-align:center;">
                                                        <input type="checkbox" id="checkbox" name="checkbox[]"
                                                               value="<?php echo $data_drv[$i]['iAdvertBannerId']; ?>"/>&nbsp;
                                                    </td>
                                                <?php } ?>
                                                <td align="center">
                                                ...
                                                <td align="center"><? echo DateTime($data_drv[$i]['dAddedDate']); ?></td>
                                                <td align="center"><? echo $impressionCount; ?></td>
                                                <?php if ($bannerUsedCount > 0) { ?>
                                                    <td align="center">
                                                        <button type="button" class="btn btn-primary btn-new"
                                                                title="<?= $data_drv[$i]['tRedirectUrl'] ?>"
                                                                onclick='window.open("banner_impression.php?id=<?= $data_drv[$i]['iAdvertBannerId']; ?>", "_blank")'>
                                                            <b><?= $bannerUsedCount; ?></b>
                                                        </button>
                                                    </td>
                                                <?php } else { ?>
                                                    ...
                                                    <td align="center" style="text-align:center;" class="action-btn001">
                                                        <div class="share-button openHoverAction-class"
                                                            ...
                                                            <div class="social show-moreOptions for-five openPops_<?= $data_drv[$i]['iAdvertBannerId']; ?>">
                                                                <ul>
                                                                    <?php if ($userObj->hasPermission('edit-advertise-banner')) { ?>
                                                                        <li class="entypo-twitter"
                                                                            data-network="twitter">
                                                                            <a href="advertise_banner_action.php?id=<?= $data_drv[$i]['iAdvertBannerId']; ?>&usedcount=<?= $bannerUsedCount; ?>"
                                                                    ...
                                                                    <?php if ($userObj->hasPermission('update-status-advertise-banner')) { ?>
                                                                        <li class="entypo-facebook"
                                                                            ...
                                                                            <a href="javascript:void(0);"
                                                                               onClick="changeStatus('<?php echo $data_drv[$i]['iAdvertBannerId']; ?>', 'Inactive')"
                                                                        ...
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onClick="changeStatus('<?php echo $data_drv[$i]['iAdvertBannerId']; ?>', 'Active')"
                                                                    ...
                                                                    <?php if ($eStatus != 'Deleted' && $userObj->hasPermission('delete-advertise-banner')) { ?>
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onClick="changeStatusDelete('<?php echo $data_drv[$i]['iAdvertBannerId']; ?>')"
            ...
            <div class="admin-notes">
                <h4>Notes:</h4>
                <ul>
                    <li><?php echo $langage_lbl_admin['LBL_ADVERTISEMENT_BANNERS_TXT_ADMIN']; ?> module will list
                        all <?php echo $langage_lbl_admin['LBL_ADVERTISEMENT_BANNERS_TXT_ADMIN']; ?> on this page.
                    </li>
                    <li>Administrator can Activate / Deactivate / Delete
                        any <?php echo $langage_lbl_admin['LBL_ADVERTISEMENT_BANNERS_TXT_ADMIN']; ?>.
                    </li>
                    <!--<li>Administrator can export data in XLS or PDF format.</li>-->
                    <li>The advertisement will display one at a time.</li>
                    <li>The advertisement will be shown each time the Application is open or reopen from the background
                        after X minutes.
                    </li>
                    <li>Set the advertisement frequency time from the general settings, where the next advertisement
                        display after X Minutes when the app reopen from the background.
                    </li>
                    <li>The advertisement will stop publishing when the Impressions / Click Counts reached its limit.
                    </li>
