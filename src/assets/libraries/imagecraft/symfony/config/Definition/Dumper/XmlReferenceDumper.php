...
class XmlReferenceDumper
{
     ...
     */
    private function writeNode(NodeInterface $node, $depth = 0, $root = false, $namespace = null): void
    {
        ...
        // xml remapping
        if ($node->getParent()) {
            $remapping = array_filter($node->getParent()->getXmlRemappings(), static fn ($mapping) => $rootName === $mapping[1]);
