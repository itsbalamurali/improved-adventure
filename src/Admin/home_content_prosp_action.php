                ...
                <div class="form-group">
                    ...
                    <form method="post" name="_home_content_form" id="_home_content_form" action=""
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h3 class="show-help-section">
                                            Service Section
                                            <i class="fa fa-question-circle show-help-img" data-fancybox data-src="<?php echo $tconfig['tsite_url_main_admin']; ?>img/web_home_page_help_image/home_3.png"></i>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="lServiceSection_title"
                                               id="lServiceSection_title" value="<?php echo $lServiceSection['title']; ?>"
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="lServiceSection_subtitle"
                                               id="lServiceSection_subtitle"
                                               value="<?php echo $lServiceSection['subtitle']; ?>"
                            ...
                            <div  class="form-group">
                                <label>Note :  Click  <a target="_blank" href="category_content_page.php?id=<?php echo $iLanguageId; ?>">here</a> to manage services shown and its content.
                                </label>
                            </div>
                        </div>
                        <?php } else { ?>
...
if (!empty($vcatdata)) {
    for ($i = 0; $i < count($vcatdata); ++$i) {
        ?>
        <div class="modal fade" id="<?php echo $vcatdata[$i]['iVehicleCategoryId']; ?>" tabindex="-1" role="dialog"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    if (!empty($vcatdata[$i]['vHomepageLogoOurServices'])) {
                                        ?>
                                        <!-- <img src="<?php echo $tconfig['tsite_upload_home_page_service_images'].'/'.$vcatdata[$i]['vHomepageLogoOurServices']; ?>" class="innerbg_image" /> -->
                                        <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_home_page_service_images'].'/'.$vcatdata[$i]['vHomepageLogoOurServices']; ?>"
                                             class="innerbg_image"/>
                                    <?php } ?>
                                </div>
                                <div class="col-lg-12">
