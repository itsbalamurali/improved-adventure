...
/*$action = decrypt($_REQUEST["action"]);
$iMemberId = decrypt($_REQUEST["iMemberId"]);
$eMemberType = decrypt($_REQUEST["eMemberType"]);
$Member_Available_Balance = decrypt($_REQUEST["Member_Available_Balance"]);*/
...
if($action_form == "add_money"){
	...
	$ePaymentStatus = 'Unsettelled';
	 ...
	 if($result){
	 	$script="Add money";
		$meta = $STATIC_PAGE_OBJ->FetchStaticPage(31,$_SESSION['sess_lang']);
		?>
