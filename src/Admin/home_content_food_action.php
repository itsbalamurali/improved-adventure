...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Admin | Food Home Content <?php echo $action; ?></title>
        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2><?php echo $action; ?> Food Home Content (<?php echo $title; ?>)</h2>
                            <?php if ('Yes' === $THEME_OBJ->isCubeJekXThemeActive()) { ?>
                            <a href="home_content_cubejekx_action.php?id=<?php echo $id; ?>">
                            <?php } else { ?>
...
<?php if (1 === $goback) { ?>
                    ...
                    //history.go(-1);
                    window.location.href = "home_content_food.php?id=<?php echo $id; ?>";
