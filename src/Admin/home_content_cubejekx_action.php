...
if($THEME_OBJ->isCubeJekXv3ThemeActive() == "Yes") {
    ...
    header('Location: home_content_cubejekxv3_action.php?'. http_build_query($_GET));
...
if($THEME_OBJ->isCubeJekXv3ProThemeActive() == "Yes") {

    header('Location: home_content_cubejekxv3pro_action.php?'. http_build_query($_GET));
...
if($THEME_OBJ->isPXCProThemeActive() == "Yes") {
    ...
    header('Location: homepage_content.php');
...
if (isset($_POST['removeicon']) && $_POST['removeicon'] == 'remove') {
    ...
    if (SITE_TYPE == 'Demo') {
        ...
        header("Location:home_content_cubejekx_action.php?id=" . $id . "&success=2");
                        ...
                        <form method="post" name="_home_content_form" id="_home_content_form" action="" enctype='multipart/form-data'>
                            ...
                            <div class="body-div innersection">
                                ...
                                <div class="form-group">
                                    ...
                                    <? if($THEME_OBJ->isCubeJekXv2ThemeActive()=='Yes' || $THEME_OBJ->isCJXDoctorv2ThemeActive()=='Yes') { ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="how_it_work_section_subtitle"  id="how_it_work_section_subtitle" value="<?= $how_it_work_section['subtitle']; ?>" placeholder="SubTitle" required>
                            ...
                            <div class="body-div innersection">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row"><div class="col-lg-12"><h3>Book section</h3></div></div>
                            ...
                            <div class="body-div innersection">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row"><div class="col-lg-12"><h3>Register section</h3></div></div>
