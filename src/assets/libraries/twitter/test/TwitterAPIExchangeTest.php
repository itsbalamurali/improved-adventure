 ...
 * @coversNothing
 */
final class TwitterAPIExchangeTest extends PHPUnit\Framework\TestCase
{
    /**
     * @var string
     */
    public const CONSUMER_KEY = 'VXD22AD9kcNyNgsfW6cwkWRkw';

    /**
     * @var string
     */
    public const CONSUMER_SECRET = 'y0k3z9Y46V0DMAKGe4Az2aDtqNt9aXjg3ssCMCldUheGBT0YL9';

    /**
     * @var string
     */
    public const OAUTH_ACCESS_TOKEN = '3232926711-kvMvNK5mFJlUFzCdtw3ryuwZfhIbLJtPX9e8E3Y';

    /**
     * @var string
     */
    public const OAUTH_ACCESS_TOKEN_SECRET = 'EYrFp0lfNajBslYV3WgAGmpHqYZvvNxP5uxxSq8Dbs1wa';
     ...
     */
    public function testStatusesMentionsTimeline(): void
    {
     ...
     */
    public function testStatusesUserTimeline(): void
    {
     ...
     */
    public function testStatusesHomeTimeline(): void
    {
     ...
     */
    public function testStatusesRetweetsOfMe(): void
    {
     ...
     */
    public function testStatusesRetweetsOfId(): void
    {
     ...
     */
    public function testStatusesShowId(): void
    {
    ...
    public function testMediaUpload(): void
    {
        ...
        self::assertArrayHasKey('media_id', is_array($data) ? $data : []);
     ...
     */
    public function testStatusesUpdate(): void
    {
        if (!self::$mediaId) {
            self::fail('Cannot /update status because /upload failed');
        }

        $url = 'https://api.twitter.com/1.1/statuses/update.json';
        $method = 'POST';
        $params = [
            'status' => 'TEST TWEET TO BE DELETED'.random_int(0, getrandmax()),
        ...
        self::assertArrayHasKey('id_str', is_array($data) ? $data : []);
     ...
     */
    public function testStatusesDestroy(): void
    {
        if (!self::$tweetId) {
            self::fail('Cannot /destroy status because /update failed');
        }
     ...
     */
    public function testCanSearchWithHashTag(): void
    {
        ...
        self::assertNotCount(1, $data);
    }

    /**
     * Test to check that options passed to curl do not cause any issues.
     */
    public function testAdditionalCurlOptions(): void
    {
        $url = 'https://api.twitter.com/1.1/search/tweets.json';
        $method = 'GET';
        $params = '?q=#twitter';
    ...
    public function testIssue70(): void
    {
        ...
        $data = $this->exchange->request($url, $method, $params);
        self::assertContains('created_at', $data);
    }
    ...
    public function testPut(): void
    {
        ...
        self::assertContains('UNAUTHORIZED_CLIENT_APPLICATION', $data);
    }
