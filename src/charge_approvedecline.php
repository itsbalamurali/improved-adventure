...
$iTripId = base64_decode(base64_decode(trim($_REQUEST['iTripId']), true), true);
$iTripId = isset($_REQUEST['iTripId']) ? (int) $iTripId : '';
...
// /echo "<pre>";print_r($data_trip_locations);die;
...
$eType = 'UberX';
if (isset($data_trip_locations[0]['eType'])) {
...
$latitudes[] = $lat_array[$total_ele - 1];
$longitudes[] = $long_array[$total_ele - 1];
...
<html lang="en" dir="<?php echo (isset($_SESSION['eDirectionCode']) && '' !== $_SESSION['eDirectionCode']) ? $_SESSION['eDirectionCode'] : 'ltr'; ?>">
    <head>
        ...
        <title><?php echo $SITE_NAME; ?> |<?php echo $langage_lbl['LBL_MYEARNING_INVOICE']; ?> </title>
...
if (isset($orgDataArr[$db_trip_data['iOrganizationId']]) && '' !== $orgDataArr[$db_trip_data['iOrganizationId']] && 'Organization' === $db_trip_data['ePaymentBy'] && 'rider' === $eUserType) {
    $organizationName = $orgDataArr[$db_trip_data['iOrganizationId']];
}
$jobWord = 'Job';
if ('RIDE' === strtoupper($eType)) {
    $jobWord = 'Trip';
}
?>
            <div class="page-contant">
                <div class="page-contant-inner page-trip-detail clearfix">
                    <h2 class="header-page trip-detail">Extra Charges on <?php echo $jobWord; ?> Number <?php echo $db_trip_data['vRideNo']; ?>
                        <!-- <a href="<?php echo $tconfig['tsite_url']; ?>"><?php echo $langage_lbl['LBL_CLOSE_TXT']; ?></a>                     -->
...
if (!empty($db_trip_data)) {
    ...
    // echo "<pre>";print_r($resultChargeDetails);die;
    ...
    $AcceptLink = $tconfig['tsite_url'].'charge_Approvalstatus.php?iTripId='.base64_encode(base64_encode($iTripId)).'&status=Yes';
    $AcceptLink = get_tiny_url($AcceptLink);
    $DeclineLink = $tconfig['tsite_url'].'charge_Approvalstatus.php?iTripId='.base64_encode(base64_encode($iTripId)).'&status=No';
    ...
    ?>
                        <div class="trip-detail-page">
                            <div class="trip-detail-page-inner clearfix">
                                ...
                                <div class="trip-detail-page-right1" style="font-weight: 400;font-size: 15px">
                                    <?php if ('RIDE' === strtoupper($eType)) { ?>
                                        Dear <?php echo $userName; ?>,<br><br>Driver <?php echo $ProviderName; ?> has added an extra charges for <?php echo $jobWord; ?> number <b><?php echo $db_trip_data['vRideNo']; ?></b>.  Please refer below added charges and provide a verification code to the driver to confirm added charges.<br><br><span>Toll Charges : <b><?php echo $fTollPrice; ?></b></span><br><span>Other Charges : <b><?php echo $fOtherCharges; ?></b></span><br><span>Driver discount: <b><?php echo $fDriverDiscount; ?></b></span><br><span>Total Amount: <b><?php echo $totalAmount; ?></b></span><br><br>
                                    <?php } else { ?>
                                        Dear <?php echo $userName; ?>,<br><br>Provider <?php echo $ProviderName; ?> has added an extra charges for <?php echo $jobWord; ?> number <b><?php echo $db_trip_data['vRideNo']; ?></b>.  Please refer below added charges and provide a verification code to the provider to confirm added charges.<br><br><span>Service Cost: <b><?php echo $serviceCost; ?></b></span><br><span>Material Fee: <b><?php echo $fMaterialFee; ?></b></span><br><span>Misc Fee: <b><?php echo $fMiscFee; ?></b></span><br><span>Provider discount: <b><?php echo $fDriverDiscount; ?></b></span><br><span>Total Amount: <b><?php echo $totalAmount; ?></b></span><br><br>
                                    <?php } ?>
                                    <span>Approve/Decline: <?php echo $linkAcceptDecline; ?></span><br><span><br></span><span><br></span>
                                </div>
                            </div>
                        </div>
                        <?php
        ...
        <script type="text/javascript">
            ...
            var tPlatitudes = '<?php echo json_encode($latitudes); ?>';
            lats = JSON.parse(tPlatitudes);
            var tPlongitudes = '<?php echo json_encode($longitudes); ?>';
