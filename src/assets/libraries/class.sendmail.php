...
class SendPHPMail
{
    ...
    public function Send($vType, $vSection, $ToEmail, $bodyArr, $postArr)
    {
    ...
    public function SendMail($From, $To, $Subject, $vBody, $name)
    {
    ...
    // To Send Mail
    public function SendMailFriend($From, $To, $Subject, $vBody)
    {
        global $obj,$MAIL_FOOTER,$SITE_URL,$SITE_TITLE;
        $headers = "MIME-Version: 1.0\r\n";
        $headers .= "Content-type: text/html; charset=iso-8859-1\r\n";
    ...
    // SEND NEWSLETTER
    public function SendNewsletter($From_Email, $From_Name, $Subject, $iNewsId, $To_arr, $tContent)
    {
        global $obj,$MAIL_FOOTER,$SITE_URL,$SITE_TITLE;
        // headers information
        $headers = "MIME-Version: 1.0\r\n";
