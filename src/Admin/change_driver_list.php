				...
				<? for ($i = 0; $i < count($data_drv); $i++) { ?>
					<tr class="gradeA" >
						...
						<td width="20%">
							...
							<?php if($data_drv[$i]['eStatus']!="Deleted"){?>	
								<form name="delete_form" id="delete_form" method="post" action="" onSubmit="return confirm('Are you sure you want to delete <?=clearName($data_drv[$i]['vName']." ".$data_drv[$i]['vLastName']); ?> record?')" class="margin0">
