<?
	...
	/* #echo '<pre>'; print_R($db_trip); echo '</pre>';
		...
		$db_trip[0]['starttime'] = DateTime($db_trip[0]['tStartDate'],18);
		$db_trip[0]['endtime'] = DateTime($db_trip[0]['tEndDate'],18);
										...
										<div class="row">
											...
											<div class="col-sm-6 rider-invoice-new-right">
												...
												<table style="width:100%" cellpadding="5" cellspacing="0" border="0">
													<tr>
															<td>Basic Fare  </td>
															<td><?=trip_currency($db_trip[0]['iBaseFare'],$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></td>
													</tr>
													<tr>
															<td>Distance</td>
															<td><?=trip_currency($db_trip[0]['fPricePerKM'],$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></td>
													</tr>
													<tr>
															<td>Time</td>
															<td><?=trip_currency($db_trip[0]['fPricePerMin'],$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></td>
													</tr>
													<tr>
															<td>Commision </td>
															<td><?=trip_currency($db_trip[0]['fCommision'],$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></td>
													</tr>
													<tr>
													...
													<tr>
															...
															<td><b><?=trip_currency($tot,$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></b></td>
													</tr>
