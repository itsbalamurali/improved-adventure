...
?>
<!-- TEMPLATE CSS START -->
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/jquery.dataTables.css" type="text/css">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/jquery-ui.css">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/font-awesome-4.css" type="text/css"><link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/themify-icons.css" type="text/css">
<link href="https://fonts.googleapis.com/css?family=Poppins:100,400,500,600,700,800,900&display=swap" rel="stylesheet"/>
<link href="https://fonts.googleapis.com/css2?family=Rajdhani:wght@300;400;500;600;700&family=Rubik:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
<link href="https://fonts.googleapis.com/css2?family=Rubik:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/mstepper.min.css" type="text/css">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/header.css?time=<?= time() ?>" type="text/css">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/footer.css?time=<?= time() ?>" type="text/css">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/style.css?time=<?= time() ?>" type="text/css">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/home-new-2021.css?time=<?= time() ?>" type="text/css">
...
?>
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/style.less" type="text/less"><!-- Added for LESS CSS BY GP 26 SEP 2019 -->
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/style_rtl.css?time=<?= time() ?>" type="text/css">
<?php /*<script src="<?= $siteUrl ?><?= $templatePath; ?>assets/js/jquery.min.js"></script>
<script src="<?= $siteUrl ?><?= $templatePath; ?>assets/js/parallax.min.js"></script>
<script src="<?= $siteUrl ?><?= $templatePath; ?>assets/js/mstepper.min.js"></script> 
<script src="<?= $siteUrl ?><?= $templatePath; ?>assets/js/touch-punch.js"></script> */?>
<script src="<?= $siteUrl ?>assets/js/common_all.js"></script>
...
$(document).ready(function () {
    ...
    <?php if($sess_user == "driver" || $sess_user == "organization" || $sess_user == "tracking_company") {?>
