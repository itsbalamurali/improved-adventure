...
if ('' !== $id && '' !== $status) {
    if (SITE_TYPE !== 'Demo') {
        ...
        header('Location:home_content_cubex.php?success=2');
                                                    ...
                                                    for ($i = 0; $i < count($data_drv); ++$i) {
                                                        ...
                                                        <tr class="gradeA">
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <a href="home_content_cubex_action.php?id=<?php echo $data_drv[$i]['iLanguageMasId']; ?>" data-toggle="tooltip" title="Edit">
...
<?php // include('pagination_n.php');?>
        ...
        <!--END MAIN WRAPPER -->
        <form name="pageForm" id="pageForm" action="action/home_content_cubex.php" method="post" >
