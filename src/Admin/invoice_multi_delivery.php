                                                    ...
                                                    <tbody>
                                                        ...
                                                        <table style="border:dotted 2px #000000;" cellpadding="5px" cellspacing="2px" width="100%">
                                                            <tr>
                                                                ...
                                                                <td align="right"><b><?= formateNumAsPerCurrency($db_trip_data['fCommision'],''); ?></b></td>
                                                            </tr>
                                                        </table><br>
<?php }
?>
                                                ...
                                                <? if(isset($outstandingamount['fPendingAmount']) && $outstandingamount['fPendingAmount'] > 0){ ?>
                                                    <table style="border:dotted 2px #000000;" cellpadding="5px" cellspacing="2px" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><b><?php echo $langage_lbl_admin['LBL_OUTSTANDING_AMOUNT_TXT']; ?></b></td>

                                                            <td align="right"><b><?= $db_trip_data['CurrencySymbol'] ." ". $outstandingamount['fPendingAmount']; ?></b></td>
