...
<section class="banner-section taxi-app">
    <div class="tab-row-holding">
        <ul class="tab-row">
            <li class="tab active">
                <a href="#app-features"><?= $menutitleService ?></a>
            </li>
            <li class="tab">
...
<!-- *************banner section end************* -->
<!-- ************* app feature section section start ************* -->
<section class="app-feature-section page-section" id="app-features">
    <strong><?php echo strip_tags($service_section['desc_'.$vCode]); ?></strong>
</section>
<!-- ************* app feature section section end ************* -->
...
<section class="banner-section taxi-app">
    <div class="tab-row-holding">
        <ul class="tab-row">
            ...
            <li class="tab">
                <a href="#safety"><?= $menutitleService ?></a>
            </li>
            <!-- <li class="tab mob">
                <a href="#">&nbsp</a>
            </li> -->
