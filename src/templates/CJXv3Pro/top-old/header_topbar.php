...
if (!function_exists('ucfirst_multibyte'))
{
    function ucfirst_multibyte($str) {
                                ...
                                foreach ($db_lng_mst as $key => $value) { 
                                    ...
                                    <a href="javascript:void(0)" onclick="change_language('<?php echo $value['vCode']; ?>')" <?php if ($value['vCode'] == $_SESSION['sess_lang']) { ?> class="active" <? } ?>>
                                        ...
                                        <?php if($value['vTitle'] != $value['vTitle_EN']){?>
                                            <?php echo ucfirst_multibyte($value['vTitle_EN']); ?> <small>(<?php echo ucfirst_multibyte($value['vTitle']);?>)</small> 
                                        <?php } else { ?>
                                            <?php echo ucfirst_multibyte($value['vTitle_EN']); ?>
                                        <?php } ?>
                                        <!-- <?php echo ucfirst_multibyte($value['vTitle']); ?> --></a>
                                <?php }
                                echo '</div>'; ?>
                            </div>
                        </div>
                ...
                <?php if (function_exists('restaurant_listing_page')) { } else { $onclickLogoURL = $tconfig['tsite_url']; ?>
                    <ul class="navmenu-links">
                        ...
                        <? if ($our_service_shown == "Yes") { ?>
                            ...
                            <!-- New Menu End -->
                            <li>
                                <a href="earn" <? if ($url_name == "earn") { ?> class="active" <?php } ?>><?php echo $langage_lbl['LBL_FOOTER_LINK_EARN']; ?></a>
                            </li>
                        <? }
                        if (count($PagesData) > 0) { ?>
                            <li>
                                <a href="about" <? if ($url_name == "about") { ?> class="active" <?php } ?>><?= $langage_lbl['LBL_ABOUT_US_HEADER_TXT']; ?></a>
                            </li>
                        <? } ?>
                        <li>
                            <a href="contact-us" <? if ($url_name == "contact-us") { ?> class="active" <?php } ?>><?= $langage_lbl['LBL_FOOTER_HOME_CONTACT_US_TXT']; ?></a>
                        </li>
                    </ul>
                <?php } ?>
                <ul>
                                        ...
                                        <select name="language" id="lang_select" onchange="change_lang(this.value);">
                                            ...
                                            foreach ($db_lng_mst as $key => $value) {
                                                ...
                                                <option <?php echo $status_lang; ?>
                                                        value="<?php echo $value['vCode']; ?>"><?php echo ucfirst_multibyte($value['vTitle']); ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                <?php } ?>
                                    ...
                                    <div id = "langDropdown" class="dropdown-content">
                                        <div class="row">
                                            ...
                                            foreach ($db_lng_mst as $key => $value) { 
                                                ...
                                                <a href="javascript:void(0)" onclick="change_language('<?php echo $value['vCode']; ?>')" <?php if ($value['vCode'] == $_SESSION['sess_lang']) { ?> class="active" <? } ?>>
                                                    <b><img src="<?= $tconfig['tsite_url'] ?>webimages/icons/language_flags/<?= $language_flag_code_sel ?>.svg" alt="" onerror="this.src='<?= $tconfig['tsite_url'] ?>webimages/icons/language_flags/globe.svg'" /></b>
                                                   <!--  <?php echo ucfirst_multibyte($value['vTitle']); ?> --> 
                                                   <?php if($value['vTitle'] != $value['vTitle_EN']){?>
                                                        <?php echo ucfirst_multibyte($value['vTitle_EN']); ?> <small>(<?php echo ucfirst_multibyte($value['vTitle']);?>)</small>
                                                    <?php } else { ?>
                                                        <?php echo ucfirst_multibyte($value['vTitle_EN']); ?>
