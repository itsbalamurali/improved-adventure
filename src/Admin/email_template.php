...
<head>
    <meta charset="UTF-8"/>
    <title><?php echo $SITE_NAME; ?> | Email Template</title>
                    ...
                    <tr>
                        ...
                        <td width="10%" class=" padding-right10">
                            <select name="option" id="option" class="form-control">
                                ...
                                <option value="<?php echo 'vSubject_'.$default_lang; ?>" <?php if ($option === "vSubject_{$default_lang}") {
                                    echo 'selected';
                                } ?> >Email Subject
                                </option>
                                <!--   <option  value="<?php echo 'vEmail_Code'; ?>" <?php if ('vEmail_Code' === $option) {
                                    echo 'selected';
                                } ?> >Email Code</option> -->
                                <option value="<?php echo 'vPurpose'; ?>" <?php if ('vPurpose' === $option) {
                                    echo 'selected';
                                } ?> >Purpose
                                </option>
                            </select>
                        ...
                        <td>
                            ...
                            <input type="button" value="Reset" class="btnalt button11"
                                   onClick="window.location.href='email_template.php'"/>
                        </td>
                        <td width="30%">
                            <!--<a class="add-btn" href="email_template_action.php" style="text-align: center;">Add Email Template</a>--></td>
                    </tr>
                    </tbody>
                </table>
            </form>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(1,<?php if ('1' === $sortby) {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Email Subject <?php if (1 === $sortby) {
                                                   if (0 === $order) { ?>
                                        ...
                                        <!-- <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if ('2' === $sortby) {
                                            echo $order;
                                        } else { ?>0<?php } ?>)">Email Code <?php if (2 === $sortby) {
                                        ...
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(2,<?php if ('2' === $sortby) {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Purpose <?php if (2 === $sortby) {
                                                   if (0 === $order) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                    ...
                                    if (!empty($data_drv)) {
                                        for ($i = 0; $i < count($data_drv); ++$i) {
                                            ...
                                            <tr class="gradeA">
                                                <td><?php echo $data_drv[$i]['vSubject_'.$default_lang]; ?></td>
                                                <!--  <td><?php echo $data_drv[$i]['vEmail_Code']; ?></td> -->
                                                <td><?php echo $data_drv[$i]['vPurpose']; ?></td>
                                                <?php if ($userObj->hasPermission('edit-email-templates')) { ?>
                                                <td align="center" style="text-align:center;" class="action-btn001">
                                                    <!--<div class="share-button openHoverAction-class" style="display: block;">
                                                                    <label class="entypo-export"><span><a href="page_action.php?id=<?php echo $data_drv[$i]['iEmailId']; ?>" data-toggle="tooltip" title="Edit">
                                                                                <img src="img/edit-icon.png" alt="Edit">
                                                                            </a></span></label>
                                                                    <div class="social show-moreOptions openPops_<?php echo $data_drv[$i]['iEmailId']; ?>">
                                                    ...
                                                    <?php if ($userObj->hasPermission('edit-email-templates')) { ?>
                                                        <div class="share-button openHoverAction-class"
                                                            ...
                                                            <label class="entypo-twitter" data-network="twitter"
                                                                   style="margin-top: -10px;">
                                                                <a href="email_template_action.php?id=<?php echo $data_drv[$i]['iEmailId']; ?>"
