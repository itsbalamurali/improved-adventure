...
if (isset($_POST['submit'])) {
    ...
    $safe_section_arr['img'] = $sectionData['img'] ?? '';
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="safe_section_title"  id="safe_section_title" value="<?php echo $safe_section['title']; ?>" placeholder="Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="safe_section_desc"  id="safe_section_desc"  placeholder="Description"><?php echo $safe_section['desc']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ('' !== $safe_section['img']) { ?>
                                                    <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$safe_section['img']; ?>" class="innerbg_image" />
                                                <?php } ?>
