...
<html lang="en" dir="<?php echo (isset($_SESSION['eDirectionCode']) && '' !== $_SESSION['eDirectionCode']) ? $_SESSION['eDirectionCode'] : 'ltr'; ?>">
	<head>
		...
		<title><?php echo $SITE_NAME; ?> | <?php echo $langage_lbl['LBL_HEADER_PROFILE_TXT']; ?></title>
...
?>
		...
		<!-- <script type="text/javascript" src="assets/js/validation/localization/messages_<?php echo $lang; ?>.js" ></script> -->
		<?php } ?>
