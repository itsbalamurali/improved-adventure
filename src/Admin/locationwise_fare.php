...
<head>
    <meta charset="UTF-8"/>
    <title><?php echo $SITE_NAME; ?> | Location Wise Fare</title>
                        ...
                        <div class="table-responsive">
                            <form class="_list_form" id="_list_form" method="post"
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($userObj->hasPermission(['edit-location-wise-fare', 'update-status-location-wise-fare', 'delete-location-wise-fare'])) { ?>
						  ...
						  value="<?php echo $data_drv[$i]['iLocatioId']; ?>" />&nbsp;
                                                ...
                                                <?php } ?>
                                                  ...
                                                  <td align="center"><?php echo formateNumAsPerCurrency($data_drv[$i]['fFlatfare'], ''); ?></td>
                                                  <td align="center"><?php echo $data_drv[$i]['vVehicleType']; ?></td>
                                                  <td align="center" style="text-align:center;">
						      ...
						      <span><img src="images/settings-icon.png" alt=""></span>
                                                          ...
                                                          <div class="social show-moreOptions openPops_<?php echo $data_drv[$i]['iLocatioId']; ?>">
                                                              <ul>
                                                                <?php if ($userObj->hasPermission('edit-location-wise-fare')) { ?>
									<li class="entypo-twitter" data-network="twitter">
									<a href="location_wise_fare_action.php?id=<?php echo $data_drv[$i]['iLocatioId']; ?>"
