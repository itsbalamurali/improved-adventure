                    ...
                    <div class="fileupload-preview thumbnail" style="width: 100%; height: 150px; ">
                        <?php if ('' === $db_user_li[0]['doc_file']) {
                            ...
                            if ('is_image' === $file_ext) {
                                ...
                                <img src = "<?php echo $tconfig['tsite_upload_compnay_doc'].'/'.$id[1].'/'.$db_user_li[0]['doc_file']; ?>" style="width:100%;" alt ="<?php echo $db_user_doc[0]['doc_name']; ?> not found"/>
                            <?php } else { ?>
                                <a href="<?php echo $tconfig['tsite_upload_compnay_doc'].'/'.$id[1].'/'.$db_user_li[0]['doc_file']; ?>" target="_blank"><?php echo $db_user_li[0]['doc_name']; ?></a>
                            <?php } ?>
                        <?php } ?>
                    </div>
                    <div>
