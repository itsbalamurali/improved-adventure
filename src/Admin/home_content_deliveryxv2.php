...
if ('' !== $id && '' !== $status) {
    if (SITE_TYPE !== 'Demo') {
        ...
        header('Location:homecontent.php?success=2');
                        ...
                        <div class="table-responsive">
                            <form class="_list_form" id="_list_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th width="58%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if ('1' === $sortby) {
                                            echo $order;
                                        ...
                                        for ($i = 0; $i < count($data_drv); ++$i) {
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td align="center" style="text-align:center;" class="action-btn001">
                                                    <a href="home_content_deliveryxv2_action.php?id=<?php echo $data_drv[$i]['id']; ?>" data-toggle="tooltip" title="Edit">
...
<!--END MAIN WRAPPER -->
<form name="pageForm" id="pageForm" action="action/home_content_deliveryxv2.php" method="post" >
