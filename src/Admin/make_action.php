...
if (isset($_POST['submit'])) {
    if ('Add' === $action && !$userObj->hasPermission('create-vehicle-make')) {
        $_SESSION['success'] = 3;
    ...
    if ('Edit' === $action && !$userObj->hasPermission('edit-vehicle-make')) {
        $_SESSION['success'] = 3;
...
<?php } ?>
                            <form method="post" name="_make_form" id="_make_form" action="">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
<?php if (('Edit' === $action && $userObj->hasPermission('edit-vehicle-make')) || ('Add' === $action && $userObj->hasPermission('create-vehicle-make'))) { ?>
                                            <input type="submit" class=" btn btn-default" name="submit" id="submit" value="<?php echo $action; ?> Make">
