...
if(file_exists($tconfig['tpanel_path'] . 'assets/libraries/Models/class.firebase.auth.php')) {
	include_once $tconfig['tpanel_path'] . 'assets/libraries/Models/class.firebase.auth.php';
	$FireBaseData = new FireBaseClass;
}
?>