...
<head>
    ...
    <?php if (!empty($ride_data[0]['vMetaTitle'])) { ?>
        <title><?=$SITE_NAME?> | <?php echo $ride_data[0]['vMetaTitle']; ?></title>
    <?php } else { ?>
        <title><?=$SITE_NAME?> | <?= $langage_lbl['LBL_SERVICE_PARTNER_TXT'] ?></title>
    <?php } ?>
   
    <meta name="keywords" value="<?= $ride_data[0]['tMetaKeyword']; ?>" />
    <meta name="description" value="<?= $ride_data[0]['tMetaDescription']; ?>" />
...
<div class="common-inner-heading-section">
    <div class="common-inner-heading-section-inner">
        <h2 class="common-inner-heading"><?= $langage_lbl['LBL_SERVICE_PARTNER_TXT'] ?></h2>
    </div>
</div>
...
<section class="get_app_area sec_pad page-section" id="download-apps">
    <div class="get_app_area-inner">
        ...
        <div class="get_app_area-right app_image">
            <?php if (!empty($IPHONE_APP_LINK_EARN_PAGE)) { ?>
                <div class="image_first">
                    <a href="<?= $IPHONE_APP_LINK_EARN_PAGE?>" target="_blank"><img src="assets/img/footer-ios-store.svg" alt="" ></a>
                </div>
            <?php } ?>
            <?php if (!empty($ANDROID_APP_LINK_EARN_PAGE)) { ?>
                <div class="image_two">
                    <a href="<?= $ANDROID_APP_LINK_EARN_PAGE ?>" target="_blank"><img src="assets/img/footer-google-play.svg" alt=""></a>
                </div>
            <?php } ?>
        </div>
    </div>
