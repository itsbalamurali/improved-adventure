...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Admin | <?php echo $langage_lbl_admin['LBL_FLY_LOCATION_WISE_FARE']; ?>  <?php echo $action; ?></title>
        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2><?php echo $action.' '.$langage_lbl_admin['LBL_FLY_LOCATION_WISE_FARE']; ?> </h2>
                        ...
                        <div class="form-group location-wise-box">
                            <?php if (1 === $success) { ?>
                                <div class="alert alert-success alert-dismissable msgs_hide">
                                    <button aria-hidden="true" data-dismiss="alert" class="close" type="button">x</button>
                                    <?php echo $langage_lbl_admin['LBL_FLY_LOCATION_WISE_FARE']; ?> fare updated successfully.
                                </div><br/>
                            <?php } ?>
                            <form method="post" action="" enctype="multipart/form-data" id="locationfareForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="iFromLocationId" class="form-control selectpicker" required="required" onChange="getvehilcetypefly(this.value, '');" data-live-search="true">
...
<?php } ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="iToLocationId" class="form-control selectpicker" required="required" onChange="getvehilcetypefly(this.value, '');" data-live-search="true">
...
<?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <?php if (('Edit' === $action && $userObj->hasPermission('edit-fly-fare')) || ('Add' === $action && $userObj->hasPermission('create-fly-fare'))) { ?>
                                            <input type="submit" class="save btn-info" name="submit" id="submit" value="<?php echo $action; ?>">
<?php } else { ?>
...
<?php include_once 'footer.php'; ?>
        ...
        <script>
											...
											function getvehilcetype(id, selected)
                                            {
                                                ...
                                                var ajaxData = {
                                                    'URL': '<?php echo $tconfig['tsite_url_main_admin']; ?>ajax_get_vehicletype_flyfare.php',
											...
											function getvehilcetypefly(id, selected)
                                            {
                                                ...
                                                var ajaxData = {
                                                    'URL': '<?php echo $tconfig['tsite_url_main_admin']; ?>ajax_get_vehicletype_flyfare.php',
                                                    'AJAX_DATA': {iLocationId: ilocationId, selected: selected,to: 1,iFromlocationId: iFromlocationId },
                                                };
                                                getDataFromAjaxCall(ajaxData, function(response) {
                                                    if(response.action == "1") {
                                                        var dataHtml = response.result;
