...
if ('CabRequestAccepted' === $tripDetails) {
    $stylefirst = 'work-invoice';
    $stylesec = 'work-invoice-new';
    $stylethird = 'work-invoice-new';
    $secstylefirst = 'color-invo';
    $secstylesec = 'color-invo-new';
    $secstylethird = 'color-invo-new';
} elseif ('TripStarted' === $tripDetails) {
    $stylefirst = 'work-invoice';
    $stylesec = 'work-invoice';
    $stylethird = 'work-invoice-new';
    $secstylefirst = 'color-invo';
    $secstylesec = 'color-invo';
    $secstylethird = 'color-invo-new';
} elseif ('TripEnd' === $tripDetails) {
    $stylefirst = 'work-invoice';
    $stylesec = 'work-invoice';
    $stylethird = 'work-invoice';
    $secstylefirst = 'color-invo';
    $secstylesec = 'color-invo';
    $secstylethird = 'color-invo';
} else {
    $stylefirst = 'work-invoice-new';
    $stylesec = 'work-invoice-new';
    $stylethird = 'work-invoice-new';
    $secstylefirst = 'color-invo-new';
    $secstylesec = 'color-invo-new';
    $secstylethird = 'color-invo-new';
}
