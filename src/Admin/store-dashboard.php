<?php
	...
	$company 	= getDriverDetailsDashboard();
									...
									<div class="col-lg-6"><a href="admin_payment_report.php">
										<div class="info-box bg-green">
											...
											<div class="info-box-content">
												...
												<span class="info-box-number"><?=trip_currency($totalEarns,'','',2);?></span>
											</div>
											<!-- /.info-box-content -->
										</div></a>
										<!-- /.info-box -->
						...
						<div class="col-lg-6">
							<div class="panel panel-primary bg-gray-light" >
									...
									<div class="col-lg-6">
										...
										<p>Today : 
											<b><?=number_format(getOrderDateStates('today'));?></b>
										</p>
										<p>This Month : 
											<b><?=number_format(getOrderDateStates('month'));?></b>
										</p>
										<p>This Year : 
											<b><?=number_format(getOrderDateStates('year'));?></b>
										</p>
										<br />
										<p>
