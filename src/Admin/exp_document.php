...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
       <title><?php echo $SITE_NAME; ?> | <?php echo $langage_lbl_admin['LBL_EXPIRY_DOMENT_TXT']; ?></title>
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="dm.doc_name" <?php if ('dm.doc_name' === $option) {
                                              echo 'selected';
                                          } ?> >Document Name</option>
										   <option value="doc.doc_usertype" <?php if ('doc.doc_usertype' === $option) {
										       echo 'selected';
										   } ?> >Document Type</option>
                                          <!--<option value="doc.ex_date" <?php if ('doc.ex_date' === $option) {
                                              echo 'selected';
                                          } ?> >Expiry Date</option>-->
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if ('1' === $sortby) {
                                                            echo $order;
                                                        } else { ?>0<?php } ?>)">Document Name <?php if (1 === $sortby) {
                                                ...
                                                <tbody>
                                                    ...
                                                    if (!empty($data_ex_doc)) {
                                                        for ($i = 0; $i < count($data_ex_doc); ++$i) {
                                                            ...
                                                            $Username = ('driver' === $data_ex_doc[$i]['doc_usertype'] || 'car' === $data_ex_doc[$i]['doc_usertype']) ? $data_ex_doc[$i]['DriverName'] : $data_ex_doc[$i]['CmpName'];

                                                            $Status = ('driver' === $data_ex_doc[$i]['doc_usertype']) ? ucfirst($data_ex_doc[$i]['DriverStatus']) : $data_ex_doc[$i]['CmpStatus'];

                                                            $btnlink = ('driver' === $data_ex_doc[$i]['doc_usertype']) ? 'driver_document_action.php?id='.$data_ex_doc[$i]['driverid'].'&action=edit&user_type=driver' : 'company_document_action.php?id='.$data_ex_doc[$i]['cmpid'].'&action=edit';

                                                            if ('driver' === $data_ex_doc[$i]['doc_usertype'] || 'car' === $data_ex_doc[$i]['doc_usertype']) {
                                                            ...
                                                            ?>
                                                    <tr class="gradeA">
                                                        <td><?php echo $data_ex_doc[$i]['DocumentName']; ?></td>
                                                        <td><?php echo $data_ex_doc[$i]['doc_usertype']; ?></td>
                                                        <td><?php echo $Username; ?></td>
														<?php $CarDetail = ('driver' === $data_ex_doc[$i]['doc_usertype'] || 'car' === $data_ex_doc[$i]['doc_usertype']) ? $data_car_detail[0]['vMake'].'-'.$data_car_detail[0]['vTitle'] : '--'; ?>
                                                        <td><?php echo $CarDetail; ?></td>
                                                        <td><?php echo $data_ex_doc[$i]['ex_date']; ?></td>

                                                       <!-- <td align="center" style="text-align:center;">
                                                                <?php if ('Active' === $data_ex_doc[$i]['DocumentStatus']) {
                                                                    $dis_img_doc = 'img/active-icon.png';
                                                                } elseif ('Inactive' === $data_ex_doc[$i]['DocumentStatus']) {
                                                                    $dis_img_doc = 'img/inactive-icon.png';
                                                                } elseif ('Deleted' === $data_ex_doc[$i]['DocumentStatus']) {
                                                            ...
                                                            if (!empty($data_ex_doc[$i]['DocumentStatus'])) {
                                                                ...
                                                                <img src="<?php echo $dis_img_doc; ?>" alt="<?php echo $data_ex_doc[$i]['DocumentStatus']; ?>" data-toggle="tooltip" title="<?php echo $data_ex_doc[$i]['DocumentStatus']; ?>">
																<?php } else {
																    echo $dis_img_doc;
																} ?>
                                                            </td>-->
															 <td align="center" style="text-align:center;">
                                                                ...
                                                                <img src="<?php echo $dis_img; ?>" alt="<?php echo $Status; ?>" data-toggle="tooltip" title="<?php echo $Status; ?>">
                                                            </td>
															<?php if ('driver' === $data_ex_doc[$i]['doc_usertype'] || 'company' === $data_ex_doc[$i]['doc_usertype']) { ?>
