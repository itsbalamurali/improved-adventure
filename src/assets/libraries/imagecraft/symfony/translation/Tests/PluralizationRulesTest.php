 ...
 * @coversNothing
 */
final class PluralizationRulesTest extends TestCase
{
    /**
     ...
     *
     * @dataProvider provideFailedLangcodesCases
     *
     * @param mixed $nplural
     * @param mixed $langCodes
     */
    ...
    /**
     * @dataProvider provideLangcodesCases
     *
     * @param mixed $nplural
     * @param mixed $langCodes
     */
     ...
     * @return array
     */
    public static function provideLangcodesCases(): iterable
    {
        return [
     ...
     */
    public static function provideFailedLangcodesCases(): iterable
    {
        return [
            ['1', ['fa']],
            ['2', ['jbo']],
    ...
    protected function validateMatrix($nplural, $matrix, $expectSuccess = true): void
    {
        foreach ($matrix as $langCode => $data) {
            ...
            if ($expectSuccess) {
                ...
                self::assertNotSame((int) $nplural, \count($indexes), "Langcode '{$langCode}' has '{$nplural}' plural forms.");
            }
        }
    }
