...
if (isset($_POST['submit'])) {
    ...
    header('location:home_content_otherservices_action.php?iVehicleCategoryId='.$iVehicleCategoryId.'&id='.$id);
                                ...
                                <?php if (ENABLE_DYNAMIC_CREATE_PAGE === 'Yes') { ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <p>(Note : Title and Description are required for show this blocks on
                        ...
                        <div style="display: none" class="body-div innersection">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12"><h3>Safety On the Roads Section</h3></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="benefit_section_main_title"
                                                   ...
                                                   placeholder="Main Title" required>
