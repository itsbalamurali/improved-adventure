...
//   //header("location: home_content_cubejekx_action.php?id=$id");
...
if (isset($_POST['submit'])) {
    if (ENABLE_DYNAMIC_CREATE_PAGE === 'Yes') {
        $check_file_query = "SELECT lBannerSection,lHowitworkSection,lSecuresafeSection,lDownloadappSection,lCalltobookSection,lEarnSection,lServiceSection FROM {$tbl_name} where eFor='".$eFor."' AND iVehicleCategoryId = {$iVehicleCategoryId}";
    } else {
    ...
    $service_section_arr['desc_'.$vCode] = $_POST['service_section_desc'] ?? '';
...
if (isset($_POST['submit'])) {
    ...
    $update_array['lSecuresafeSection'] = $secure_section;

    $update_array['lDownloadappSection'] = $download_section;

    $update_array['lEarnSection'] = $earn_section;

    $update_array['lServiceSection'] = $service_section;

    $update_array['lBenefitSection'] = $benefit_section;
    ...
    // header("location:" . $backlink);
    header('location:home_content_videoconsult_action.php?iVehicleCategoryId='.$iVehicleCategoryId.'&id='.$id);
                        ...
                        <div class="body-div innersection">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12"><h3>Banner section</h3></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="banner_section_sub_title"

                                               id="banner_section_sub_title"

                                               value="<?php echo $banner_section['sub_title_'.$vCode]; ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <?php if ('' !== $how_it_work_section['img_'.$vCode]) { ?>
                                            ...
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$how_it_work_section['img_'.$vCode]; ?>"
                                ...
                                <?php if (ENABLE_DYNAMIC_CREATE_PAGE === 'Yes') { ?>
                                    ...
                                    <div style="display:none" class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <p>(Note : Title and Description are for show this blocks on page..)</p>
                        ...
                        <div style="display:none" class="body-div innersection">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12"><h3>Earn Section</h3></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="earn_section_menu_title"

                                               id="earn_section_menu_title"

                                               value="<?php echo $earn_section['menu_title_'.$vCode]; ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="earn_section_title"

                                               id="earn_section_title" value="<?php echo $earn_section['title_'.$vCode]; ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control ckeditor" rows="10" name="earn_section_desc"

                                                  id="earn_section_desc"

                                                  placeholder="Description"><?php echo $earn_section['desc_'.$vCode]; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <?php if ('' !== $earn_section['img_'.$vCode]) { ?>
                                            ...
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$earn_section['img_'.$vCode]; ?>"

                                                 class="innerbg_image"/>

                                        <?php } ?>

                                        <input type="file" class="form-control FilUploader" name="earn_section_img"

                                               id="earn_section_img" accept=".png,.jpg,.jpeg,.gif,.svg">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="secure_section_menu_title"

                                               id="secure_section_menu_title"

                                               value="<?php echo $secure_section['menu_title_'.$vCode]; ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="secure_section_title"
                                               ...
                                               id="secure_section_title"

                                               value="<?php echo $secure_section['title_'.$vCode]; ?>" placeholder="Title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control ckeditor" rows="10" name="secure_section_desc"
                                                  ...
                                                  placeholder="Description"><?php echo $secure_section['desc_'.$vCode]; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <?php if ('' !== $secure_section['img_'.$vCode]) { ?>
                                            ...
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$secure_section['img_'.$vCode]; ?>"
                                        ...
                                        <input type="file" class="form-control FilUploader" name="secure_section_img"

                                               id="secure_section_img" accept=".png,.jpg,.jpeg,.gif,.svg">
                        ...
                        <div style="display:none"  class="body-div innersection">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12"><h3>App Features</h3></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="service_section_menu_title"

                                               id="service_section_menu_title"

                                               value="<?php echo $service_section['menu_title_'.$vCode]; ?>"
                                ...
                                <div style="display:none" class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="service_section_title"
                                               ...
                                               value="<?php echo $service_section['title_'.$vCode]; ?>" placeholder="Title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control ckeditor" rows="10" name="service_section_desc"

                                                  id="service_section_desc"

                                                  placeholder="Description"><?php echo $service_section['desc_'.$vCode]; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12"><h4>Safety On the Roads Data</h4></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       name="service_section_title_first"

                                                       value="<?php echo $service_section['title_first_'.$vCode]; ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                ...
                                                <textarea class="form-control" rows="5"
                                                          ...
                                                          name="service_section_desc_first"

                                                          placeholder="Description"><?php echo $service_section['desc_first_'.$vCode]; ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                ...
                                                <?php if ('' !== $service_section['img_first_'.$vCode]) { ?>
                                                    ...
                                                    <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$service_section['img_first_'.$vCode]; ?>"
                                                ...
                                                <input type="file" class="form-control" name="service_section_img_first"

                                                       value="<?php echo $service_section['img_first_'.$vCode]; ?>">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                ...
                                                <input type="text" class="form-control" name="service_section_title_sec"

                                                       value="<?php echo $service_section['title_sec_'.$vCode]; ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                ...
                                                <textarea class="form-control" rows="5" name="service_section_desc_sec"

                                                          placeholder="Description"><?php echo $service_section['desc_sec_'.$vCode]; ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                ...
                                                <?php if ('' !== $service_section['img_sec_'.$vCode]) { ?>
                                                    ...
                                                    <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$service_section['img_sec_'.$vCode]; ?>"

                                                         class="innerbg_image"/>

                                                <?php } ?>

                                                <input type="file" class="form-control" name="service_section_img_sec"

                                                       value="<?php echo $service_section['img_sec_'.$vCode]; ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       name="service_section_title_third"

                                                       value="<?php echo $service_section['title_third_'.$vCode]; ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                ...
                                                <textarea class="form-control" rows="5"
                                                          ...
                                                          name="service_section_desc_third"

                                                          id="service_section_desc_third"

                                                          placeholder="Description"><?php echo $service_section['desc_third_'.$vCode]; ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                ...
                                                <?php if ('' !== $service_section['img_third_'.$vCode]) { ?>
                                                    ...
                                                    <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$service_section['img_third_'.$vCode]; ?>"

                                                         class="innerbg_image"/>

                                                <?php } ?>

                                                <input type="file" class="form-control" name="service_section_img_third"

                                                       value="<?php echo $service_section['img_third_'.$vCode]; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="download_section_menu_title"

                                               id="download_section_menu_title"

                                               value="<?php echo $download_section['menu_title_'.$vCode]; ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="download_section_title"
                                               ...
                                               value="<?php echo $download_section['title_'.$vCode]; ?>" placeholder="Title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control ckeditor" rows="10" name="download_section_desc"

                                                  id="download_section_desc"

                                                  placeholder="Description"><?php echo $download_section['desc_'.$vCode]; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <?php if ('' !== $download_section['img_'.$vCode]) { ?>
                                            ...
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$download_section['img_'.$vCode]; ?>"
                                        ...
                                        <input type="file" class="form-control FilUploader" name="download_section_img"

                                               id="download_section_img" accept=".png,.jpg,.jpeg,.gif,.svg">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <?php if ('' !== $download_section['img2_'.$vCode]) { ?>
                                            ...
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$download_section['img2_'.$vCode]; ?>"

                                                 class="innerbg_image"/>

                                        <?php } ?>

                                        <input type="file" class="form-control FilUploader" name="download_section_img2"

                                               id="download_section_img2" accept=".png,.jpg,.jpeg,.gif,.svg">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <h5>[Note: Please use #ANDROID_APP_LINK# predefined tags to display the Play

                                            store link value. Please go to Settings >> General section to change the

                                            values of above predefined tags.]</h5>

                                    </div>

                                    <div class="col-lg-6">

                                        <input type="text" class="form-control" name="download_section_link1"

                                               id="download_section_link1"

                                               value="<?php echo $download_section['link1_'.$vCode]; ?>"

                                               placeholder="Play store link for anroid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <h5>[Note: Please use #IPHONE_APP_LINK# predefined tags to display the Play
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="download_section_link2"

                                               id="download_section_link2"

                                               value="<?php echo $download_section['link2_'.$vCode]; ?>"

                                               placeholder="Play store link for ios">
                            ...
                            <div style="display:none" class="body-div innersection">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12"><h3>Get in Touch / Contact / Address Section</h3></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="call_section_menu_title"

                                                   id="call_section_menu_title"

                                                   value="<?php echo $call_section['menu_title_'.$vCode]; ?>"
                                    ...
                                    <!--<div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="call_section_title"  id="call_section_title" value="<?php echo $call_section['title_'.$vCode]; ?>" placeholder="Title" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <h5>[Note: Please use #SUPPORT_PHONE# predefined tags to display the support
                                                ...
                                                phone value. Please go to Settings >> General section to change the
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <textarea class="form-control ckeditor" rows="10" name="call_section_desc"
                                                      ...
                                                      placeholder="Description"><?php echo $call_section['desc_'.$vCode]; ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php if ('' !== $call_section['img_'.$vCode]) { ?>
                                                ...
                                                <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$call_section['img_'.$vCode]; ?>"
                                            ...
                                            <input type="file" class="form-control FilUploader" name="call_section_img"
                                                   ...
                                                   id="call_section_img" accept=".png,.jpg,.jpeg,.gif,.svg">
                            ...
                            <div class="body-div innersection">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12"><h3>Benefit Section</h3></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="benefit_section_main_title"

                                                   id="benefit_section_main_title"

                                                   value="<?php echo $benefit_section['main_title_'.$vCode]; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="benefit_section_menu_title"

                                                   id="benefit_section_menu_title"

                                                   value="<?php echo $benefit_section['menu_title_'.$vCode]; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="5" name="benefit_section_main_desc"

                                                      placeholder="Main Description"><?php echo $benefit_section['main_desc_'.$vCode]; ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12"><h4>Benefit Data</h4></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="benefit_section_title_first"

                                                   value="<?php echo $benefit_section['title_first_'.$vCode]; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="5" name="benefit_section_desc_first"

                                                      placeholder="Description"><?php echo $benefit_section['desc_first_'.$vCode]; ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php if ('' !== $benefit_section['img_first_'.$vCode]) { ?>
                                                ...
                                                <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$benefit_section['img_first_'.$vCode]; ?>"
                                            ...
                                            <input type="file" class="form-control" name="benefit_section_img_first"

                                                   value="<?php echo $benefit_section['img_first_'.$vCode]; ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="benefit_section_title_sec"

                                                   value="<?php echo $benefit_section['title_sec_'.$vCode]; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="5" name="benefit_section_desc_sec"

                                                      placeholder="Description"><?php echo $benefit_section['desc_sec_'.$vCode]; ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php if ('' !== $benefit_section['img_sec_'.$vCode]) { ?>
                                                ...
                                                <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$benefit_section['img_sec_'.$vCode]; ?>"
                                            ...
                                            <input type="file" class="form-control" name="benefit_section_img_sec"

                                                   value="<?php echo $benefit_section['img_sec_'.$vCode]; ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="benefit_section_title_third"

                                                   value="<?php echo $benefit_section['title_third_'.$vCode]; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="5" name="benefit_section_desc_third"

                                                      placeholder="Description"><?php echo $benefit_section['desc_third_'.$vCode]; ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php if ('' !== $benefit_section['img_third_'.$vCode]) { ?>
                                                ...
                                                <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$benefit_section['img_third_'.$vCode]; ?>"

                                                     class="innerbg_image"/>

                                            <?php } ?>

                                            <input type="file" class="form-control" name="benefit_section_img_third"

                                                   value="<?php echo $benefit_section['img_third_'.$vCode]; ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="benefit_section_title_fourth"

                                                   value="<?php echo $benefit_section['title_fourth_'.$vCode]; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="5" name="benefit_section_desc_fourth"

                                                      placeholder="Description"><?php echo $benefit_section['desc_fourth_'.$vCode]; ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php if ('' !== $benefit_section['img_fourth_'.$vCode]) { ?>
                                                ...
                                                <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$benefit_section['img_fourth_'.$vCode]; ?>"

                                                     class="innerbg_image"/>

                                            <?php } ?>

                                            <input type="file" class="form-control" name="benefit_section_img_fourth"

                                                   value="<?php echo $benefit_section['img_fourth_'.$vCode]; ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="benefit_section_title_fifth"

                                                   value="<?php echo $benefit_section['title_fifth_'.$vCode]; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="5" name="benefit_section_desc_fifth"

                                                      placeholder="Description"><?php echo $benefit_section['desc_fifth_'.$vCode]; ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php if ('' !== $benefit_section['img_fifth_'.$vCode]) { ?>
                                                ...
                                                <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$benefit_section['img_fifth_'.$vCode]; ?>"

                                                     class="innerbg_image"/>

                                            <?php } ?>

                                            <input type="file" class="form-control" name="benefit_section_img_fifth"

                                                   value="<?php echo $benefit_section['img_fifth_'.$vCode]; ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="benefit_section_title_six"

                                                   value="<?php echo $benefit_section['title_six_'.$vCode]; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <textarea class="form-control" rows="5" name="benefit_section_desc_six"

                                                      placeholder="Description"><?php echo $benefit_section['desc_six_'.$vCode]; ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php if ('' !== $benefit_section['img_six_'.$vCode]) { ?>
                                                ...
                                                <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$benefit_section['img_six_'.$vCode]; ?>"

                                                     class="innerbg_image"/>

                                            <?php } ?>

                                            <input type="file" class="form-control" name="benefit_section_img_six"

                                                   value="<?php echo $benefit_section['img_six_'.$vCode]; ?>">
