...
$ENABLE_TIP_MODULE = $CONFIG_OBJ->getConfigurations("configurations","ENABLE_TIP_MODULE");
	...
	$sql = "select * from ratings_user_driver where iTripId = '".$iTripId."' AND vRating1 != '' ";
								...
								<div class="panel panel-default">
									...
									<h4 style="text-align:center;">	Cancellation Fare For Ride No  :<?= $db_trip[0]['vRideNo'];?></h4><hr/>
												...
												if($db_trip[0]['eFareType'] != 'Fixed' && $db_trip[0]['eFareType'] != 'Hourly')
												{
													...
													<tr>
															<td>Basic Fare  </td>
															<td align="right"><?=trip_currency($db_trip[0]['iBaseFare']);?></td>
															</tr>
													<tr>
															<?php if($APP_TYPE == "UberX") { ?>
															...
															<?php } else { ?>
																<td>Distance</td>
															<?php } ?>
															<td align="right"><?=trip_currency($db_trip[0]['fPricePerKM']);?></td>
													</tr>
													<tr>
															<?php if($APP_TYPE == "UberX") { ?>
												...
												?>
													...
													<tr>
														...
														<td align="right">
															<?php $vVehicleFare_price = cal_trip_price_details($db_trip[0]['iTripId'],$db_trip[0]['iDriverVehicleId'],$db_trip[0]['iVehicleTypeId']);

															$vVehicleFare = trip_currency($vVehicleFare_price);
												...
												<?php 
													if($db_trip[0]['fVisitFee'] > 0){ ?> 
														...
														<td align="right"><?=trip_currency($db_trip[0]['fVisitFee']);?></td>
													</tr>
													...
													if($db_trip[0]['fMaterialFee'] > 0){ ?>
														...
														<td align="right"><?=trip_currency($db_trip[0]['fMaterialFee']);?></td>
													</tr>
													<?php }
													if($db_trip[0]['fMiscFee'] > 0){ ?>
														<tr>
														<td><?php echo $langage_lbl_admin['LBL_MISC_FEE'];?> </td>
														<td align="right"><?=trip_currency($db_trip[0]['fMiscFee']);?></td>
													</tr><?php } 
													if($db_trip[0]['fDriverDiscount'] > 0){ ?>
														<tr>
														<td><?php echo $langage_lbl_admin['LBL_PROVIDER_DISCOUNT'];?> </td>
														<td align="right"> - <?=trip_currency($db_trip[0]['fDriverDiscount']);?></td>
													</tr>
													<?php } ?>
														<?php 
													...
													<tr>
															<td><b><?=trip_currency($minimum_fare);?></b> <?=$langage_lbl['LBL_MINIMUM']; ?> </td>
															<td align="right"><?=trip_currency($db_trip[0]['fMinFareDiff']);?></td>
													</tr>

													<?php } ?>
													<tr>
															<td>Commission </td>
															<td align="right">- <?=trip_currency($db_trip[0]['fCommision']);?></td>
													</tr>
													<tr>
													...
													<tr>
															...
															<td align="right"><b><?=trip_currency($db_trip[0]['iFare']);?></b></td>
													</tr>
									...
									<h4 style="text-align:center;">	Cancellation Fare For Ride No  :<?= $db_trip[0]['vRideNo'];?></h4><hr/>
												<table style="width:100%" cellpadding="5" cellspacing="0" border="0">											
														...
														<tr>
															...
															<td align="right"> <?=trip_currency($db_trip[0]['fCancellationFare']);?></td>
													</tr>
													...
													<tr>
															<td><b><?php echo $langage_lbl_admin['LBL_Total_Fare_TXT'];?> (Via <?=$db_trip[0]['vTripPaymentMode']?>)</b></td>
															<td align="right"><b><?=trip_currency($db_trip[0]['fCancellationFare']);?></b></td>
													</tr>
