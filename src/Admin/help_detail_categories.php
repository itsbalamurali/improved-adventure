...
<head>
    <meta charset="UTF-8"/>
    <title><?php echo $SITE_NAME; ?> | <?php echo $langage_lbl_admin['LBL_HELP_DETAIL_CATEGORY_TXT']; ?></title>
        ...
        <div class="inner">
            ...
            <form name="frmsearch" id="frmsearch" action="javascript:void(0);" method="post">
                    ...
                    <tr>
                        ...
                        <td width="10%" class=" padding-right10">
                            <select name="option" id="option" class="form-control">
                                ...
                                <option value="iDisplayOrder" <?php if ('iDisplayOrder' === $option) {
                                    echo 'selected';
                                } ?> >Order
				 </option>
			    ...
			    title="Search"/>
			      ...
			      onClick="window.location.href = 'help_detail_categories.php'"/>
                        </td>
                        <?php if ($userObj->hasPermission('create-help-detail-category')) { ?>
                            <td width="30%">
                                <a class="add-btn" href="help_detail_categories_action.php" style="text-align: center;">
                                    Add Help Topic Category
                                </a>
                            </td>
                        <?php } ?>
                    </tr>
				    ...
				    action="<?php echo $_SERVER['PHP_SELF']; ?>">
						    ...
						    <input type="checkbox" id="setAllCheck" >
						     ...
						     onClick="Redirect(2,<?php if ('2' === $sortby) {
						         echo $order;
						     } else { ?>0<?php } ?>)">Title <?php if (2 === $sortby) {
						         if (0 === $order) { ?>
						    ...
						    <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
						      ...
						      <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a>
                                        ...
                                        <?php if ($userObj->hasPermission(['edit-help-detail-category', 'update-status-help-detail-category', 'delete-help-detail-category'])) { ?>
...
if (!empty($data_drv)) {
    for ($i = 0; $i < $count_all; ++$i) {
        ...
        ?>
							    ...
							    value="<?php echo $data_drv[$i]['iUniqueId']; ?>" />&nbsp;
							    </td>
                                                            <td ><?php echo $vTitle; ?></td>
                                                            <?php if (DELIVERALL === 'Yes') { ?>
                                                                <td align="center"><?php echo $eSystem; ?></td>
                                                            <?php } ?>
                                                            <td align="center">
								...
								data-toggle="tooltip" title="<?php echo $data_drv[$i]['eStatus']; ?>">
                                                ...
                                                <td align="center" style="text-align:center;" class="action-btn001">
                                                    <div class="share-button openHoverAction-class"
                                                        ...
                                                        <div class="social show-moreOptions openPops_<?php echo $data_drv[$i]['iHelpDetailCategoryId']; ?>">
                                                            <ul>
                                                                <?php if ($userObj->hasPermission('edit-help-detail')) { ?>
                                                                <li class="entypo-twitter" data-network="twitter">
                                                                    <a href="help_detail_categories_action.php?id=<?php echo $iUniqueId; ?>"
                                                                ...
                                                                <?php if ('Yes' !== $data_drv[$i]['eDefault']) { ?>
                                                                    <?php if ($userObj->hasPermission('update-status-help-detail-category')) { ?>
                                                                        <li class="entypo-facebook"
                                                                            ...
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?php echo $iUniqueId; ?>', 'Inactive')"
                                                                        ...
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?php echo $iUniqueId; ?>', 'Active')"
                                                                    ...
                                                                    <?php if ($userObj->hasPermission('delete-help-detail-category')) { ?>
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatusDelete('<?php echo $iUniqueId; ?>')"
