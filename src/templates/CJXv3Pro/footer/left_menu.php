...
$importBulkItem = $MODULES_OBJ->isEnableBulkImportItems(); // Added By HJ On 28-07-2020 For Import Bulk Item Menu
        ...
        <?php } else if ($user == 'company') { ?>
            <?php if ($eSystem == "DeliverAll") { ?>
                ...
                <?php if($importBulkItem > 0){ ?>
                    <li class="<?= (isset($script) && $script == 'ImportItem') ? 'active' : ''; ?>"><a href="import_item_data.php"><span><?= $langage_lbl['LBL_IMPORT_BULK_ITEM_LEFT_MENU']; ?></span></a></li>
                <?php } ?>
