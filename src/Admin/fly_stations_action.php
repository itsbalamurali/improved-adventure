...
$vLocationAddress = $_POST['vLocationAddress'] ?? '';
...
if (isset($_POST['submit'])) {
    if ('Add' === $action && !$userObj->hasPermission('create-fly-stations')) {
        $_SESSION['success'] = 3;
    ...
    if ('Edit' === $action && !$userObj->hasPermission('edit-fly-stations')) {
        $_SESSION['success'] = 3;
    ...
    foreach ($lattitudeArr[$key] as $key12 => $value) {
        ...
        $allowed_ans_drop = checkAreaRestriction($pickuplocationarr, 'Yes');
        if ('No' === $allowed_ans && 'No' === $allowed_ans_drop) {
            // $errmessage = $langage_lbl_admin["LBL_PICK_DROP_LOCATION_NOT_ALLOW"];
            $error_res = 1;
        }
        if ('Yes' === $allowed_ans && 'No' === $allowed_ans_drop) {
            // $errmessage = $langage_lbl_admin["LBL_DROP_LOCATION_NOT_ALLOW"];
            $error_res = 1;
        }
        if ('No' === $allowed_ans && 'Yes' === $allowed_ans_drop) {
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Admin | <?php echo $langage_lbl_admin['LBL_FLY_STATIONS']; ?> <?php echo $action; ?></title>
        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2><?php echo $action; ?> <?php echo $langage_lbl_admin['LBL_FLY_STATION']; ?></h2>
                    ...
                    <div class="body-div">
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <form method="post" name="location_form" id="location_form" action="">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label><?php echo $langage_lbl_admin['LBL_FLY_STATIONS']; ?> Name<span class="red"> *</span></label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="vLocationName"  id="vLocationName" value="<?php echo $vLocationName; ?>" placeholder="<?php echo $langage_lbl_admin['LBL_FLY_STATIONS']; ?> Name" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label><?php echo $langage_lbl_admin['LBL_FLY_STATIONS']; ?> Address<span class="red"> * </span><i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Add specific Address like Street, Area, City, Pincode.'></i></label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="vLocationAddress"  id="vLocationAddress" value="<?php echo $vLocationAddress; ?>" placeholder="<?php echo $langage_lbl_admin['LBL_FLY_ADDRESS']; ?>" required >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <?php if (('Edit' === $action && $userObj->hasPermission('edit-fly-stations')) || ('Add' === $action && $userObj->hasPermission('create-fly-stations'))) {?>
                                                    <input type="submit" class=" btn btn-default" name="submit" id="submit"  value="<?php if ('Add' === $action) {?><?php echo $action; ?> <?php echo $langage_lbl_admin['LBL_FLY_STATIONS']; ?><?php } else {?>Update<?php }?>" onclick="return IsEmpty();">
                            ...
                            <div class="col-lg-7">
                                <label>Pin <?php echo $langage_lbl_admin['LBL_FLY_STATIONS']; ?> Point Here In Map :<span class="red">*</span></label>
                                ...
                                <div class="panel-heading location-map" style="background:none;">
                                    <div class="google-map-wrap box_in_map">
												<input id="pac-input" type="text" placeholder="Enter <?php echo $langage_lbl_admin['LBL_FLY_STATIONS']; ?> For More Focus" style="padding:4px;width: 200px;margin-top: 5px;">
                                                    ...
                                                    function initialize() {
                                                        ...
                                                        if (Country != "" && (tLongitude == "" || tLatitude == "")) {
                                                            ...
                                                            if (tLongitude != "" || tLatitude != "") {
                                                                ...
                                                                var triangleCoords = [];
                                                                var latlngnew = new google.maps.LatLng(tlat, tlong);
                                                                ...
                                                                map.setZoom(15);
                                                                // add to control map zoom size
                                                                map.setCenter(latlngnew);
                                                                //commented due to zoom issue 21-03
