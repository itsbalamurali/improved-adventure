        ...
        <?php if (($rideModuleAvailable == 1 && $rideTypeEnabled == "Yes") || ($deliveryModuleAvailable == 1 && $deliveryTypeEnabled == "Yes") || ($deliverAllModuleAvailable == 1 && $deliverAllTypeEnabled == "Yes") || ($ufxModuleAvailable == 1 && $ufxTypeEnabled == "Yes")) { ?>
            ...
            <form name="_fare_estimate_form" id="_fare_estimate_form" method="post" action="cx-fareestimate.php">
                ...
                <div class="element-holder address-input">
                    ...
                    <a target="_blank" href="#" class="goto-service-page"><?= $langage_lbl['LBL_CLICK_HERE_TO_PROCCED'] ?></a>
                </div>                                                    
            </form>
        <?php } ?>
    </div>
                    ...
                    <li>
                        <div class="servicesdata-caption-main">
                            <div class="servicesdata-caption">
                               <div class="servicesdata-caption-content">
                               <i>
                                ...
                                <p><? if (file_exists($tconfig["tsite_upload_home_page_service_images_panel"] . '/' . $vcatdata[$i]['vHomepageFullLogo']) && !empty($vcatdata[$i]['vHomepageFullLogo'])) { ?>
                                        <img src="<?= $tconfig["tsite_url"] . 'resizeImg.php?h=256&src=' . $tconfig["tsite_upload_home_page_service_images"] . '/' . $vcatdata[$i]['vHomepageFullLogo']; ?>"
                                            alt="">
                                    <? } ?></div>
