...
if($keyword != ''){
	if($option != '') {
		...
		$ssql.= " AND (concat(rd.vName,' ',rd.vLastName) LIKE '%".clean($keyword)."%' OR c.vCompany LIKE '%".clean($keyword)."%' OR rd.vEmail LIKE '%".clean($keyword)."%' OR rd.vPhone LIKE '%".clean($keyword)."%' OR rd.eStatus LIKE '%".clean($keyword)."%')";
