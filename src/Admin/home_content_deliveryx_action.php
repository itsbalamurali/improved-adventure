...
if (isset($_POST['submit'])) {
    ...
    $track_section_arr['title'] = $_POST['track_section_title'] ?? '';
    $track_section_arr['desc'] = $_POST['track_section_desc'] ?? '';
    $track_section_arr['img'] = $sectionData['img'] ?? '';
    $track_section = getJsonFromAnArr($track_section_arr);
}
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="download_section_sub_title"  id="download_section_sub_title" value="<?php echo $download_section['subtitle']; ?>" placeholder="Subtitle">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="track_section_title"  id="track_section_title" value="<?php echo $track_section['title']; ?>" placeholder="Title" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control ckeditor" rows="10" name="track_section_desc"  id="track_section_desc"  placeholder="Description"><?php echo $track_section['desc']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ('' !== $track_section['img']) { ?>
                                                    <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$track_section['img']; ?>" class="innerbg_image" />
                                                <?php } ?>
