...
if (isset($_POST['submit'])) {
    ...
    $check_file_query = "SELECT header_second_label,vDeliveryPartContent  FROM {$tbl_name} where vCode='".$vCode."'";
    $check_file = $obj->MySQLSelect($check_file_query);
    $sectionData = json_decode($check_file[0]['header_second_label'], true);
    ...
    $sectionData = json_decode($check_file[0]['vDeliveryPartContent'], true);
    ...
    $Update['third_mid_desc_two1'] = $third_mid_desc_two1;
    $Update['header_second_label'] = $safe_section;
    $Update['vDeliveryPartContent'] = $register_section;
...
if ('Edit' === $action) {
    ...
    if (count($db_data) > 0) {
        foreach ($db_data as $key => $value) {
            ...
            $third_mid_desc_two1 = $value['third_mid_desc_two1'];
            $third_mid_image_three1 = $value['third_mid_image_three1'];
            $safe_section = json_decode($value['header_second_label'], true);
            $register_section = json_decode($value['vDeliveryPartContent'], true);
        }
    }
}
...
?>
                                ...
                                <?php if ('No' === $THEME_OBJ->isDeliverallXv2ThemeActive()) { ?>
                                    <div class="row">
                                        <div class="col-lg-12">
                        ...
                        <div style="display: none" class="body-div innersection">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="third_mid_title_two1" id="third_mid_title_two1" value="<?php echo $third_mid_title_two1; ?>" placeholder="Home Seventh Section Title" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10" name="third_mid_desc_two1" id="third_mid_desc_two1" placeholder="Home Sixth Section Description" required><?php echo $third_mid_desc_two1; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $third_mid_image_two1) { ?>
                                            <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$third_mid_image_two1; ?>" class="innerbg_image"/>
                                        <?php } ?>
                                        <input type="file" class="form-control fileuploader" name="third_mid_image_two1" id="third_mid_image_two1" accept=".png,.jpg,.jpeg,.gif">
                                        <br/>
                                        <span class="notes">[Note: For Better Resolution Upload only image size of 1920px * 505px.]</span>
                                    </div>
                                </div>
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="third_mid_title_three1" id="third_mid_title_three1" value="<?php echo $third_mid_title_three1; ?>" placeholder="Home Seventh Section Title" required>
                                    </div>
                                </div>
                                <!--<div class="row">
                                                <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10" name="third_mid_desc_three1" id="third_mid_desc_three1" placeholder="Home Seventh Section Description" required><?php echo $third_mid_desc_three1; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $mobile_app_bg_img1) { ?>
                                            <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$mobile_app_bg_img1; ?>" class="innerbg_image"/>
                                        <?php } ?>
