    ...
    <div class="banner-inner">
        <div class="banner-left">
            <div class="banner-content">
                ...
                <p><?=   html_entity_decode($generalData['desc']); ?></p>  
            </div>
            <?php if (!empty($IPHONE_APP_LINK) || !empty($ANDROID_APP_LINK)) { ?>
            <div class="app-store-btn">
                <h3><?= $langage_lbl['LBL_CLICK_TO_DOWNLOAD_APP'] ?></h3>
                <?php if (!empty($IPHONE_APP_LINK)) { ?>
                <a href="<?= $IPHONE_APP_LINK ?>" target="_blank">
                    <img alt="" src="assets/img/apptype/<?= $template ?>/ios-store.png">
                </a>
                <?php } ?>

                <?php if (!empty($ANDROID_APP_LINK)) { ?>
                <a href="<?= $ANDROID_APP_LINK ?>" target="_blank">
                    <img alt="" src="assets/img/apptype/<?= $template ?>/google-play_.png">
                </a>
                <?php } ?>
            </div>
            <?php } ?>
        ...
        <div class="banner-right">
            <img src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$vHomepageBannerSec; ?>" >
        </div>            
    </div>       
    <span class="banner-shape"></span>
</div>
<!-- Banner section end -->
<?php } } ?>
<!-- *************banner section end************* -->
