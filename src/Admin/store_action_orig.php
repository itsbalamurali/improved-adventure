...
$iServiceIdNew = $_POST['iServiceId'] ?? '';
$vEmail = isset($_POST['vEmail']) ? strtolower($_POST['vEmail']) : '';
$vPassword = $_POST['vPassword'] ?? '';
$vPass = ('' !== $vPassword) ? encrypt_bycrypt($vPassword) : '';
$vContactName = $_POST['vContactName'] ?? '';
$vCode = $_POST['vCode'] ?? '';
$vPhone = $_POST['vPhone'] ?? '';
$vCountry = $_POST['vCountry'] ?? $DEFAULT_COUNTRY_CODE_WEB;
$vState = $_POST['vState'] ?? '';
$vCity = $_POST['vCity'] ?? '';
$vRestuarantLocation = $_POST['vRestuarantLocation'] ?? '';
$vRestuarantLocationLat = $_POST['vRestuarantLocationLat'] ?? '';
$vRestuarantLocationLong = $_POST['vRestuarantLocationLong'] ?? '';
$vCaddress = $_POST['vCaddress'] ?? '';
$vZip = $_POST['vZip'] ?? '';
$vLang = $_POST['vLang'] ?? '';
$vAcctHolderName = $_POST['vAcctHolderName'] ?? '';
$vAcctNo = $_POST['vAcctNo'] ?? '';
$vBankName = $_POST['vBankName'] ?? '';
$vBankLocation = $_POST['vBankLocation'] ?? '';
$vSwiftCode = $_POST['vSwiftCode'] ?? '';
$cuisineId = $_POST['cuisineId'] ?? '';
$vFromMonFriTimeSlot1 = $_POST['vFromMonFriTimeSlot1'] ?? '';
$vToMonFriTimeSlot1 = $_POST['vToMonFriTimeSlot1'] ?? '';
$vFromMonFriTimeSlot2 = $_POST['vFromMonFriTimeSlot2'] ?? '';
$vToMonFriTimeSlot2 = $_POST['vToMonFriTimeSlot2'] ?? '';
$vFromSatSunTimeSlot1 = $_POST['vFromSatSunTimeSlot1'] ?? '';
$vToSatSunTimeSlot1 = $_POST['vToSatSunTimeSlot1'] ?? '';
$vFromSatSunTimeSlot2 = $_POST['vFromSatSunTimeSlot2'] ?? '';
$vToSatSunTimeSlot2 = $_POST['vToSatSunTimeSlot2'] ?? '';
$fMinOrderValue = $_POST['fMinOrderValue'] ?? '';
$fPackingCharge = $_POST['fPackingCharge'] ?? '';
$iMaxItemQty = $_POST['iMaxItemQty'] ?? '';
$fPrepareTime = $_POST['fPrepareTime'] ?? '';
$fOfferAppyType = $_POST['fOfferAppyType'] ?? '';
$fOfferType = $_POST['fOfferType'] ?? '';
$fTargetAmt = $_POST['fTargetAmt'] ?? '';
$fOfferAmt = $_POST['fOfferAmt'] ?? '';
$fMaxOfferAmt = $_POST['fMaxOfferAmt'] ?? '';
$fPricePerPerson = $_POST['fPricePerPerson'] ?? '';
$backlink = $_POST['backlink'] ?? '';
$previousLink = $_POST['backlink'] ?? '';
$vFromMonFriTimeSlot1_validation = explode(' ', $vFromMonFriTimeSlot1);
$storeCategoryIds = $_POST['storeCategoryId'] ?? '';
$eDriverOption = $_POST['eDriverOption'] ?? 'All';

if ('00:00' === $vFromMonFriTimeSlot1_validation[0]) {
...
if (!empty($_POST)) {
    ...
    if ('' !== $vEmail) {
        if ('' !== $id) {
            $msg1 = checkDuplicateAdminNew('iCompanyId', 'company', ['vEmail'], $id, '');
        } else {
            $msg1 = checkDuplicateAdminNew('vEmail', 'company', ['vEmail'], '', '');
        }
        if (1 === $msg1) {
    ...
    if (0 === $checPhoneExist['status']) {
        $error .= '* Phone number already exists.<br>';
    } elseif (2 === $checPhoneExist['status']) {
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?php echo $SITE_NAME; ?> | <?php echo $langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN']; ?> <?php echo $action; ?></title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport" />
        <?php include_once 'global_files.php'; ?>
        <!-- On OFF switch -->
        <link href="../assets/css/jquery-ui.css" rel="stylesheet" />
        <link rel="stylesheet" href="../assets/plugins/switch/static/stylesheets/bootstrap-switch.css" />
        <script src="//maps.google.com/maps/api/js?sensor=true&key=<?php echo $GOOGLE_SEVER_API_KEY_WEB; ?>&libraries=places" type="text/javascript"></script>
...
?>
            ...
            <div id="content">
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2><?php echo $action; ?> <?php echo $langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN']; ?> <?php echo $vCompany; ?></h2>
                    ...
                    <div class="body-div">
                        <div class="form-group">
                            ...
                            <form name="_company_form" id="_company_form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="oldvCoverImageImage" value="<?php echo $oldvCoverImageImage; ?>"/>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="vCompany"  id="vCompany" value="<?php echo clearName(' '.$vCompany); ?>" placeholder="<?php echo $langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN']; ?> Name">
                                            </div>
                                        </div>
                                        <?php
                            if ('Add' === $action) {
                                                    ...
                                                    <div class="col-lg-12">
                                                        <select class="form-control" name = 'iServiceId' id="iServiceId" onchange="changeServiceType(this.value)">
                                                            ...
                                                            <?php for ($i = 0; $i < count($service_cat_list); ++$i) { ?>
                                                                <option value = "<?php echo $service_cat_list[$i]['iServiceId']; ?>" <?php if ($iServiceIdNew === $service_cat_list[$i]['iServiceId']) { ?>selected<?php } ?>><?php echo $service_cat_list[$i]['servicename']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
...
?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" id="vRestuarantLocation" class="form-control" name="vRestuarantLocation"  id="vRestuarantLocation" value="<?php echo $vRestuarantLocation; ?>" placeholder="<?php echo $langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN']; ?> Location" required>
                                            </div>
                                            <input type="hidden" name="vRestuarantLocationLat" id="vRestuarantLocationLat" value="<?php echo $vRestuarantLocationLat; ?>">
                                            <input type="hidden" name="vRestuarantLocationLong" id="vRestuarantLocationLong" value="<?php echo $vRestuarantLocationLong; ?>">
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="vCaddress"  id="vCaddress" value="<?php echo $vCaddress; ?>" placeholder="Address" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="vZip"  id="vZip" value="<?php echo $vZip; ?>" placeholder="Zip Code" >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="vContactName"  id="vContactName" value="<?php echo $vContactName; ?>" placeholder="Person Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12" style="float: left;">
                                                <input type="text" class="form-select-2" id="code" name="vCode" value="<?php echo $vCode; ?>"  readonly style="width: 10%;height: 36px;text-align: center;"/ >
                                                       <input type="text" class="form-control" name="vPhone"  id="vPhone" value="<?php echo $vPhone; ?>" placeholder="Phone" style="margin-top: 5px; width:90%;" required>
                                            </div>
                                        </div>
                                        <?php if ($id) { ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="file" class="form-control" name="vImage"  id="vImage" style="padding-bottom: 39px;" <?php if ((!empty($id) && ('NONE' === $oldImage || '' === $oldImage)) || empty($id)) { ?> required <?php } ?>><!-- Required validation added by SP on 26-7-2019 -->
                                        ...
                                        <!--  <?php if ($id) { ?>
                                            ...
                                            <?php $class = 'col-lg-12'; ?>
                                                                                                      <div class="<?php echo $class; ?>">
                                                                                                           <b>
                                            <?php if ('NONE' === $oldvCoverImageImage || '' === $oldvCoverImageImage) { ?>
                                                                                                                                                                         <img src="../assets/img/profile-user-img.png" alt="" >
                                                <?php
                                            } else {
                     ...
                     <div class="row">
                          ...
                          <div class="col-lg-12">
                               <input type="file" class="form-control" name="vCoverImage"  id="vCoverImage" style="padding-bottom: 39px;">
                                                ...
                                                <div class="col-lg-12">
                                                    <select  class="form-control" name = 'vLang' >
                                                        ...
                                                        <?php for ($i = 0; $i < count($db_lang); ++$i) { ?>
                                                            <option value = "<?php echo $db_lang[$i]['vCode']; ?>" <?php echo ($db_lang[$i]['vCode'] === $vLang) ? 'selected' : ''; ?>>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <?php if (('Edit' === $action && $userObj->hasPermission('edit-store')) || ('Add' === $action && $userObj->hasPermission('create-store'))) { ?>
                                                    <input type="submit" class="btn btn-default" name="submitBtn" id="submitBtn" value="<?php echo $action; ?> <?php echo $langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN']; ?>" >
                                    ...
                                    <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-12">
                                                    <select class="form-control"  id="js-store-category-multiple" name="storeCategoryId[]" multiple="multiple">
                                                        ...
                                                        foreach ($db_store_categories as $store_category) {
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $store_category['iCategoryId']; ?>" <?php echo (isset($storecatselecteddata) && in_array($store_category['iCategoryId'], $storecatselecteddata, true)) ? 'selected="selected"' : ''; ?>><?php echo $category_name['tCategoryName_'.$default_lang]; ?></option>
                                                        <?php } ?>
                                                    </select>
                                            ...
                                            <div class="col-lg-12">
                                                <select class="form-control" required=""  id="js-cuisine-multiple" name="cuisineId[]" multiple="multiple">
                                                    <?php foreach ($db_cuisine as $cuisinedata) { ?>
                                                        <option name="<?php echo $cuisinedata['cuisineId']; ?>" value="<?php echo $cuisinedata['cuisineId']; ?>" <?php echo (isset($cusineselecteddata) && in_array($cuisinedata['cuisineId'], $cusineselecteddata, true)) ? 'selected="selected"' : ''; ?>><?php echo $cuisinedata['cuisineName_'.$default_lang]; ?></option>
                                                    <?php } ?>
                                                </select>
                                                <div class="CuisineClass">
                                                </div>
                                                ...
                                                <div class='col-lg-5'>
                                                    <div class="form-group">
                                                        <div class='input-group date' id='vFromMonFriTimeSlot1'>
                                                            <input type='text' class="form-control TimeField" name="vFromMonFriTimeSlot1" id= "vFromMonFriTimeSlot1-1" value="<?php echo $vFromMonFriTimeSlot1; ?>" required/>
                                                ...
                                                <div class='col-lg-5'>
                                                    <div class="form-group">
                                                        <div class='input-group date' id='vToMonFriTimeSlot1'>
                                                            <input type='text' class="form-control TimeField" name="vToMonFriTimeSlot1" id="vToMonFriTimeSlot-2" value="<?php echo $vToMonFriTimeSlot1; ?>" required/>
                                                            <span class="input-group-addon">
                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class='col-lg-5'>
                                                    <div class="form-group">
                                                        <div class='input-group date' id='vFromMonFriTimeSlot2'>
                                                            <input type='text' class="form-control" name="vFromMonFriTimeSlot2"  id= "vFromMonFriTimeSlot-first" value="<?php echo $vFromMonFriTimeSlot2; ?>"/>
                                                            <span class="input-group-addon">
                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class='col-lg-5'>
                                                    <div class="form-group">
                                                        <div class='input-group date' id='vToMonFriTimeSlot2'>
                                                            <input type='text' class="form-control" name="vToMonFriTimeSlot2" id= "vToMonFriTimeSlot-second" value="<?php echo $vToMonFriTimeSlot2; ?>"/>
                                                            <span class="input-group-addon">
                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class='col-lg-5'>
                                                    <div class="form-group">
                                                        <div class='input-group date' id='vFromSatSunTimeSlot1'>
                                                            <input type='text' class="form-control TimeField" name="vFromSatSunTimeSlot1" value="<?php echo $vFromSatSunTimeSlot1; ?>" required/>
                                                            <span class="input-group-addon">
                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class='col-lg-5'>
                                                    <div class="form-group">
                                                        <div class='input-group date' id='vToSatSunTimeSlot1'>
                                                            <input type='text' class="form-control TimeField" name="vToSatSunTimeSlot1" value="<?php echo $vToSatSunTimeSlot1; ?>" required/>
                                                            <span class="input-group-addon">
                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class='col-lg-5'>
                                                    <div class="form-group">
                                                        <div class='input-group date' id='vFromSatSunTimeSlot2'>
                                                            <input type='text' class="form-control" name="vFromSatSunTimeSlot2" value="<?php echo $vFromSatSunTimeSlot2; ?>"/>
                                                            <span class="input-group-addon">
                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class='col-lg-5'>
                                                    <div class="form-group">
                                                        <div class='input-group date' id='vToSatSunTimeSlot2'>
                                                            <input type='text' class="form-control" name="vToSatSunTimeSlot2" value="<?php echo $vToSatSunTimeSlot2; ?>"/>
                                                            <span class="input-group-addon">
                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                            </span>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label>Minimum Amount Per Order (In <?php echo $db_currency[0]['vName']; ?>) <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Set the minimum order amount that the customer should add to the cart to get the delivery of the order.'></i></label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="fMinOrderValue"  id="fMinOrderValue" value="<?php echo $fMinOrderValue; ?>" placeholder="Minimum Order" >
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label>Additional Packing Charges (In <?php echo $db_currency[0]['vName']; ?>)</label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="fPackingCharge"  id="fPackingCharge" value="<?php echo $fPackingCharge; ?>" placeholder="Packing Charges" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="iMaxItemQty"  id="iMaxItemQty" value="<?php echo $iMaxItemQty; ?>" placeholder="Max qty place by <?php echo strtolower($langage_lbl_admin['LBL_RIDER']); ?>" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row estimateval">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="fPrepareTime"  id="fPrepareTime" value="<?php echo $fPrepareTime; ?>" placeholder="Estimated Order Time including Approx Delivery time" >
                                            </div>
                                        </div>
...
if ('First' === $fOfferAppyType) {
    echo 'selected';
}
?>>First Order</option>
                                                <option value="All" <?php
if ('All' === $fOfferAppyType) {
    echo 'selected';
}
?>>All Order</option>
                                            </select>
...
?>>Percentage Offer</option>
                                        ...
                                        <div class="row" id="fOfferAmtDiv">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="fOfferAmt"  id="fOfferAmt" value="<?php echo $fOfferAmt; ?>" placeholder="Offer Amount">
                                            </div>
                                        </div>

                                        <div class="row" id="fTargetAmtDiv">
                                            <div class="col-lg-12">
                                                <label>Target Amount (In <?php echo $db_currency[0]['vName']; ?>) <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='"Set the minimum total order amount to avail the offer. E.g. "Get $7 off on order above $50" OR "Get 20% off on order above $50", so $50 is the target amount to get the off."'></i></label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="fTargetAmt"  id="fTargetAmt" value="<?php echo $fTargetAmt; ?>" placeholder="Target Amount">
                                        ...
                                        <div class="row" id="fMaxOfferAmtDiv" style="display: none;">
                                            <div class="col-lg-12">
                                                <label>Max Off Amount (In <?php echo $db_currency[0]['vName']; ?>) <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Set the amount to limit <?php echo strtolower($langage_lbl_admin['LBL_RIDER']); ?> to get the maximum off amount on each order. E.g. If offer is 50% off, and maximum off amount is $250, then on order of $2000 <?php echo strtolower($langage_lbl_admin['LBL_RIDER']); ?> can get $250 off, but not $1000 off.'></i></label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="fMaxOfferAmt"  id="fMaxOfferAmt" value="<?php echo $fMaxOfferAmt; ?>" placeholder="Max Off Amount" >
                                            </div>
                                        </div>
                                        <div class="row servicecatresponsive"  style="display:none;">
                                            <div class="col-lg-12">
                                                <label>Cost Per Person (In <?php echo $db_currency[0]['vName']; ?>)<span class="red"> *</span></label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="fPricePerPerson"  id="fPricePerPerson" value="<?php echo $fPricePerPerson; ?>" placeholder="Cost Per Person">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text"  class="form-control" name="vAcctHolderName"  id="vAcctHolderName" value="<?php echo clearName(' '.$vAcctHolderName); ?>" placeholder="Account Holder Name" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text"  class="form-control" name="vAcctNo"  id="vAcctNo" value="<?php echo clearName(' '.$vAcctNo); ?>" placeholder="Account Number" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text"  class="form-control" name="vBankName"  id="vBankName" value="<?php echo clearName(' '.$vBankName); ?>" placeholder="Bank Name" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" name="vBankLocation"  id="vBankLocation" value="<?php echo clearName(' '.$vBankLocation); ?>" placeholder="Bank Location" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text"  class="form-control" name="vSwiftCode"  id="vSwiftCode" value="<?php echo clearName(' '.$vSwiftCode); ?>" placeholder="BIC/SWIFT Code" >
                                            </div>
                                        </div>
                                        <?php if ($isStoreDriver > 0) { ?>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label><?php echo $langage_lbl_admin['LBL_PROVIDER_SELECTION_TXT']; ?><span class="red"> *</span></label>
                                            </div>
                                            <div class="col-lg-12">
                                                <select class="form-control" name="eDriverOption"  id="eDriverOption">
                                                    <option value="All" <?php
    if ('All' === $eDriverOption) {
        echo 'selected';
    }
                                            ?>><?php echo $langage_lbl_admin['LBL_BOTH_DELIEVERY_DRIVERS']; ?></option>
                                                    <option value="Personal" <?php
                                            if ('Personal' === $eDriverOption) {
                                                echo 'selected';
                                            }
                                            ?>><?php echo $langage_lbl_admin['LBL_PERSONAL_DELIVERY_DRIVER']; ?></option>
                                                    <option value="Site" <?php
                                            if ('Site' === $eDriverOption) {
                                                echo 'selected';
                                            }
                                            ?>><?php echo $langage_lbl_admin['LBL_SITE_DELIVERY_DRIVER']; ?></option>
                                                </select>
                                            </div>
                                        </div>
 <?php } ?>
        ...
        <script>
                                                        ...
                                                        $(document).ready(function () {
                                                            ...
                                                            $('#vRestuarantLocation').keyup(function (e) {
                                                                buildAutoComplete("vRestuarantLocation", e, "<?php echo $MIN_CHAR_REQ_GOOGLE_AUTO_COMPLETE; ?>", "<?php echo $_SESSION['sess_lang']; ?>", function (latitude, longitude, address) {
                                                                    // set map marker...
                                                                    var map;
                                                                    var myLatlng;
                                                        ...
                                                        $(function () {
                                                            ...
                                                            if (fOfferAppyType1 != 'None' && fOfferType1 == 'Percentage') {
                                                                ...
                                                                $(".addnote").html("(In <?php echo $db_currency[0]['vName']; ?>)");
