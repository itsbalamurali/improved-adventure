...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?php echo $SITE_NAME; ?> | Newsletter Subscribers </title>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                            ...
                                            <option  value="vName" <?php if ('vName' === $option) {
                                                echo 'selected';
                                            } ?> >Name</option>
                                            <option value="vEmail" <?php if ('vEmail' === $option) {
                                                echo 'selected';
                                            } ?> >Email</option>
                                        </select>
                                    </td>
                                    <td width="20%"><input type="Text" id="keyword" name="keyword" value="<?php echo $keyword; ?>"  class="form-control" /></td>
                                    <td width="15%" class="estatus_options" id="eStatus_options" >
                                        <select name="eStatus" id="eStatus" class="form-control">
                                            <option value="" >Select Status</option>
                                            <option value="Subscribe" <?php
if ('Subscribe' === $eStatus) {
    echo 'selected';
}
?> >Subscribe</option>
                                            <option value="Unsubscribe" <?php
                                            if ('Unsubscribe' === $eStatus) {
                                                echo 'selected';
                                            }
?> >Unsubscribe</option>
                                        </select>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="admin-nir-export">
                                    <?php if (!empty($data_drv) && $userObj->hasPermission('export-newsletter')) { ?>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if ('1' === $sortby) {
                                                        echo $order;
                                                    } else { ?>0<?php } ?>)">Name <?php if (1 === $sortby) {
                                                    ...
                                                    <th width="15%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if ('2' === $sortby) {
                                                        echo $order;
                                                    } else { ?>0<?php } ?>)">Email <?php if (2 === $sortby) {
                                                        if (0 === $order) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                                        } else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>

                                                    <th width="8%" style="text-align:center;"><a href="javascript:void(0);" onClick="Redirect(3,<?php if ('3' === $sortby) {
                                                        echo $order;
                                                    ...
                                                    <th width="8%" align="center" style="text-align:center;"><a href="javascript:void(0);" onClick="Redirect(4,<?php if ('4' === $sortby) {
                                                        echo $order;
                                                    } else { ?>0<?php } ?>)">Date <?php if (4 === $sortby) {
                                                        if (0 === $order) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                                        } else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                ...
                                                <?php
                                                        if (!empty($data_drv)) {
                                                            for ($i = 0; $i < count($data_drv); ++$i) {
                                                                ...
                                                                ?>
                                                        <tr class="gradeA">
                                                            <?php /* <td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iNewsLetterId']; ?>" />&nbsp;</td> */ ?>
                                                            <td><?php echo clearName(ucfirst($data_drv[$i]['vName'])); ?>  </td>
                                                            <td><?php echo clearEmail($data_drv[$i]['vEmail']); ?></td>
                                                            <td align="center"><?php echo $data_drv[$i]['eStatus']; ?></td>
                                                            <td align="center"><?php echo DateTime($data_drv[$i]['tDate'], 'No'); ?></td>
