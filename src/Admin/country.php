...
?> >Delete
                        ...
                        <td>
                            ...
                            <input type="button" value="Reset" class="btnalt button11"
                                   onClick="window.location.href = 'country.php'"/>
                        </td>
                        <?php if ($userObj->hasPermission('create-country')) { ?>
                            <td width="30%">
                                <a class="add-btn" href="country_action.php" style="text-align: center;">Add Country</a>
                            </td>
                        <?php } ?>
                    </tr>
                    </tbody>
            ...
            <div class="table-list">
                <div class="row">
                    <div class="col-lg-12">
					 ...
					 <?php if (COUNTRY_IMAGE_UPLOAD === 'Yes') { ?>
                                            <th align="center" width="3%" style="text-align:center;">Flag</th><?php } ?>
                                        <th width="20%">
			  <a href="javascript:void(0);" onClick="Redirect(1,<?php
					...
					<a href="javascript:void(0);" onClick="Redirect(3,<?php
                                        ...
                                        <?php if ('VOIP' === strtoupper($RIDE_DRIVER_CALLING_METHOD)) { ?>
                                            <th width="8%" align="center" style="text-align:center;">Voip Calling</th>
                                        <?php } ?>
                                        ...
                                        <?php if ($userObj->hasPermission(['edit-country', 'update-status-country', 'delete-country'])) { ?>
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td align="center" style="text-align:center;">
                                                    <input type="checkbox" id="checkbox"
                                                           ...
                                                           value="<?php echo $data_drv[$i]['iCountryId']; ?>"/>&nbsp;
                                                </td>
                                                <?php } ?>
                                                <?php if (COUNTRY_IMAGE_UPLOAD === 'Yes') { ?>
                                                    <td style="text-align:center;"><?php if (!empty($data_drv[$i]['vSImage']) && file_exists($tconfig['tsite_upload_country_images_path'].$data_drv[$i]['vSImage'])) { ?>
                                                        <!-- <img src="<?php echo $tconfig['tsite_upload_country_images'].$data_drv[$i]['vSImage']; ?>" width="20" height="20"> -->
                                                        <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?w=40&h=40&src='.$tconfig['tsite_upload_country_images'].$data_drv[$i]['vSImage']; ?>"
                                                             width="20" height="20">
                                                    <?php } else { ?>
                                                        <!-- <img src="<?php echo $tconfig['tsite_url'].'webimages/icons/DefaultImg/in_s.png'; ?>" width="20" height="20"> -->
                                                        <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?w=40&h=40&src='.$tconfig['tsite_url'].'webimages/icons/DefaultImg/in_s.png'; ?>"
                                                             width="20" height="20">
                                                    <?php } ?>
                                                ...
                                                <?php if ('VOIP' === strtoupper($RIDE_DRIVER_CALLING_METHOD)) { ?>
                                                    <td><?php echo $data_drv[$i]['eEnableSinch']; ?></td>
                                                <?php } ?>
                                                <td align="center" style="text-align:center;">
                                                    <?php
                                                ...
                                                <td align="center" style="text-align:center;" class="action-btn001">
                                                    <div class="share-button openHoverAction-class"
                                                        ...
                                                        <div class="social show-moreOptions openPops_<?php echo $data_drv[$i]['iCountryId']; ?>">
                                                            <ul>
                                                                <?php if ($userObj->hasPermission('edit-country')) { ?>
                                                                <li class="entypo-twitter" data-network="twitter">
                                                                    <a href="country_action.php?id=<?php echo $data_drv[$i]['iCountryId']; ?>"
                                                                ...
                                                                <?php if ('Yes' !== $data_drv[$i]['eDefault']) { ?>
                                                                    <?php if ($userObj->hasPermission('update-status-country')) { ?>
                                                                        <li class="entypo-facebook"
                                                                            ...
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?php echo $data_drv[$i]['iCountryId']; ?>', 'Inactive')"
                                                                        ...
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?php echo $data_drv[$i]['iCountryId']; ?>', 'Active')"
                                                                    ...
                                                                    <?php if ('Deleted' !== $eStatus && $userObj->hasPermission('delete-country')) { ?>
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatusDelete('<?php echo $data_drv[$i]['iCountryId']; ?>')"
