					...
					<div class="driver-action-page">
						...
						<form id="frm1" method="post" onSubmit="return editPro('login')" enctype="multipart/form-data">
							...
							<div id="hide-profile-div" class="row col-md-12">
								...
								<? if($SITE_VERSION == "v5" && $action == "Edit"){ ?>
								...
								<div class="row-a1">
									<div class="col-md-6">
										<span class="newrow">
											...
											<input type="text" class="driver-action-page-input" name="vName"  id="vName" value="<?= cleanall(htmlspecialchars($vName)); ?>" placeholder="First Name" >
											</strong>
										</span> 
									</div>
									<div class="col-md-6">
										<span class="newrow">
											...
											<input type="text" class="driver-action-page-input" name="vLastName"  id="vLastName" value="<?= cleanall(htmlspecialchars($vLastName)); ?>" placeholder="Last Name" >
											</strong>
										</span> 
									</div>
									<div class="col-md-6">
