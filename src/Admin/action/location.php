...
if ('delete' === $method && '' !== $iLocationId) {
    if (!$userObj->hasPermission('delete-geo-fence-locations')) {
        ...
        if (SITE_TYPE !== 'Demo') {
            ...
            if ('VehicleType' === $checklocation[0]['eFor']) {
            ...
            } elseif ('Restrict' === $checklocation[0]['eFor']) {
            ...
            } elseif ('AirportSurcharge' === $checklocation[0]['eFor']) {
            ...
            } elseif ('FixFare' === $checklocation[0]['eFor']) {
