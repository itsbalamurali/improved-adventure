                    ...
                    <tr>
                        ...
                        <td width="10%" class=" padding-right10">
                            <select name="option" id="option" class="form-control">
                                ...
                                <option value="vMake" <?php if ('vMake' === $option) {
                                    echo 'selected';
                                } ?> >Make
                                </option>
                        ...
                        <td>
                            ...
                            <input type="button" value="Reset" class="btnalt button11"
                                   onClick="window.location.href = 'make.php'"/>
                        </td>
                        <?php if ($userObj->hasPermission('create-vehicle-make')) { ?>
                            <td width="30%">
                                <a class="add-btn" href="make_action.php" style="text-align: center;">Add Make</a>
                            </td>
                        <?php } ?>
                    </tr>
                    </tbody>
                            ...
                            <form class="_list_form" id="_list_form" method="post"
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(1,<?php if ('1' === $sortby) {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Make<?php if (1 === $sortby) {
                                                   if (0 === $order) { ?>
                                        ...
                                        <?php if ($userObj->hasPermission(['edit-vehicle-make', 'update-status-vehicle-make', 'delete-vehicle-make'])) { ?>
                                            ...
                                            <tr class="gradeA">
                                                <td align="center" style="text-align:center;">
                                                    <input type="checkbox" id="checkbox"
                                                           ...
                                                           value="<?php echo $data_drv[$i]['iMakeId']; ?>"/>&nbsp;
                                                </td>
                                            ...
                                            ?>
                                                ...
                                                <td align="center" style="text-align:center;" class="action-btn001">
                                                    <div class="share-button openHoverAction-class"
                                                        ...
                                                        <div class="social show-moreOptions leastcol openPops_<?php echo $data_drv[$i]['iMakeId']; ?>">
                                                            <ul>
                                                                <?php if ($userObj->hasPermission('edit-vehicle-make')) { ?>
                                                                    <li class="entypo-twitter" data-network="twitter">
                                                                        <a href="make_action.php?id=<?php echo $data_drv[$i]['iMakeId']; ?>"
                                                                ...
                                                                <?php if ('Yes' !== $data_drv[$i]['eDefault']) { ?>
                                                                    <?php if ($userObj->hasPermission('update-status-vehicle-make')) { ?>
                                                                        <li class="entypo-facebook"
                                                                            ...
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?php echo $data_drv[$i]['iMakeId']; ?>', 'Inactive')"
                                                                        ...
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?php echo $data_drv[$i]['iMakeId']; ?>', 'Active')"
                                                                    ...
                                                                    <?php if ($userObj->hasPermission('delete-vehicle-make')) { ?>
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatusDelete('<?php echo $data_drv[$i]['iMakeId']; ?>')"
