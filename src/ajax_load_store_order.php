...
global $obj, $LIST_RESTAURANT_LIMIT_BY_DISTANCE, $DRIVER_REQUEST_METHOD, $intervalmins;
...
if (count($Data) > 0) {
    ...
    for ($i = 0; $i < count($Data); $i++) {
        ...
        $restaurant_status_arr = GetStoreWorkingHoursDetailsWeb($Data[$i]['iCompanyId'], $iUserId);
