        ...
        if (!empty($value['name'])) {
            ...
            for ($i = 1; $i <= 4; ++$i) {
                if ($key === 'how_it_work_section_hiw_img'.$i) {
                    ...
                    $img_str = 'hiw_img'.$i.'_';
                } elseif ($key === 'cartype_section_block_img'.$i) {
                    $key = 'lCartypeSection';
...
if (isset($_POST['submit'])) {
    $check_file_query = "SELECT lBannerSection,lHowitworkSection,lSecuresafeSection,lDownloadappSection,lCalltobookSection,lEarnSection,lCalculateSection,lCartypeSection,lServiceSection,lBenefitSection,lKioskSection FROM {$tbl_name} where eFor='".$eFor."' AND iVehicleCategoryId = {$iVehicleCategoryId}";
    ...
    $kiosk_section_arr['menu_title_'.$vCode] = $_POST['kiosk_section_menu_title'] ?? '';

    $kiosk_section_arr['title_'.$vCode] = $_POST['kiosk_section_title'] ?? '';

    $kiosk_section_arr['desc_'.$vCode] = $_POST['kiosk_section_desc'] ?? '';

    $kiosk_section_arr['img_'.$vCode] = $sectionData['img_'.$vCode] ?? '';

    $kiosk_section_arr = !(empty($sectionData)) ? array_merge($sectionData, $kiosk_section_arr) : $kiosk_section_arr;

    $kiosk_section = getJsonFromAnArrWithoutClean($kiosk_section_arr);
    ...
    for ($i = 1; $i <= 3; ++$i) {
        $cartype_section_arr['cartype_title'.$i.'_'.$vCode] = $_POST['cartype_section_block_title'.$i] ?? '';
    }

    // ----------------------------------------

    $cartype_section = getJsonFromAnArrWithoutClean($cartype_section_arr);
...
if (isset($_POST['submit'])) {
    if (SITE_TYPE === 'Demo') {
        header('Location: home_content_taxi_action.php?id='.$id.'&success=2');
    ...
    // header("location:" . $backlink);
    header('location:home_content_taxi_action.php?iVehicleCategoryId='.$iVehicleCategoryId.'&id='.$id);
    ...
    <!--[if IE 9]> <html lang="en" class="ie9"> <![endif]-->
        ...
        <!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
            ...
            <head>
                ...
                <title>Admin | Taxi Home Content <?php echo $action; ?></title>
                        ...
                        <div class="inner">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <h2><?php echo $action; ?> Taxi Home Content (<?php echo $title; ?>)</h2>
...
?>
                            ...
                            <div class="body-div">
                                ...
                                <div class="form-group">
                                    ...
                                    <form method="post" name="_home_content_form" id="_home_content_form" action="" enctype='multipart/form-data'>
                                      ...
                                      <?php if (ONLY_MEDICAL_SERVICE === 'No') { ?>
                                       <div class="body-div innersection">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <textarea class="form-control" rows="5" name="service_section_main_desc"  placeholder="Main Description"><?php echo $service_section['main_desc_'.$vCode]; ?></textarea>
                 ...
                 <div class="col-lg-4">
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-11">
                          ...
                          <input type="text" class="form-control" name="service_section_title_fourth" value="<?php echo $service_section['title_fourth_'.$vCode]; ?>" placeholder="Title">
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-11">
                       ...
                       <textarea class="form-control" rows="5" name="service_section_desc_fourth" placeholder="Description"><?php echo $service_section['desc_fourth_'.$vCode]; ?></textarea>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-11">
                   ...
                   <?php if ('' !== $service_section['img_fourth_'.$vCode]) { ?>

                     <!--  <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$service_section['img_fourth_'.$vCode]; ?>" class="innerbg_image"/> -->

                     <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$service_section['img_fourth_'.$vCode]; ?>" class="innerbg_image"/>

                 <?php } ?>

                 <input type="file" class="form-control" name="service_section_img_fourth" value="<?php echo $service_section['img_fourth_'.$vCode]; ?>">
     ...
     <div class="col-lg-4">
      ...
      <div class="row">
          ...
          <div class="col-lg-11">
              ...
              <input type="text" class="form-control" name="service_section_title_fifth" value="<?php echo $service_section['title_fifth_'.$vCode]; ?>" placeholder="Title">
      ...
      <div class="row">
          ...
          <div class="col-lg-11">
           ...
           <textarea class="form-control" rows="5" name="service_section_desc_fifth" placeholder="Description"><?php echo $service_section['desc_fifth_'.$vCode]; ?></textarea>
   ...
   <div class="row">
      ...
      <div class="col-lg-11">
       ...
       <?php if ('' !== $service_section['img_fifth_'.$vCode]) { ?>

        <!--   <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$service_section['img_fifth_'.$vCode]; ?>" class="innerbg_image"/> -->

        <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$service_section['img_fifth_'.$vCode]; ?>" class="innerbg_image"/>



    <?php } ?>

    <input type="file" class="form-control" name="service_section_img_fifth" value="<?php echo $service_section['img_fifth_'.$vCode]; ?>">
...
<div class="col-lg-4">
  ...
  <div class="row">
      ...
      <div class="col-lg-11">
          ...
          <input type="text" class="form-control" name="service_section_title_six" value="<?php echo $service_section['title_six_'.$vCode]; ?>" placeholder="Title">
  ...
  <div class="row">
      ...
      <div class="col-lg-11">
       ...
       <textarea class="form-control" rows="5" name="service_section_desc_six" placeholder="Description"><?php echo $service_section['desc_six_'.$vCode]; ?></textarea>
...
<div class="row">
  ...
  <div class="col-lg-11">
   ...
   <?php if ('' !== $service_section['img_six_'.$vCode]) { ?>

     <!--  <img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$service_section['img_six_'.$vCode]; ?>" class="innerbg_image"/> -->



     <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$service_section['img_six_'.$vCode]; ?>" class="innerbg_image"/>
 ...
 <input type="file" class="form-control" name="service_section_img_six" value="<?php echo $service_section['img_six_'.$vCode]; ?>">
    ...
    <div class="form-group">
       ...
       <div class="row">
           ...
           <div class="col-lg-6">
               ...
               <input type="text" class="form-control" name="kiosk_section_menu_title"  id="kiosk_section_menu_title" value="<?php echo $kiosk_section['menu_title_'.$vCode]; ?>" placeholder="Menu Title">
       ...
       <div class="row">
           ...
           <div class="col-lg-6">
               ...
               <input type="text" class="form-control" name="kiosk_section_title"  id="kiosk_section_title" value="<?php echo $kiosk_section['title_'.$vCode]; ?>" placeholder="Title" required>
       ...
       <div class="row">
           ...
           <div class="col-lg-12">
               ...
               <textarea class="form-control ckeditor" rows="10" name="kiosk_section_desc"  id="kiosk_section_desc"  placeholder="Description"><?php echo $kiosk_section['desc_'.$vCode]; ?></textarea>
       ...
       <div class="row">
           ...
           <div class="col-lg-6">
               ...
               <?php if ('' !== $kiosk_section['img_'.$vCode]) { ?>

                >

                   <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$kiosk_section['img_'.$vCode]; ?>" class="innerbg_image"/>
               ...
               <span class="notes">[Note: For Better Resolution Upload only image size of 860px * 490px.]</span>
            ...
            <div class="col-lg-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-11">
                        ...
                        <input type="text" class="form-control" name="cartype_section_block_title<?php echo $i; ?>"  id="cartype_section_block_title<?php echo $i; ?>" value="<?php echo $cartype_section['cartype_title'.$i.'_'.$vCode]; ?>" placeholder="Title">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-11">
                        ...
                        <?php if ('' !== $cartype_section['cartype_img'.$i.'_'.$vCode]) { ?>

                            //<img src="<?php echo $tconfig['tsite_upload_apptype_page_images'].$template.'/'.$cartype_section['cartype_img'.$i.'_'.$vCode]; ?>" class="innerbg_image"/ style="max-height:100px;">



                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=100&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$cartype_section['cartype_img'.$i.'_'.$vCode]; ?>" class="innerbg_image"/ style="max-height:100px;">
