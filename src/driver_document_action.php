                            ...
                            <div class="profile-req-doc profile-req-doc-driver driver-document-action-page">
                                <div class="profile-req-doc-inner">
                                    ...
                                    ?>
                                        ...
                                        <div><?php echo $db_userdoc[$i]['d_name']; ?>
                                        <?php   
                                        if($MODULES_OBJ->isEnableServiceTypeWiseProviderDocument() == "Yes" && $db_userdoc[$i]['vCategory']!="" && $db_userdoc[$i]['isShowInfo'] == "Yes") {
                                            if($db_userdoc[$i]['iVehicleCategoryId'] > 0) {
                                                $eDocServiceType = $db_userdoc[$i]['vCategory']; ?>
                                                <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo $langage_lbl['LBL_DOCUMENT_FOR']." ".$eDocServiceType; ?>"> 
                                                </i>
                                            <?php       } 
                                        } ?>
                                    </div>
