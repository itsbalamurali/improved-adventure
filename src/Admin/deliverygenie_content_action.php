...
if (isset($_POST['submit'])) {
    $check_file_query = "SELECT lBannerSection,lHowitworkSection,lBenefitSection FROM {$tbl_name} where eFor='".$eFor."' AND iVehicleCategoryId = {$iVehicleCategoryId}";
    $check_file = $obj->MySQLSelect($check_file_query);
...
if (isset($_POST['submit'])) {
    ...
    header('location:deliverygenie_content_action.php?iVehicleCategoryId='.$iVehicleCategoryId.'&id='.$id);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  name="benefit_section_main_desc" id="benefit_section_main_desc"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $benefit_section['img_'.$vCode]) { ?>
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$benefit_section['img_'.$vCode]; ?>"
                                                 class="innerbg_image"/>
                                        <?php } ?>
                                        <input type="file" class="form-control" name="benefit_section_img"
                                               value="<?php echo $benefit_section['img_'.$vCode]; ?>"
