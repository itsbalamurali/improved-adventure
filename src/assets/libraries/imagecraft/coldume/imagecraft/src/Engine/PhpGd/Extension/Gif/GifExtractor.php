...
class GifExtractor
{
     ...
     * @param resource $fp
     */
    protected function readMetadata($fp, GifExtracted $extracted): void
    {
     ...
     * @param resource $fp
     */
    protected function readExtension($fp, GifExtracted $extracted): void
    {
        switch ($this->read($fp, 1)) {
            case "\xFF":
     ...
     * @param resource $fp
     */
    protected function readFrame($fp, GifExtracted $extracted): void
    {
        if (!$extracted->hasGraphicControlExtension()) {
    ...
    protected function readEnd(GifExtracted $extracted): void
    {
