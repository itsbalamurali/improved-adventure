...
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/header.css" type="text/css">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/footer.css" type="text/css">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/style.css" type="text/css">
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/home-new-2021.css" type="text/css">
...
<link rel="stylesheet" href="<?= $siteUrl ?>assets/css/apptype/<?= $template;?>/style_rtl.css" type="text/css">
