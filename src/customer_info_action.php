...
if (isset($_POST['SUBMIT'])) {
    ...
    unset($_SESSION[$orderDetailsSession], $_SESSION[$userSession], $_SESSION[$orderUserSession], $_SESSION[$orderServiceSession], $_SESSION[$orderUserIdSession], $_SESSION[$orderAddressIdSession], $_SESSION[$orderCouponSession], $_SESSION[$orderCouponNameSession], $_SESSION[$orderCurrencyNameSession], $_SESSION[$orderLatitudeSession], $_SESSION[$orderLongitudeSession], $_SESSION[$orderAddressSession], $_SESSION[$orderDataSession], $_SESSION[$orderUserNameSession], $_SESSION[$orderCompanyNameSession], $_SESSION[$orderUserEmailSession], $_SESSION[$orderStoreIdSession], $_SESSION[$orderServiceNameSession]);

    // unset($_SESSION['sess_currentpage_url_mr']);

    // unset($_SESSION["sess_user_mr"]);
    $Data = $DataAddress = [];
    // $msg= checkDuplicateFront('vEmail', "register_user" , Array('vEmail=>$_POST[customer_info_vLastName']'),$tconfig["tsite_url"]."customer_info.php?error=1&var_msg=Email already Exists", "Email already Exists",'',"");
    $eReftype = 'Rider';
    ...
    if ('' !== $iUserId) {
        ...
        // $_SESSION['sess_userby_mr'] = GetSessionMemberType();
        ...
        if ('' !== $_REQUEST['depart'] && 'mobi' === $_REQUEST['depart']) {
        ...
        if ($MODULES_OBJ->isSingleStoreSelection()) {
            ...
            // if($cnt_sc==1) {
            session_start();
            $store_data = getStoreDataForSystemStoreSelection($_POST['serviceid']);
