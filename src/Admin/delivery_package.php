...
if ('' !== $hdn_del_id) {
    if (SITE_TYPE !== 'Demo') {
        ...
        header('Location:delivery_package.php?success=2');
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
       <title><?php echo $SITE_NAME; ?> | Delivery Package</title>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if ('1' === $sortby) {
                                                            echo $order;
                                                        } else { ?>0<?php } ?>)">Package Type <?php if (1 === $sortby) {
