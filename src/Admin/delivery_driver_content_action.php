...
if (empty($id)) {
    ...
    header('Location:home_content_delivery_driver_action.php?id='.$iLanguageId);

    exit;
}
$url = 'home_content_delivery_driver_action.php';
...
<head>
    <meta charset="UTF-8"/>
    <title>Admin | Deliver Partner Home Content <?php echo $action; ?></title>
    ...
    <div id="content">
        <div class="inner">
            <div class="row">
                <div class="col-lg-12">
                    <div class="col-lg-6">
                        <h2><?php echo $action; ?> Deliver Partner Home Content (<?php echo $title; ?>)</h2>
                    </div>
