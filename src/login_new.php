        ...
        <div class="page-contant-inner">
            ...
            <div class="login-form">
                ...
                <div class="login-form-left">
                    <form action="<?= $action_url ?>" class="form-signin" method="post" id="login_box"
                        ...
                        <b>
                            ...
                            <div class="phone-field">
                                <input name="vEmail" type="text"
                                       placeholder="<?= $langage_lbl['LBL_ENTER_EMAIL_ID_OR_MOBILE_TXT']; ?>"
                                       class="login-input" id="vEmail"
                                       value="<?= (SITE_TYPE == 'Demo') ? (($action == 'rider') ? $rider_email : $driver_email) : ''; ?>"
                                       required/>
                                <div class="clearfix"></div>
                                <div class="mobile-info"
                                     style="margin: 0 0 15px 0;font-size: 11px;color: #666;font-weight: normal;"><?= $langage_lbl['LBL_SIGN_IN_MOBILE_EMAIL_HELPER'] ?></div>
                            </div>
                        </b>
                        ...
                        <div class="relative_ele">
                            <b>
                                ...
                                <input name="vPassword" type="password"
                                       placeholder="<?= $langage_lbl['LBL_PASSWORD_LBL_TXT']; ?>" class="login-input"
                                       id="vPassword" value="<?= (SITE_TYPE == 'Demo') ? '123456' : '' ?>" required/>
                    ...
                    <form action="" method="post" class="form-signin" id="frmforget" onSubmit="return forgotPass();"
                        ...
                        <input type="hidden" name="isEmail" class="isEmail " value="Yes">
                        <b>
                            <label><?= $langage_lbl['LBL_EMAIL_MOBILE_NO_TXT_MSG']; ?></label>
                            <div class="clearfix"></div>
                            <div class="phone-field">
                                ...
                                <input name="femail" type="text"
                                       placeholder="<?= $langage_lbl['LBL_EMAIL_MOBILE_NO_TXT_MSG']; ?>"
                                       class="login-input" id="femail" value="" required/>
                                <div class="clearfix"></div>
                            </div>
                        </b>
                            ...
                            if ($action == 'driver') {
                                ...
                                <span class="login-socials">
                                            <?php if ($DRIVER_FACEBOOK_LOGIN == "Yes") { ?>
                                                <a href="facebook/<?= $action ?>" class="facebook-new"><img
                                                            src="assets/img/facebook-new.png"></a>
                                            <?php }
                                            if ($DRIVER_TWITTER_LOGIN == "Yes") { ?>

                                                <a href="twitter/<?= $action ?>" class="facebook-new"><img
                                                            src="assets/img/twitter-new.png"></a>
                                            <?php }
                                            if ($DRIVER_GOOGLE_LOGIN == "Yes") { ?>

                                                <a href="google/<?= $action ?>" class="facebook-new"><img
                                                            src="assets/img/google-new.png"></a>
                                            <?php }
                                            if ($DRIVER_LINKEDIN_LOGIN == "Yes") { ?>
                                                <a href="linkedin/<?= $action ?>" class="facebook-new"><img
                                                            src="assets/img/Linkedin-new.png"></a>
                                            <?php } ?>
                            ...
                            if ($action == 'rider') {
                                ...
                                <span class="login-socials">
                                            <?php if ($PASSENGER_FACEBOOK_LOGIN == "Yes") { ?>
                                                ...
                                                <a href="facebook-rider/<?= $action ?>" class="facebook-new"><img
                                                            src="assets/img/facebook-new.png"></a>
                                                <?php
                                            }
                                            ...
                                            if ($PASSENGER_LINKEDIN_LOGIN == "Yes") { ?>
                                                ...
                                                <a href="linkedin-rider/<?= $action ?>" class="facebook-new"><img
                                                            src="assets/img/Linkedin-new.png"></a>
                                            <?php } ?>
                    ...
                    <div class="text-center" style="text-align:left;">
                        ...
                        <? } elseif ($host_system == "doctor4") { ?>
                            <h4>
                                ...
                                view the detail of your Appointment.<br/>
                            </h4>
                            To view the Standard Features of the Apps use below access detail :<br/><br/>
                            <p>
                                <b>Doctor : </b><br/>
                    ...
                    <div class="text-center" style="text-align:left;">
                        ...
                        <? } elseif ($host_system == "beautician" || $host_system == "beautician4") { ?>
                            <h4>
                                ...
                                to view the detail of your Jobs.<br/>
                            </h4>
                            To view the Standard Features of the Apps use below access detail :<br/><br/>
                            <p>
                                <b>Beautician : </b><br/>
                        ...
                        <?php } elseif ($host_system == "doctor4") { ?>
                            <h4>
                                <b>Note :</b><br/>
                                - If you have registered as a new doctor, use your registered Email Id and Password to
                                view the detail of your Jobs.<br/>
                            </h4>
                            To view the Standard Features of the Apps use below access detail :<br/><br/>
                            <p>
                        ...
                        <?php } elseif ($host_system == "massage4") { ?>
                            <h4>
                                <b>Note :</b><br/>
                                - If you have registered as a new massge therapist, use your registered Email Id and
                                Password to view the detail of your Jobs.<br/>
                            </h4>
                            To view the Standard Features of the Apps use below access detail :<br/><br/>
                            <p>
                        ...
                        <?php } elseif ($host_system == "dogwalking4") { ?>
                            <h4>
                                <b>Note :</b><br/>
                                - If you have registered as a new dog walker, use your registered Email Id and Password
                                to view the detail of your Jobs.<br/>
                            </h4>
                            To view the Standard Features of the Apps use below access detail :<br/><br/>
                            <p>
                        ...
                        <?php } elseif ($host_system == "towtruck4") { ?>
                            <h4>
                                <b>Note :</b><br/>
                                - If you have registered as a new towing driver, use your registered Email Id and
                                Password to view the detail of your Jobs.<br/>
                            </h4>
                            To view the Standard Features of the Apps use below access detail :<br/><br/>
                            <p>
                        ...
                        <?php } elseif ($host_system == "ufxforall4" || $domain == "cubejek") { ?>
                            <h4>
                                <b>Note :</b><br/>
                                - If you have registered as a new provider, use your registered Email Id and Password to
                                view the detail of your Jobs.<br/>
                            </h4>
                            To view the Standard Features of the Apps use below access detail :<br/><br/>
                            <p>
            ...
            var request = $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == 1) {
                        ...
                        $("#btn_submit").val("<?= $langage_lbl['LBL_Recover_Password'] ?>");
                    }
