                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <textarea class="form-control"
                                                              ...
                                                              value="<?php echo $how_it_work_section['hiw_desc'.$i]; ?>"
                                                              placeholder="Description"
                                                              rows="3"><?php echo $how_it_work_section['hiw_desc'.$i]; ?></textarea>
                                                </div>
                                            </div>
                                            <!-- Image  -->
                                            <div class="row">
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10" name="travel_section_desc"
                                                  id="travel_section_desc"
                                                  placeholder="Description"><?php echo $travel_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10" name="pool_section_desc"
                                                  id="pool_section_desc"
                                                  placeholder="Description"><?php echo $pool_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  name="safety_section_main_desc" id="safety_section_main_desc"
                                                  placeholder="Description"><?php echo $safety_section['main_desc']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="safety_section_title_first"
                                               id="safety_section_title_first"
                                               value="<?php echo $safety_section['title_first']; ?>" placeholder="Title"
                                               required>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $safety_section['img_first']) { ?>
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$safety_section['img_first']; ?>"
                                                 class="innerbg_image"/>
                                        <?php } ?>
                                        <input type="file" class="form-control FilUploader"
                                               name="safety_section_img_first" id="safety_section_img_first"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  name="safety_section_description_first"
                                                  id="safety_section_description_first"
                                                  placeholder="Description"><?php echo $safety_section['safety_section_description_first']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="safety_section_title_sec"
                                               id="safety_section_title_sec"
                                               value="<?php echo $safety_section['title_sec']; ?>" placeholder="Title"
                                               required>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <?php if ('' !== $safety_section['img_sec']) { ?>
                                            <img src="<?php echo $tconfig['tsite_url'].'resizeImg.php?h=300&src='.$tconfig['tsite_upload_apptype_page_images'].$template.'/'.$safety_section['img_sec']; ?>"
                                                 class="innerbg_image"/>
                                        <?php } ?>
                                        <input type="file" class="form-control FilUploader"
                                               name="safety_section_img_sec" id="safety_section_img_sec"
                                               accept=".png,.jpg,.jpeg,.gif">
                                        <br/>
                                        <span class="notes">[Note: For Better Resolution Upload only image size of 450px * 520px.]</span>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  name="safety_section_description_second"
                                                  id="safety_section_description_second"
                                                  placeholder="Description"><?php echo $safety_section['safety_section_description_second']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="10" name="call_section_desc"
                                                  ...
                                                  placeholder="Description"><?php echo $call_section['desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control ckeditor" rows="10"
                                                  name="register_section_main_desc" id="register_section_main_desc"
                                                  placeholder="Description"><?php echo $register_section['main_desc']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
