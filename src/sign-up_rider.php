...
$meta_arr = $STATIC_PAGE_OBJ->FetchSeoSetting(6);
                                ...
                                <?php if ($REFERRAL_SCHEME_ENABLE == 'Yes') { ?>
                                    <span class="newrow" style="margin:0px;">
                                        <strong id="refercodeCheck">
                                            ...
                                            <input id="vRefCode" type="text" name="vRefCode" placeholder="<?= $langage_lbl['LBL_REFERAL_CODE']; ?>" class="create-account-input create-account-input1 vRefCode_verify" value="<?php echo $_SESSION["vRefCode"]; ?>"  onBlur="validate_refercode(this.value)"/>  </strong>
                                ...
                                <span class="newrow">
                                    <strong class="captcha-signup1">
                                        <div class="checkbox-n checkbox-na">
                                            ...
                                            <abbr><?= $langage_lbl['LBL_SIGNUP_Agree_to']; ?> <a href="terms-condition" target="_blank"><?= $langage_lbl['LBL_TERMS_AND_CONDITION']; ?></a></abbr>
                                        </div>   
