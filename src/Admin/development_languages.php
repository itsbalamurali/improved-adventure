...
if ('' !== $hdn_del_id) {
    if (SITE_TYPE !== 'Demo') {
        ...
        header('Location:languages.php?success=2');
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2><?php echo ucfirst($type); ?> Development</h2>
						</div>
					</div>
					<hr />
					<?php if (2 === $success) { ?>
...
if ($count_all > 0) {
    for ($i = 0; $i < $count_all; ++$i) {
        ...
        ?>
															<tr class="gradeA">
																<td width="30%"><?php echo $lp_name; ?></td>
																<!---
																<td width="40%"><?php echo $lp_link; ?></td>
																--->
																<td width="11%" align="center"><?php echo $total; ?></td>
																<td width="45%"><?php echo $vDescription; ?></td>

																<td class="center" >
																	<a href="languages.php?lp_id=<?php echo $lp_id; ?>&lp_name=<?php echo $db_data[$i]['lp_name']; ?>">
																		<button class="btn btn-primary">
																			<i class="icon-pencil icon-white"></i> Add / View Labels
																		</button>
																	</a>
