                    ...
                    <div class="driver-profile-page">
                        ...
                        <div class="driver-profile-top-part" id="hide-profile-div">
                            <div class="driver-profile-info edit-organization">
                                <h3>
                                    <?php echo cleanall(htmlspecialchars($db_user[0]['vCompany'])); ?> 
                                </h3>
                            ...
                            <form id = "frm2" method = "post" onsubmit ="return editPro('address')">
                                ...
                                <div class="profile-address-part">
                                    <span>
                                        ...
                                        <input type="text" class="profile-address-input" placeholder="<?= $langage_lbl['LBL_PROFILE_ADDRESS']; ?> 1" value="<?= cleanall(htmlspecialchars($db_user[0]['vCaddress'])); ?>" name="address1" required>
                                    </span>
                                    <span>
