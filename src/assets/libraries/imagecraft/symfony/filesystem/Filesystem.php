...
class Filesystem
{
     ...
     *
     * @param array|string|\Traversable $dirs The directory path
     ...
     *
     * @param array|string|\Traversable $files A filename, an array of files, or a \Traversable instance to check
     *
     ...
     *
     * @param array|string|\Traversable $files A filename, an array of files, or a \Traversable instance to create
     ...
     *
     * @param array|string|\Traversable $files A filename, an array of files, or a \Traversable instance to remove
     *
     ...
     *
     * @param array|string|\Traversable $files     A filename, an array of files, or a \Traversable instance to change mode
     ...
     *
     * @param array|string|\Traversable $files     A filename, an array of files, or a \Traversable instance to change owner
     ...
     *
     * @param array|string|\Traversable $files     A filename, an array of files, or a \Traversable instance to change group
