...
if ('' !== $keyword) {
    if ('' !== $option) {
        if (str_contains($option, 'vPagename')) {
                ...
                <hr/>
				    ...
				    <strong>Search:</strong>
				     ...
				     <select name="option" id="option" class="form-control">
                                          ...
                                          <option value="vPagename" <?php if ('vPagename' === $option) {
                                              echo 'selected';
                                          } ?> >Page Name
					  </option>
                                    </select>
				    ...
				    class="form-control" />
				      ...
				      title="Search" />
				       ...
				       onClick="window.location.href='seo_setting.php	'"/>
                                    </td>
                                    <td width="30%"></td>
                                </tr>
                              </tbody>
                    ...
                    <div class="table-list">
					    ...
					    action="<?php echo $_SERVER['PHP_SELF']; ?>">
						     ...
						     onClick="Redirect(1,<?php if ('1' === $sortby) {
						         echo $order;
						     } else { ?>0<?php } ?>)">Page Name <?php if (1 === $sortby) {
						         if (0 === $order) { ?>
						     ...
						     <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a>
                                        ...
                                        <?php if ($userObj->hasPermission('edit-seo-setting')) { ?>
                                        ...
                                        <?php } ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td><?php echo $data_drv[$i]['vPagename']; ?></td>
                                                <?php if ($userObj->hasPermission('edit-seo-setting')) { ?>
                                                               <td align="center">
								<a href="seosetting_action.php?id=<?php echo $data_drv[$i]['iId']; ?>"
