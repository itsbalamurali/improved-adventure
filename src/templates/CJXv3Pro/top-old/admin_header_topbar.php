...
$dashboardLink = (ONLYDELIVERALL == "Yes") ? SITE_ADMIN_URL.'/store-dashboard.php' : SITE_ADMIN_URL.'/dashboard.php';
...
<link type="text/css" href="<?= $tconfig["tsite_url_main_admin"] ?>css/admin_new/admin_style.css" rel="stylesheet" />
<? } ?>
    ...
    <header class="main_header">
        <div class="header header-admin-hotel clearfix">
            ...
            <nav class="navbar-static-top nav-admin-hotel"> 
                ...
                <span style="font-size: 26px"><?php echo clearName($_SESSION['sess_vAdminFirstName'] . "&nbsp;&nbsp;" . $_SESSION['sess_vAdminLastName']); ?></span>
                <span style="font-size: 13px"><?php echo $role_sql_data[0]['vGroup']; ?></span>
            </nav>
            <? if((strpos($_SERVER['SCRIPT_FILENAME'],'reset_admin_password.php') === false) ) { ?>
            <div>
                <a href="<?= $tconfig["tsite_url_main_admin"] ?>logout.php" title="Logout" class="header-top-button"><img src="<?= $tconfig["tsite_url_main_admin"]; ?>images/logout-icon1.png" alt="" />Logout</a>
