...
} elseif ('Yes' === $THEME_OBJ->isDeliveryKingXv2ThemeActive()) {
    $url = "home_content_deliveryking_action.php?id={$id}";
}
...
if (isset($_POST['submit'])) {
    ...
    header('location: home_content_deliverall_dynamic.php?iVehicleCategoryId='.$iVehicleCategoryId.'&id='.$id);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="secure_section_title"  id="secure_section_title" value="<?php echo $secure_section['title_'.$vCode]; ?>" placeholder="Title">
