...
if ('' !== $id && '' !== $iMenuItemId && '' !== $iFoodMenuId && '' !== $id) {
    ...
    if (0 === count($addorderdetails)) {
        ...
        $responce['OrderDetails'][] = $optionsi;
        ...
        if ('0' === $check) {
            ...
            $responce['addOrderDetails'][] = $addoptions;
...
echo json_encode(['responce' => $responce['OrderDetails'], 'totalcounter' => $totalQtyty]);
