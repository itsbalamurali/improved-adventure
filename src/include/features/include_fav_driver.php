...
function getFavSelectQueryDriver($iMemberId) {
...
function addUpdateFavDriver() {
    global $_REQUEST, $obj,$vSystemDefaultLangCode,$tripDetailsArr,$userDetailsArr,$LANG_OBJ;
...
if ($type == "getFavDriverList") {
    ...
    if (count($Data) > 0) {
        ...
        $returnData['Action'] = "0";
        $returnData['message'] = "LBL_NO_DRIVERS_FOUND";
    }
